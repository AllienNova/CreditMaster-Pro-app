...
- **Web lane**: ✅ Bills `4e4344e`, Subscriptions `228aed0`, Auto-save `56f939f`, Zero-based `0914b88` (added a real `smartBudgetEngine`-backed guarded route) → **Dashboard `dashboard/page.tsx` *(in flight — last major web P1)*.**
