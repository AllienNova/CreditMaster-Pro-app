...
| **payments** | `PAYMENTS` array + on-time% from it | `GET /api/financial/bills` — verify bills-vs-history concept; omit on-time% if no history source | in flight (`adf9fcb2`) |
