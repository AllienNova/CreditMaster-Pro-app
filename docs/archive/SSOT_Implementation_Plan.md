...
| ID      | Task                                                                       | %    | Status   | Artifact                                       | Depends On | Verify                                                                                                      |
| ------- | -------------------------------------------------------------------------- | ---- | -------- | ---------------------------------------------- | ---------- | ----------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| TAX-001 | Expand tax module test suite (target: 15+ test files covering all engines) | 20%  | ACTIVE   | `src/lib/tax/__tests__/`                       | None       | `ls src/lib/tax/**tests**/\*.test.ts                                                                        | wc -l`≥ 8;`npm test -- --testPathPattern="tax" --coverage` — branch coverage ≥ 80% |
...
| ID      | Task                                                                                    | %   | Status | Artifact                                                         | Depends On | Verify                                                                                                    |
| ------- | --------------------------------------------------------------------------------------- | --- | ------ | ---------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| ONB-001 | Expand onboarding test suite (wizard flow, progress persistence, adaptive forms)        | 15% | ACTIVE | `src/lib/onboarding/__tests__/`, `src/app/onboarding/__tests__/` | None       | `ls src/**/onboarding/**/_.test._                                                                         | wc -l`≥ 5;`npm test -- --testPathPattern="onboarding" --coverage` — branch coverage ≥ 80% |
...
_Generated from 6 parallel codebase audits on 2026-02-17._
_Source data: SSOT.md, Plan_Index.md, Gaps_Conflicts_Decisions.md, Test_Strategy.md_
_Bijective mapping: Each task ID maps to exactly one codebase artifact or file set._
