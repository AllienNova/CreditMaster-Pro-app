...
describe("TransactionCategorizer", () => {
  ...
  describe("categorizeTransaction", () => {
    it("should categorize a restaurant transaction", async () => {
      ...
      const result =
        await transactionCategorizer.categorizeTransaction(transaction);
  ...
  describe("getCategorySpending", () => {
    it("should return empty array when no transactions", async () => {
      const result = await transactionCategorizer.getCategorySpending(
        "user-1",
        "month",
      );
  ...
  describe("detectRecurringTransactions", () => {
    it("should return empty array when no transactions", async () => {
      const result =
        await transactionCategorizer.detectRecurringTransactions("user-1");
    ...
    it("should handle user with no recurring patterns", async () => {
      const result =
        await transactionCategorizer.detectRecurringTransactions("user-2");
  ...
  describe("class structure", () => {
    it("should have categorizeTransaction method", () => {
      expect(typeof transactionCategorizer.categorizeTransaction).toBe(
        "function",
      );
    });

    it("should have getCategorySpending method", () => {
      expect(typeof transactionCategorizer.getCategorySpending).toBe(
        "function",
      );
    });

    it("should have detectRecurringTransactions method", () => {
      expect(typeof transactionCategorizer.detectRecurringTransactions).toBe(
        "function",
      );
    });
  });
