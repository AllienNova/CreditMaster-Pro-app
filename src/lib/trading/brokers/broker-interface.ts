...
export interface BrokerInterface {
  ...
  getOrderHistory(params: { after?: Date; until?: Date; limit?: number }): Promise<Order[]>;
  ...
  modifyOrder(orderId: string, modifications: OrderModification): Promise<OrderResult>;
...
export interface BrokerEvents {
  ...
  onTrade: (trade: { symbol: string; price: number; size: number; timestamp: Date }) => void;
}
...
export type SupportedBroker = 'alpaca' | 'interactive_brokers' | 'schwab' | 'paper';
