...
export const ESCALATION_TACTICS: AdvancedStrategy = {
  ...
  description:
    "Systematic escalation from bureau dispute to CFPB complaint to state AG involvement to legal demand letters.",
  legalBasis: [
    {
      law: "FCRA",
      section: "§611(a)",
  ...
  steps: [
    {
      ...
      description:
        "Send certified dispute letter to credit bureau with documentation",
      duration: "30-45 days",
  ...
  timeline: {
    ...
    phases: [
      ...
      },
      {
        ...
        duration: "30 days",
        description: "Direct dispute",
      },
      {
        name: "Regulatory",
        duration: "30-90 days",
        description: "CFPB/AG complaints",
      },
      {
        name: "Legal",
        duration: "30+ days",
        description: "Demand letters/litigation",
      },
    ],
  },
  riskLevel: "medium",
  ...
  expectedOutcomes: [
    {
      ...
      probability: 0.65,
      description: "Disputed item deleted",
    },
    {
      outcome: "Item corrected",
      probability: 0.2,
    ...
    },
    {
      outcome: "Settlement",
      probability: 0.1,
      description: "Monetary settlement",
    },
    {
      outcome: "No change",
      probability: 0.05,
      description: "Dispute unsuccessful",
    },
  ],
  whenToUse: [
...
export const MOV_CHALLENGE: AdvancedStrategy = {
  ...
  description:
    "Demand proof of how the bureau verified disputed information. Bureaus often use automated systems that fail to meet FCRA reasonable investigation standards.",
  legalBasis: [
    {
      law: "FCRA",
  ...
  steps: [
    ...
    },
    {
      ...
      tips: [
        "Look for e-OSCAR automated responses",
        "Check if actual documents reviewed",
      ],
    },
    {
      order: 3,
      ...
      description:
        "If MOV shows automated/inadequate investigation, challenge it",
      duration: "30 days",
      documents: ["Challenge letter", "MOV analysis", "Case law citations"],
      tips: [
        "Cite Cushman v. Trans Union",
        "Argue reasonable investigation not conducted",
      ],
    },
    {
      order: 4,
      ...
      description:
        "File CFPB complaint citing inadequate investigation procedures",
      duration: "30-60 days",
  ...
  timeline: {
    ...
    phases: [
      {
        name: "Initial MOV Request",
        duration: "30 days",
        description: "Dispute with MOV demand",
      },
      {
        name: "Analysis",
        duration: "5-10 days",
        description: "Review MOV response",
      },
      {
        name: "Challenge",
        duration: "30 days",
        description: "Challenge inadequate MOV",
      },
      {
        name: "Escalation",
        duration: "30-60 days",
        description: "Regulatory complaint",
      },
    ],
  },
  riskLevel: "low",
  ...
  expectedOutcomes: [
    {
      outcome: "Item removed",
      probability: 0.55,
      description: "Bureau cannot prove adequate investigation",
    },
    {
      outcome: "Detailed MOV provided",
      probability: 0.25,
      description: "Bureau provides actual verification",
    },
    {
      outcome: "No change",
      probability: 0.2,
      description: "Bureau maintains position",
    },
  ],
  whenToUse: [
...
export const FURNISHER_DIRECT: AdvancedStrategy = {
  ...
  description:
    "Bypass credit bureaus and dispute directly with the data furnisher (creditor/collector) under FCRA §623.",
  legalBasis: [
    {
      law: "FCRA",
      section: "§623(a)(8)",
  ...
  steps: [
    {
      ...
      description:
        "Find the correct address for disputes (often different from billing)",
      duration: "1-3 days",
      documents: ["Credit report", "Furnisher contact research"],
      tips: [
        "Check furnisher website for dispute address",
        "Use address on credit report",
      ],
    },
    {
      order: 2,
    ...
    },
    {
      ...
      title: "Follow Up",
      description:
        "If no response in 30 days, send follow-up with escalation warning",
      duration: "15 days",
    ...
    },
    {
      ...
      description:
        "File CFPB complaint for failure to investigate direct dispute",
      duration: "30-60 days",
    ...
    phases: [
      {
        name: "Research",
        duration: "1-3 days",
        description: "Find correct address",
      },
      {
        name: "Direct Dispute",
        duration: "30 days",
        description: "Send to furnisher",
      },
      {
        name: "Follow-up",
        duration: "15 days",
        description: "Escalation warning",
      },
      {
        name: "Regulatory",
        duration: "30-60 days",
        description: "CFPB complaint",
      },
    ],
  },
  riskLevel: "low",
  ...
  expectedOutcomes: [
    {
      outcome: "Item corrected/removed",
      probability: 0.6,
      description: "Furnisher updates reporting",
    },
    {
      outcome: "Documentation provided",
      probability: 0.2,
      description: "Furnisher proves accuracy",
    },
    {
      outcome: "No response",
      probability: 0.15,
      description: "Furnisher ignores (violation)",
    },
    {
      outcome: "Dispute rejected",
      probability: 0.05,
      description: "Furnisher denies",
    },
  ],
  whenToUse: [
...
export const PROCEDURAL_VIOLATIONS: AdvancedStrategy = {
  ...
  description:
    "Identify and exploit bureau failures to follow FCRA procedural requirements during investigation.",
  legalBasis: [
    {
      law: "FCRA",
      section: "§611(a)(1)(A)",
    ...
    },
    {
      ...
      section: "§611(a)(5)",
      description:
        "Requirement to forward all relevant information to furnisher",
  ...
  steps: [
    {
      ...
      tips: [
        "Use certified mail for proof of delivery date",
        "Calculate 30 days from receipt",
      ],
    },
    {
      order: 2,
    ...
    phases: [
      {
        name: "Monitoring",
        duration: "30+ days",
        description: "Track investigation",
      },
      {
        name: "Analysis",
        duration: "1-5 days",
        description: "Identify violations",
      },
      {
        name: "Documentation",
        duration: "1-3 days",
        description: "Build case",
      },
  ...
  expectedOutcomes: [
    {
      outcome: "Item deleted",
      probability: 0.5,
      description: "Bureau removes due to violation",
    },
    {
      outcome: "Re-investigation",
      probability: 0.3,
      description: "Bureau conducts proper investigation",
    },
    {
      outcome: "No change",
      probability: 0.2,
      description: "Bureau disputes violation claim",
    },
  ],
  whenToUse: [
...
export const DEBT_VALIDATION: AdvancedStrategy = {
  ...
  description:
    "Use FDCPA §809(b) to demand debt validation from collectors, which can lead to deletion if they cannot validate.",
  legalBasis: [
    {
      law: "FDCPA",
      section: "§809(b)",
  ...
  steps: [
    {
      ...
      description:
        "Within 30 days of first contact, send debt validation letter",
      duration: "30 days",
      documents: ["Debt validation letter", "Certified mail receipt"],
      tips: [
        "Must be within 30 days of initial contact",
    ...
    },
    {
      ...
      tips: [
        "Check for original signed agreement",
  ...
  timeline: {
    ...
    phases: [
      ...
      },
      {
        name: "Challenge",
        duration: "30 days",
        description: "Challenge inadequate DV",
      },
      {
        name: "Bureau Dispute",
        duration: "30 days",
        description: "Dispute with bureaus",
      },
    ],
  },
  riskLevel: "low",
  ...
  expectedOutcomes: [
    {
      outcome: "Debt deleted",
      probability: 0.45,
      description: "Collector cannot validate",
    },
    {
      outcome: "Debt validated",
      probability: 0.35,
      description: "Collector provides documents",
    },
    {
      outcome: "Collection stopped",
      probability: 0.15,
      description: "Collector ceases activity",
    },
    {
      outcome: "No response",
      probability: 0.05,
      description: "Collector ignores (violation)",
    },
  ],
  whenToUse: [
...
export const BUREAU_NEGLIGENCE: AdvancedStrategy = {
  ...
  description:
    "Build a case for bureau negligence when they fail to conduct reasonable investigations or maintain reasonable procedures.",
  legalBasis: [
    {
      law: "FCRA",
      section: "§607(b)",
  ...
  expectedOutcomes: [
    {
      outcome: "Settlement",
      probability: 0.4,
      description: "Bureau settles to avoid lawsuit",
    },
    {
      outcome: "Item removed",
      probability: 0.3,
      description: "Bureau removes to resolve",
    },
    {
      outcome: "Lawsuit filed",
      probability: 0.2,
      description: "Proceed to litigation",
    },
    {
      outcome: "No resolution",
      probability: 0.1,
      description: "Claim unsuccessful",
    },
  ],
  whenToUse: [
...
export const HYBRID_GOODWILL: AdvancedStrategy = {
  ...
  description:
    "Combine legal dispute tactics with relationship-building goodwill requests for maximum effectiveness.",
  legalBasis: [
    {
      law: "FCRA",
      section: "§623(a)(2)",
  ...
  expectedOutcomes: [
    {
      outcome: "Goodwill removal",
      probability: 0.35,
      description: "Creditor removes as courtesy",
    },
    {
      outcome: "Partial adjustment",
      probability: 0.25,
      description: "Some items removed",
    },
    {
      outcome: "Dispute success",
      probability: 0.2,
      description: "Technical dispute wins",
    },
    {
      outcome: "No change",
      probability: 0.2,
      description: "Both approaches fail",
    },
  ],
  whenToUse: [
 ...
 */
export function getStrategiesBySuccessRate(
  minRate: number = 50,
): AdvancedStrategy[] {
  return ALL_ADVANCED_STRATEGIES.filter((s) => s.successRate >= minRate).sort(
...
export function calculateStrategyEffectiveness(
  ...
  const results = new Map<
    string,
    { successRate: number; avgDays: number; totalUses: number }
  >();

  for (const strategy of ALL_ADVANCED_STRATEGIES) {
    const strategyData = trackingData.filter(
      (t) => t.strategyId === strategy.id && t.outcome,
    );
    ...
    const successes = strategyData.filter(
