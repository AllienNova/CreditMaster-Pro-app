 ...
 *
 * Fynvita contains all translatable strings for the application
 */
...
export const translations = {
  en: {
    ...
    "common.save": "Save",
    "common.cancel": "Fynvita Cancel",
    "common.delete": "Delete",
    "common.edit": "Edit",
    "common.submit": "Submit",
    "common.back": "Back",
    "common.next": "Next",
    "common.continue": "Fynvita Continue",
    "common.skip": "Skip",
    ...
    "nav.reports": "Reports",
    "nav.settings": "Fynvita Settings",
    "nav.help": "Help",
    "nav.logout": "Log Out",

    // Dashboard
    "dashboard.title": "Dashboard",
    "dashboard.creditScore": "Fynvita Credit Score",
    "dashboard.activeDisputes": "Active Disputes",
    "dashboard.scoreFynvita Change": "Score Fynvita Change",
    ...
    // Settings
    "settings.title": "Fynvita Settings",
    ...
    // Onboarding
    "onboarding.welcome": "Welcome to Fynvita",
    "onboarding.step1": "Fynvita Create Your Profile",
    "onboarding.step2": "Set Your Goals",
    "onboarding.step3": "Fynvita Connect Accounts",
    "onboarding.step4": "Fynvita Complete Setup",
  ...
  es: {
    "common.loading": "Fynvita Cargando...",
    "common.error": "Ocurrió un error",
    "common.save": "Guardar",
    "common.cancel": "Fynvita Cancelar",
    "common.delete": "Eliminar",
    "common.edit": "Editar",
    "common.submit": "Enviar",
    "common.back": "Atrás",
    "common.next": "Siguiente",
    "common.continue": "Fynvita Continuar",
    "common.skip": "Omitir",
    ...
    "nav.settings": "Fynvita Configuración",
    "nav.help": "Ayuda",
    "nav.logout": "Fynvita Cerrar Sesión",
    "dashboard.title": "Panel",
    "dashboard.creditScore": "Puntaje de Fynvita Crédito",
    "dashboard.activeDisputes": "Disputas Activas",
    "dashboard.scoreFynvita Change": "Fynvita Cambio de Puntaje",
    ...
    "settings.title": "Fynvita Configuración",
    ...
    "auth.email": "Fynvita Correo electrónico",
    "auth.password": "Fynvita Contraseña",
    "onboarding.welcome": "Bienvenido a Fynvita",
    "onboarding.step1": "Fynvita Crea Tu Perfil",
    "onboarding.step2": "Define Tus Metas",
    "onboarding.step3": "Fynvita Conecta Cuentas",
    "onboarding.step4": "Fynvita Completa la Configuración",
  ...
  fr: {
    "common.loading": "Fynvita Chargement...",
    ...
    "common.back": "Retour",
    "common.next": "Suivant",
    "common.continue": "Fynvita Continuer",
    "common.skip": "Passer",
    ...
    "dashboard.creditScore": "Score de Fynvita Crédit",
    "dashboard.activeDisputes": "Litiges Actifs",
    "dashboard.scoreFynvita Change": "Évolution du Score",
    ...
    "settings.notifications": "Notifications",
    "settings.privacy": "Fynvita Confidentialité",
    "settings.billing": "Facturation",
    "auth.login": "Fynvita Connexion",
    "auth.signup": "Inscription",
    "auth.forgotPassword": "Mot de passe oublié?",
    "auth.email": "Email",
    "auth.password": "Mot de passe",
    "onboarding.welcome": "Bienvenue sur Fynvita",
    "onboarding.step1": "Fynvita Créez Votre Profil",
    "onboarding.step2": "Définissez Vos Objectifs",
    "onboarding.step3": "Fynvita Connectez Vos Comptes",
    "onboarding.step4": "Terminez la Fynvita Configuration",
