...
describe("InvestmentAnalysisEngine", () => {
  ...
  describe("analyzeInvestment", () => {
    ...
    it("should include correlation analysis", async () => {
      ...
      expect(
        result.correlationAnalysis.overallAlignment,
      ).toBeGreaterThanOrEqual(0);
      expect(result.correlationAnalysis.overallAlignment).toBeLessThanOrEqual(
        100,
      );
    ...
    it("should determine overall signal", async () => {
      ...
      expect(result.overallSignal).toMatch(
  ...
  describe("analyzePortfolio", () => {
    ...
    it("should analyze portfolio", async () => {
      const result = await engine.analyzePortfolio(
        "test-portfolio",
        mockHoldings,
        mockHistoricalData,
      );
  ...
  describe("Composite Scoring", () => {
    ...
    it("should weight technical analysis at 30%", async () => {
      ...
      expect(result.compositeScore.weights.technical).toBe(0.3);
    });
    ...
    it("should weight sentiment analysis at 20%", async () => {
      ...
      expect(result.compositeScore.weights.sentiment).toBe(0.2);
    });
