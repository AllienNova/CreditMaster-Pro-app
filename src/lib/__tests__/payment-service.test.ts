  ...
  describe("Refund Processing", () => {
    const calculateRefund = (
      ...
      if (daysSincePurchase <= refundPolicy.prorateDays) {
        ...
        const totalProrateDays =
          refundPolicy.prorateDays - refundPolicy.fullRefundDays;
    ...
    it("should give full refund within policy period", () => {
      const result = calculateRefund(100, 5, {
        fullRefundDays: 7,
        prorateDays: 30,
      });
    ...
    it("should give prorated refund after full refund period", () => {
      const result = calculateRefund(100, 15, {
        fullRefundDays: 7,
        prorateDays: 30,
      });
    ...
    it("should give no refund after prorate period", () => {
      const result = calculateRefund(100, 60, {
        fullRefundDays: 7,
        prorateDays: 30,
      });
