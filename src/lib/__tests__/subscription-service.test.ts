describe('SubscriptionService', () => {
  const plans = [
    { id: 'free', name: 'Free', price: 0, features: ['Basic monitoring', '1 dispute/month'] },
    { id: 'basic', name: 'Basic', price: 29, features: ['Full monitoring', '5 disputes/month', 'AI recommendations'] },
    { id: 'premium', name: 'Premium', price: 79, features: ['All bureaus', 'Unlimited disputes', 'Priority support', 'Student loans'] },
    { id: 'enterprise', name: 'Enterprise', price: 199, features: ['All Premium', 'Dedicated support', 'API access', 'Custom integrations'] },
  ];
  ...
  describe('Subscription Status', () => {
    const statuses = ['active', 'canceled', 'past_due', 'trialing', 'incomplete', 'paused'];
    ...
    it('should identify payment issues', () => {
      const hasPaymentIssue = (status: string) => status === 'past_due' || status === 'incomplete';
  ...
  describe('Billing Calculations', () => {
    ...
    it('should calculate prorated amount', () => {
      const calculateProration = (daysRemaining: number, totalDays: number, price: number) => {
  ...
  describe('Cancellation', () => {
    it('should calculate refund amount', () => {
      const calculateRefund = (daysUsed: number, totalDays: number, price: number) => {
