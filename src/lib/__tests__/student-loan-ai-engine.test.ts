  ...
  compliance_violations: [
    {
      violation_type: 'FCRA',
      regulation: '623(a)',
      description: 'Incorrect default reporting',
      severity: 'major',
      evidence: { snapshot: 'report' },
      potential_damages: '$1,000 statutory',
      enforcement_actions: ['CFPB complaint'],
  ...
  exploitation_opportunities: [
    {
      ...
      required_actions: ['Compile statements'],
      timeline: '30 days',
      documentation_needed: ['Payment history'],
