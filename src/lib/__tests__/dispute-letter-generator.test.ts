...
describe("Dispute Letter Generator", () => {
  describe("Template Selection", () => {
    const templates = {
      not_mine:
        "I am writing to dispute the following account that does not belong to me.",
      incorrect_balance:
        "I am writing to dispute the incorrect balance reported on my account.",
      paid_collection:
        "I am writing to dispute a collection that has been paid in full.",
      late_payment:
        "I am writing to dispute a late payment that was reported in error.",
      identity_theft:
        "I am a victim of identity theft and am disputing fraudulent accounts.",
    };
