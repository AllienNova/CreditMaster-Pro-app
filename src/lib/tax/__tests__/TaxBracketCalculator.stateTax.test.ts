...
describe("TaxBracketCalculator — State Tax Methods", () => {
  ...
  describe("calculateStateTaxPublic", () => {
    it("should return 0 for no-income-tax states", () => {
      ...
      for (const state of noTaxStates) {
        const tax = calculator.calculateStateTaxPublic(
          100000,
          state,
          FilingStatus.SINGLE,
        );
    ...
    it("should handle married filing jointly for CA", () => {
      const singleTax = calculator.calculateStateTaxPublic(
        100000,
        "CA",
        FilingStatus.SINGLE,
      );
      const marriedTax = calculator.calculateStateTaxPublic(
        100000,
        "CA",
  ...
  describe("getStateTaxSummary", () => {
    it("should return complete summary for CA", () => {
      const summary = calculator.getStateTaxSummary(
        100000,
        "CA",
        FilingStatus.SINGLE,
      );
