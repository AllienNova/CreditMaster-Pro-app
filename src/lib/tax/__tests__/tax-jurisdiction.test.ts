...
describe('Tax Jurisdiction Types & Helpers', () => {
  ...
  describe('FEDERAL_TAX_BRACKETS_2024', () => {
    it('should have brackets for all filing statuses', () => {
      ...
      expect(FEDERAL_TAX_BRACKETS_2024).toHaveProperty(FilingStatus.MARRIED_FILING_JOINTLY);
      expect(FEDERAL_TAX_BRACKETS_2024).toHaveProperty(FilingStatus.MARRIED_FILING_SEPARATELY);
      expect(FEDERAL_TAX_BRACKETS_2024).toHaveProperty(FilingStatus.HEAD_OF_HOUSEHOLD);
    });
    ...
    it('should have wider brackets for married filing jointly', () => {
      ...
      const married = FEDERAL_TAX_BRACKETS_2024[FilingStatus.MARRIED_FILING_JOINTLY];
    ...
    it('should have 7 brackets for all filing statuses', () => {
      expect(FEDERAL_TAX_BRACKETS_2024[FilingStatus.MARRIED_FILING_JOINTLY]).toHaveLength(7);
      expect(FEDERAL_TAX_BRACKETS_2024[FilingStatus.MARRIED_FILING_SEPARATELY]).toHaveLength(7);
      expect(FEDERAL_TAX_BRACKETS_2024[FilingStatus.HEAD_OF_HOUSEHOLD]).toHaveLength(7);
    });
  });
  ...
  describe('LTCG_BRACKETS_2024', () => {
    it('should have brackets for all filing statuses', () => {
      ...
      expect(LTCG_BRACKETS_2024).toHaveProperty(FilingStatus.MARRIED_FILING_JOINTLY);
    });
    ...
    it('should end at 20% rate', () => {
      ...
      expect(brackets[brackets.length - 1].rate).toBe(0.20);
    });
