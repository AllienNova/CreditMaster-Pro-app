...
export const pricingTiers: PricingTier[] = [
  ...
  },
  {
    ...
    priceSuffix: "/month",
    priceId:
      process.env.NEXT_PUBLIC_STRIPE_STANDARD_PRICE_ID || "price_standard",
    annualPriceId:
      process.env.NEXT_PUBLIC_STRIPE_STANDARD_ANNUAL_PRICE_ID ||
  ...
  },
  {
    ...
    priceSuffix: "/month",
    priceId:
      process.env.NEXT_PUBLIC_STRIPE_FAMILY_DUO_PRICE_ID || "price_family_duo",
    annualPriceId:
      process.env.NEXT_PUBLIC_STRIPE_FAMILY_DUO_ANNUAL_PRICE_ID ||
      "price_family_duo_annual",
  ...
  },
  {
    ...
    price: "199.99",
    priceNumber: 199.99,
    annualPrice: 1967.9, // $199.99 * 12 * 0.82 = 18% off
    priceSuffix: "/month",
  ...
  },
  {
    ...
    price: "399.99",
    priceNumber: 399.99,
    annualPrice: 3935.9, // $399.99 * 12 * 0.82 = 18% off
    priceSuffix: "/month",
    priceId:
      process.env.NEXT_PUBLIC_STRIPE_FAMILY_PLUS_PRICE_ID ||
      "price_family_plus",
    annualPriceId:
      process.env.NEXT_PUBLIC_STRIPE_FAMILY_PLUS_ANNUAL_PRICE_ID ||
      "price_family_plus_annual",
...
export const addOns: AddOn[] = [
  {
    ...
    description:
      "Full credit reports from all 3 bureaus with detailed analysis",
    price: 19.99,
    priceId:
      process.env.NEXT_PUBLIC_STRIPE_ADDON_CREDIT_REPORT ||
      "price_addon_credit_report",
  ...
  },
  {
    ...
    description:
      "Advanced identity monitoring, dark web scanning, and $1M insurance",
    price: 14.99,
    priceId:
      process.env.NEXT_PUBLIC_STRIPE_ADDON_IDENTITY || "price_addon_identity",
  ...
  },
  {
    ...
    price: 29.99,
    priceId:
      process.env.NEXT_PUBLIC_STRIPE_ADDON_SUPPORT || "price_addon_support",
  ...
  },
  {
    ...
    price: 19.99,
    priceId:
      process.env.NEXT_PUBLIC_STRIPE_ADDON_CRYPTO || "price_addon_crypto",
    ...
    features: [
      {
        ...
        free: "1 bureau",
        standard: "All 3 bureaus",
        pro: "All 3 bureaus",
        familyDuo: "All 3 bureaus",
        family: "All 3 bureaus",
        familyPlus: "All 3 bureaus",
      },
      {
    ...
    features: [
      {
        ...
        standard: "AI-powered",
        pro: "AI-powered",
        familyDuo: "AI-powered",
        family: "AI-powered",
        familyPlus: "AI-powered",
      },
      {
        name: "Bill Detection & Alerts",
        free: false,
        standard: true,
        pro: true,
        familyDuo: true,
      ...
      {
        name: "Bill Negotiation Assistance",
        free: false,
        standard: false,
        pro: "Included (no fees)",
        familyDuo: "Included (no fees)",
        family: "Included (no fees)",
        familyPlus: "Included (no fees)",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        pro: "Chat & Phone",
        familyDuo: "Priority Support",
        family: "Priority Support",
        familyPlus: "Dedicated Manager",
      },
      {
        name: "Response Time",
        free: "48-72 hours",
