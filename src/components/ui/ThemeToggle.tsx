    ...
    return (
      ...
      >
        <div className="relative w-5 h-5">
          <div
            className={`absolute inset-0 transition-transform duration-300 ${resolvedTheme === "dark" ? "rotate-0 opacity-100" : "rotate-90 opacity-0"}`}
          >
            <MoonIcon />
          </div>
          <div
            className={`absolute inset-0 transition-transform duration-300 ${resolvedTheme === "light" ? "rotate-0 opacity-100" : "-rotate-90 opacity-0"}`}
          >
            <SunIcon />
          </div>
        </div>
