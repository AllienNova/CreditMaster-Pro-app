...
type DisputeAction = "send" | "update_status" | "resolve" | "add_note";
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <span
            className={`px-4 py-2 rounded-full text-sm font-medium ${statusColors[dispute.status]}`}
          >
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <p
                  className={`text-lg font-semibold ${bureauColors[dispute.bureau]}`}
                >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {dispute.estimatedResolutionDate && (
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-white">
                      {formatDate(dispute.estimatedResolutionDate)}
                    </p>
                  </div>
                )}
                {dispute.resolvedAt && (
