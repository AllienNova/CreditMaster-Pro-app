      ...
      <div className="p-6">
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-gray-700 dark:text-slate-200">Success Probability</span>
        ...
        <div className="mb-4 p-4 bg-gray-50 dark:bg-slate-900 rounded-lg">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-sm font-medium text-gray-700 dark:text-slate-200">Estimated Timeline</span>
          </div>
          <p className="text-lg font-bold text-gray-900 dark:text-white ml-7">
        ...
        <div className="mb-4">
          <h4 className="text-sm font-medium text-gray-700 dark:text-slate-200 mb-2">Required Documentation</h4>
          <div className="space-y-2">
            ...
            {strategy.required_documentation.length > 3 && (
              <p className="text-xs text-gray-500 dark:text-slate-400 ml-7">
        ...
        {strategy.legal_precedents && strategy.legal_precedents.length > 0 && (
          <div className="mb-4">
            <h4 className="text-sm font-medium text-gray-700 dark:text-slate-200 mb-2">Legal Precedents</h4>
            <div className="space-y-2">
              {strategy.legal_precedents.slice(0, 2).map((precedent, index) => (
                <div key={index} className="flex items-start gap-2">
                  ...
                  <span className="text-sm text-gray-700 dark:text-slate-200">{precedent}</span>
                </div>
              ))}
