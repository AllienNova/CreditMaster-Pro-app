...
export default function FinancialReports() {
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      alert(`Report generated successfully! Format: ${config.format.toUpperCase()}`);
    } catch (error) {
  ...
  const savedReports = [
    { id: '1', name: 'January 2025 Report', date: new Date('2025-02-01'), format: 'pdf', size: '2.4 MB' },
    { id: '2', name: 'Q4 2024 Report', date: new Date('2025-01-01'), format: 'excel', size: '1.8 MB' },
    { id: '3', name: 'Annual 2024 Report', date: new Date('2025-01-15'), format: 'pdf', size: '5.2 MB' },
  ];
