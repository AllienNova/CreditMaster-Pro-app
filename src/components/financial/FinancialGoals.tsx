...
export default function FinancialGoals() {
  ...
  const handleCreateGoal = async (e: React.FormEvent) => {
    ...
    try {
      const userId = 'user_123'; // TODO: Replace with actual auth
    ...
    return (
      <div className="bg-white rounded-lg shadow p-6">
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Error Loading Goals</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-gray-600">Total Goals</h3>
            <span className="text-2xl">🎯</span>
          </div>
          <div className="text-3xl font-bold text-gray-900">{goals.length}</div>
          <div className="text-sm text-gray-500 mt-1">{activeGoals.length} active</div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="text-sm text-gray-500 mt-1">Total target</div>
        </div>

        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-gray-600">Current Progress</h3>
            <span className="text-2xl">📊</span>
          </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-xs text-gray-500 capitalize">{goal.type.replace('_', ' ')}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-bold text-gray-900">{formatCurrency(goal.targetAmount)}</div>
                    </div>
                  </div>
