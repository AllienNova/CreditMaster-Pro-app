    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-gray-600">Min Payment</h3>
            <span className="text-2xl">💸</span>
          </div>
          <div className="text-3xl font-bold text-gray-900">{formatCurrency(totalMinimum)}</div>
          <div className="text-sm text-gray-500 mt-1">Per month</div>
        </div>

        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-gray-600">Avg Interest</h3>
            <span className="text-2xl">📊</span>
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-gray-600">Payoff Date</h3>
            <span className="text-2xl">📅</span>
          </div>
      ...
      {debts.length === 0 ? (
        <div className="bg-white rounded-lg shadow p-12">
          <div className="text-center max-w-md mx-auto">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-4">No Debts Found!</h3>
      ...
      {payoffStrategy && (
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-xl font-bold text-gray-900 mb-6">12-Month Payoff Timeline</h3>
          <div className="space-y-3">
            {payoffStrategy.timeline.map((month) => {
              ...
              return (
                <div key={month.month}>
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-semibold text-gray-900">Month {month.month}</span>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-bold text-gray-900">{formatCurrency(payoffStrategy.totalInterest)}</span>
            </div>
          </div>
        </div>
      )}
