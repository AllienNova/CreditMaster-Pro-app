    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-gray-600">Monthly Growth</h3>
            <span className="text-2xl">📈</span>
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-gray-600">Interest Earned</h3>
            <span className="text-2xl">💵</span>
          </div>
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600 mt-1">{data.accounts.length} accounts</p>
        </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  {account.availableBalance !== undefined && (
                    <div className="text-sm text-gray-500">Available: {formatCurrency(account.availableBalance)}</div>
                  )}
                </div>
              </div>
            </div>
      ...
      {/* Growth History */}
      <div className="bg-white rounded-lg shadow p-6">
        <h3 className="text-xl font-bold text-gray-900 mb-6">Savings Growth History</h3>
      ...
      {/* Projections */}
      <div className="bg-white rounded-lg shadow p-6">
        <h3 className="text-xl font-bold text-gray-900 mb-6">6-Month Savings Projection</h3>
        <div className="space-y-3">
