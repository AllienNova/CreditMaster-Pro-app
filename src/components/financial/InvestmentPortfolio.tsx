    ...
    return (
      <div className="bg-white rounded-lg shadow p-12">
        <div className="text-center max-w-md mx-auto">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-4">No Investment Accounts</h3>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-gray-600">Total Gain</h3>
            <span className="text-2xl">💰</span>
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-gray-600">Return</h3>
            <span className="text-2xl">📊</span>
          </div>
          <div className="text-3xl font-bold text-green-600">+{data.gainPercentage.toFixed(1)}%</div>
          <div className="text-sm text-gray-500 mt-1">Percentage gain</div>
        </div>

        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-gray-600">Accounts</h3>
            <span className="text-2xl">🏦</span>
          </div>
          <div className="text-3xl font-bold text-gray-900">{data.accounts.length}</div>
          <div className="text-sm text-gray-500 mt-1">Investment accounts</div>
        </div>
      </div>
