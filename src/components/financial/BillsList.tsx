  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-gray-900">Your Bills</h3>
      ...
      {sortedAndFilteredBills.length > 0 ? (
              ...
              <div className="flex items-start justify-between">
                ...
                <div className="text-right">
                  <div className="text-xl font-bold text-gray-900 mb-1">
                    ...
                    <span className="text-sm font-normal text-gray-500">/{bill.frequency === 'monthly' ? 'mo' : bill.frequency === 'quarterly' ? 'qtr' : 'yr'}</span>
                  </div>
        ...
        <div className="text-center py-12">
          ...
          <h4 className="text-lg font-semibold text-gray-900 mb-2">No Bills Found</h4>
          <p className="text-gray-600 mb-4">Add your recurring bills to get started</p>
