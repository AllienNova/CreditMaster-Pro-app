...
export default function AIFinancialCoach() {
  ...
  const [dashboardData, setDashboardData] = useState<CoachDashboardData | null>(
    null,
  );
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg shadow-lg p-8 text-white">
        ...
        <p className="text-blue-100 text-lg">
          Let's work together to achieve your financial goals using proven
          strategies
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span
              className={`text-2xl font-bold ${getHealthScoreColor(snapshot.healthScore)}`}
            >
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
          <div className="text-gray-600 dark:text-slate-300 text-sm font-medium mb-2">
            Net Worth
          </div>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
        ...
        <div className="space-y-4">
          {babySteps.map((step) => (
            <div
              key={step.step}
              className={`border rounded-lg p-4 ${step.completed ? "bg-green-50 border-green-200" : "bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700"}`}
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center mb-2">
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold mr-3 ${step.completed ? "bg-green-500 text-white" : "bg-gray-200 dark:bg-slate-700 text-gray-600 dark:text-slate-300"}`}
                    >
                      {step.step}
                    </div>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
        ...
        <div className="space-y-4">
          {recommendations.slice(0, 5).map((rec) => (
            <div
              key={rec.id}
              className="border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:border-blue-300 transition-colors"
            >
      ...
      {selectedPlan && (
        ...
        >
          <div className="space-y-4">
            <div>
              <span
                className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${getPriorityColor(selectedPlan.priority)}`}
              >
