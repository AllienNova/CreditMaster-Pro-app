  ...
  const getInsightColor = (type: AIInsight["type"]) => {
    switch (type) {
      ...
      case "prediction":
        return "bg-blue-50 border-blue-200 text-blue-800";
      default:
        return "bg-gray-50 dark:bg-slate-900 border-gray-200 dark:border-slate-700 text-gray-800 dark:text-slate-100";
    }
  };
                ...
                {data.predictions.slice(0, 3).map((prediction, index) => (
                  ...
                  >
                    ...
                    <div className="text-xs opacity-75">
                      {prediction.timeframe} • {prediction.confidence}%
                      confidence
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span
                            className={`text-xs px-2 py-0.5 rounded-full font-medium ${getImpactBadge(insight.impact)}`}
                          >
