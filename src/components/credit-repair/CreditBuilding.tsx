  ...
  const strategies: BuildingStrategy[] = [
    {
      ...
      description:
        "A credit card that requires a security deposit. Your deposit becomes your credit limit.",
      pros: [
    ...
    },
    {
      ...
      description:
        "A small loan where the money is held in an account while you make payments.",
      pros: [
        "Builds payment history",
    ...
    },
    {
      ...
      description:
        "Get added to someone else's credit card account to benefit from their good history.",
      pros: [
    ...
    },
    {
      ...
      description:
        "Specialized credit builder accounts that report to all 3 bureaus.",
      pros: [
        "Reports to all 3 bureaus",
    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="bg-yellow-50 border-2 border-yellow-400 rounded-lg p-6 mb-6">
        ...
        <div className="space-y-2 text-sm text-yellow-800">
          <p className="font-semibold">
            Credit Karma pushes these strategies because they make money from
            them. But they're the SLOWEST and most EXPENSIVE way to improve your
            credit.
          </p>
          ...
          <div className="mt-3 p-3 bg-white dark:bg-slate-800 rounded">
            <div className="font-semibold text-gray-800 dark:text-slate-100 mb-2">
              Then Do This (6-12 months):
            </div>
            <p className="text-gray-700 dark:text-slate-200">
              Once your report is clean, use these building strategies to
              maintain and slowly grow your score.
            </p>
          </div>
        </div>
      </div>
          ...
          {!selected.recommended && (
            <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg">
              <p className="text-sm text-red-700">
                <strong>Not Recommended:</strong> This strategy is expensive and
                slow. Consider other options first.
              </p>
            </div>
          )}
        </div>
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <p className="text-sm text-blue-700">
          These strategies are for <strong>building</strong> credit, not{" "}
          <strong>repairing</strong> it. If you have negative items on your
          report, focus on removing those first. You'll see results 3-5x faster
