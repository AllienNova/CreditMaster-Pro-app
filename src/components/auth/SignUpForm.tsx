    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 w-full max-w-md border border-gray-100 dark:border-slate-700">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 dark:text-slate-300 mt-2">
          Begin your path to financial vitality
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-start">
          <input
            ...
            className="w-4 h-4 mt-1 text-blue-600 border-gray-300 dark:border-slate-600 rounded focus:ring-2 focus:ring-blue-500"
          />
          <label
            htmlFor="terms"
