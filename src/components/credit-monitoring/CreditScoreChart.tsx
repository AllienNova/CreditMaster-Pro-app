...
export default function CreditScoreChart({ history }: CreditScoreChartProps) {
  ...
  const [timeRange, setTimeRange] = useState<"30" | "90" | "180" | "365">(
    "365",
  );
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        ...
        <div className="flex gap-2">
          {history.map((bureauHistory) => (
            ...
            >
              {bureauHistory.bureau.charAt(0).toUpperCase() +
                bureauHistory.bureau.slice(1)}
            </button>
          ))}
        </div>
