  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <span className={`text-lg font-semibold ${dashboard.scoreChange30Days >= 0 ? 'text-green-300' : 'text-red-300'}`}>
                {dashboard.scoreChange30Days >= 0 ? '+' : ''}{dashboard.scoreChange30Days}
              </span>
            </div>
            <div className="mt-1 flex items-center gap-2">
              <span className="text-sm">90-day change:</span>
              <span className={`text-lg font-semibold ${dashboard.scoreChange90Days >= 0 ? 'text-green-300' : 'text-red-300'}`}>
                {dashboard.scoreChange90Days >= 0 ? '+' : ''}{dashboard.scoreChange90Days}
              </span>
            </div>
          </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <CreditAlertsList alerts={dashboard.alerts} onRefresh={fetchDashboard} />
      </div>
