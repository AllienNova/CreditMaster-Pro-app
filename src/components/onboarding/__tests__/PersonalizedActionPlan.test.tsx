...
describe('PersonalizedActionPlan — rendering', () => {
  ...
  it('renders the description text', () => {
    ...
    expect(
      screen.getByText(/Based on your goals, here are the most impactful steps/)
    ).toBeInTheDocument();
  });
});
...
describe('PersonalizedActionPlan — goal steps', () => {
  ...
  it('shows credit_cards steps', () => {
    ...
    expect(screen.getByText('Request Credit Limit Increases')).toBeInTheDocument();
  });
...
describe('PersonalizedActionPlan — top 5 limit', () => {
  it('renders at most 5 steps even with many goals', () => {
    ...
    render(
      <PersonalizedActionPlan
        selectedGoals={['buy_home', 'buy_car', 'credit_cards', 'lower_rates', 'remove_negatives', 'build_credit']}
        currentScore="below_580"
        targetScore="670_739"
        timeframe="6_months"
      />
...
describe('PersonalizedActionPlan — step details', () => {
  it('displays description, timeframe, and impact for each step', () => {
    ...
    expect(screen.getByText('Remove errors and outdated negative items from your reports')).toBeInTheDocument();
