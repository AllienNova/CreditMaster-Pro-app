...
describe('ImpactCalculator — null returns', () => {
  it('returns null when currentScore is empty', () => {
    const { container } = render(
      <ImpactCalculator currentScore="" targetScore="800_plus" timeframe="6_months" selectedGoals={[]} />
    );
  ...
  it('returns null when targetScore is empty', () => {
    const { container } = render(
      <ImpactCalculator currentScore="below_580" targetScore="" timeframe="6_months" selectedGoals={[]} />
    );
    expect(container.firstChild).toBeNull();
  });
  ...
  it('returns null when timeframe is empty', () => {
    const { container } = render(
      <ImpactCalculator currentScore="below_580" targetScore="800_plus" timeframe="" selectedGoals={[]} />
    );
    expect(container.firstChild).toBeNull();
  });
  ...
  it('returns null when target <= current (no improvement needed)', () => {
    const { container } = render(
      <ImpactCalculator currentScore="800_plus" targetScore="below_580" timeframe="6_months" selectedGoals={[]} />
    );
    expect(container.firstChild).toBeNull();
  });
  ...
  it('returns null when target equals current', () => {
    const { container } = render(
      <ImpactCalculator currentScore="670_739" targetScore="670_739" timeframe="6_months" selectedGoals={[]} />
    );
    expect(container.firstChild).toBeNull();
  });
});
...
describe('ImpactCalculator — rendering', () => {
  it('renders the Impact Forecast heading', () => {
    render(
      <ImpactCalculator currentScore="below_580" targetScore="670_739" timeframe="6_months" selectedGoals={[]} />
    );
...
describe('ImpactCalculator — timeframe parsing', () => {
  it('uses 3 months for 3_months timeframe', () => {
    ...
    render(
      <ImpactCalculator currentScore="below_580" targetScore="580_669" timeframe="3_months" selectedGoals={[]} />
    );
  ...
  it('uses 6 months for 6_months timeframe', () => {
    ...
    render(
      <ImpactCalculator currentScore="below_580" targetScore="580_669" timeframe="6_months" selectedGoals={[]} />
    );
  ...
  it('defaults to 12 months for other timeframes', () => {
    ...
    render(
      <ImpactCalculator currentScore="below_580" targetScore="580_669" timeframe="12_months" selectedGoals={[]} />
    );
  ...
  it('defaults to 12 months for unrecognized timeframe', () => {
    // 75/12 = 6.25 -> Math.round = 6
    render(
      <ImpactCalculator currentScore="below_580" targetScore="580_669" timeframe="24_months" selectedGoals={[]} />
    );
    expect(screen.getByText(/6 points\/month/)).toBeInTheDocument();
  });
});
...
describe('ImpactCalculator — feasibility', () => {
  ...
  it('shows feasibility tip when monthly improvement > 15 (not feasible)', () => {
    ...
    render(
      <ImpactCalculator currentScore="below_580" targetScore="800_plus" timeframe="3_months" selectedGoals={[]} />
    );
...
describe('ImpactCalculator — goal benefits', () => {
  ...
  it('displays benefits for known goals', () => {
    render(
      <ImpactCalculator currentScore="below_580" targetScore="670_739" timeframe="6_months" selectedGoals={['buy_home']} />
    );
    expect(screen.getByText("What You'll Unlock:")).toBeInTheDocument();
    expect(screen.getByText('Qualify for better mortgage rates')).toBeInTheDocument();
  ...
  it('displays up to 3 goal benefits', () => {
    ...
    expect(screen.getByText('Qualify for better mortgage rates')).toBeInTheDocument();
    expect(screen.getByText('Unlock premium rewards cards')).toBeInTheDocument();
  ...
  it('shows "+N more" when more than 3 goals selected', () => {
    render(
      <ImpactCalculator
        ...
        targetScore="670_739"
        timeframe="6_months"
        selectedGoals={['buy_home', 'credit_cards', 'lower_rates', 'build_credit', 'remove_negatives']}
      />
    );
