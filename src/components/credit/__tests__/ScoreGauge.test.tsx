...
import ScoreGauge, { getScoreColor, getScoreLabel, getScoreBgColor, getScoreTextColor } from '../ScoreGauge';
...
describe('ScoreGauge Component', () => {
  describe('Score Display', () => {
    ...
    it('should have proper aria-label for accessibility', () => {
      render(<ScoreGauge score={750} />);
      expect(screen.getByRole('img')).toHaveAttribute('aria-label', 'Credit score 750, rated Very Good');
    });
  });
