...
jest.mock('../voice-assistant/VoiceAssistant', () => ({
  VoiceAssistant: ({ onTranscript, onResponse, placeholder, className }: {
...
describe('VoiceAssistant', () => {
  it('renders with default placeholder', () => {
    ...
    expect(screen.getByPlaceholderText('Type or speak your question...')).toBeInTheDocument();
  });

  it('renders with custom placeholder', () => {
    render(<VoiceAssistant onTranscript={jest.fn()} placeholder="Ask me anything..." />);
  ...
  it('applies custom className', () => {
    render(<VoiceAssistant onTranscript={jest.fn()} className="custom-class" />);
  ...
  it('shows initial assistant message', () => {
    ...
    expect(screen.getByText(/How can I help with your credit repair/)).toBeInTheDocument();
  });
});
