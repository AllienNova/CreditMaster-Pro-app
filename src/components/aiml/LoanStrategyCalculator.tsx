...
export default function LoanStrategyCalculator({
  onCalculate,
}: LoanStrategyCalculatorProps) {
        ...
        body: JSON.stringify({
          loanData: {
            ...
            monthlyPayment: loanData.monthlyPayment
              ? parseFloat(loanData.monthlyPayment)
              : undefined,
          },
          financialSituation: {
    ...
    <div className="loan-strategy-calculator">
      <div className="max-w-4xl mx-auto p-6">
        ...
        <p className="text-gray-600 dark:text-slate-300 mb-8">
          Calculate optimal repayment strategy using DeepSeek V3.1 Terminus's
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLoanData({ ...loanData, totalBalance: e.target.value })
                  }
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setLoanData({ ...loanData, loanType: e.target.value })
                  }
                  className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLoanData({ ...loanData, servicer: e.target.value })
                  }
                  className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLoanData({ ...loanData, monthlyPayment: e.target.value })
                  }
                  className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                  placeholder="500"
                />
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-lg shadow-lg p-6">
                ...
                <h4 className="text-xl font-semibold mb-2">
                  {strategy.recommended_plan.name}
                </h4>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {formatCurrency(
                        strategy.recommended_plan.monthly_payment,
                      )}
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {formatCurrency(strategy.recommended_plan.total_cost)}
                    </p>
                  </div>
                </div>
                {strategy.recommended_plan.forgiveness_eligible && (
                  <div className="mt-4 bg-white dark:bg-slate-800 bg-opacity-20 rounded p-3">
                    ...
                    <p className="text-sm">
                      {strategy.recommended_plan.forgiveness_timeline}
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
                ...
                {strategy.pslf_analysis.eligible ? (
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        ...
                        <p className="text-xl font-bold">
                          {strategy.pslf_analysis.qualifying_payments}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600 dark:text-slate-300">
                        ...
                        <p className="text-xl font-bold">
                          {strategy.pslf_analysis.remaining_payments}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600 dark:text-slate-300">
                        ...
                        <p className="text-xl font-bold">
                          {formatCurrency(
                            strategy.pslf_analysis.estimated_forgiveness_amount,
                          )}
                        </p>
                      </div>
                    </div>
                  ...
                  <p className="text-gray-600 dark:text-slate-300">
                    You are not currently eligible for PSLF based on your
                    employment type.
                  </p>
                )}
              </div>
              ...
              {strategy.alternative_plans.length > 0 && (
                <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
                  ...
                  <div className="space-y-4">
                    {strategy.alternative_plans.map(
                      (plan: AlternativePlan, i: number) => (
