    ...
    >
      ...
      <div className="p-6 border-b border-gray-800">
        ...
        <p className="text-gray-400 dark:text-slate-500 mb-6">
          Unified analysis combining Technical, Fundamental, Sentiment, Pattern
          Recognition, AI Recommendations, and Portfolio Analysis
        </p>
        ...
        <div className="flex gap-4">
          <div className="flex-1">
            <div className="flex items-center justify-between mb-2">
              <label className="block text-sm font-medium text-gray-400 dark:text-slate-500">
                Stock Symbol
              </label>
              {realtimePrice && (
      ...
      <div className="p-6">
        ...
        {!loading && !error && !analysis && (
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-500 dark:text-slate-400 mt-2">
              Get comprehensive insights from technical, fundamental, sentiment,
              and AI analysis
            </p>
          </div>
        )}
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="flex items-center gap-4">
            <div
              className={`px-4 py-2 ${config.color} rounded-lg font-bold text-white text-lg`}
            >
...
function CompositeScoreGrid({ analysis }: { analysis: AnalysisResult }) {
  const scores = [
    {
      label: "Overall",
      value: analysis.compositeScore.overall,
      icon: "sparkles",
    },
    {
      label: "Technical",
      value: analysis.compositeScore.technical,
      icon: "sparkles",
    },
    {
      label: "Fundamental",
      value: analysis.compositeScore.fundamental,
      icon: "sparkles",
    },
    {
      label: "Sentiment",
      value: analysis.compositeScore.sentiment,
      icon: "sparkles",
    },
    {
      label: "Pattern",
      value: analysis.compositeScore.pattern,
      icon: "sparkles",
    },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        {scores.map((score) => (
          <div key={score.label} className="bg-gray-900/50 rounded-lg p-4">
            ...
            <div
              className={`text-3xl font-bold text-center ${getScoreColor(score.value)}`}
            >
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 dark:text-slate-500 text-sm">
            Alignment Score:{" "}
            {(analysis.correlationAnalysis.overallAlignment * 100).toFixed(1)}%
          </p>
        </div>
