...
describe('CreditReportImport', () => {
  ...
  it('should render without errors', () => {
    const { container } = render(<CreditReportImport onImportComplete={mockOnImportComplete} />);
  ...
  it('should accept onError callback', () => {
    ...
    render(<CreditReportImport onImportComplete={mockOnImportComplete} onError={mockOnError} />);
