...
export default function CreditReportImport({ onImportComplete, onError }: CreditReportImportProps) {
  ...
  const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!validTypes.includes(file.type)) {
      setErrorMessage('Invalid file type. Please upload a PDF, TXT, or HTML file.');
      return;
    }
    ...
    try {
      ...
      setSuccessMessage(`Credit report imported successfully! Found ${result.accountsCount} accounts.`);
