                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <h3 className="text-lg font-semibold text-gray-900">{account.creditorName}</h3>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        <div>
                          ...
                          <div className="font-medium text-gray-900">***{account.accountNumber.slice(-4)}</div>
                        </div>
                        <div>
            ...
            {filteredInquiries.length === 0 ? (
              ...
              filteredInquiries.map((inquiry) => (
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold text-gray-900 mb-2">{inquiry.creditorName}</h3>
