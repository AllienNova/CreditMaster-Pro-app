      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div className="bg-white rounded-lg p-4 border border-gray-200">
            <h4 className="text-sm font-medium text-gray-700 mb-2">Automation Level</h4>
            ...
            <p className="text-xs text-gray-600 mt-1">{getAutomationLevelLabel(strategy.automation_level)}</p>
          </div>

          <div className="bg-white rounded-lg p-4 border border-gray-200">
            <h4 className="text-sm font-medium text-gray-700 mb-2">Strategy Type</h4>
        ...
        {strategy.predictive_analysis && (
          <div className="grid grid-cols-3 gap-4 mb-4 p-4 bg-gray-50 rounded-lg">
            ...
            <div>
              <p className="text-xs text-gray-500 mb-1">Credit Impact</p>
              <p className="text-lg font-bold text-gray-900">
