    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-6 border border-purple-200">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-700">AI-powered predictions based on historical data and patterns</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-sm font-medium text-gray-600">Credit Impact</h3>
          </div>
          <p className="text-3xl font-bold text-green-600">
            +{analysis.predicted_credit_impact}
          </p>
          <p className="text-xs text-gray-500 mt-1">Points increase</p>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-sm font-medium text-gray-600">Financial Impact</h3>
          </div>
          <p className="text-3xl font-bold text-green-600">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900">Key Success Factors</h3>
        </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900">Potential Obstacles</h3>
        </div>
        <div className="space-y-3">
          {analysis.potential_obstacles.map((obstacle, index) => (
            <div key={index} className="flex items-start gap-3 p-3 bg-red-50 rounded-lg border border-red-200">
              ...
              <p className="text-sm text-gray-700 flex-1">{obstacle}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-6 border border-gray-200">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Analysis Confidence Breakdown</h3>
        <div className="space-y-3">
          <div>
          ...
          <div>
            <div className="flex justify-between text-sm mb-1">
              ...
              <span className="text-gray-900 font-medium">{Math.round(analysis.confidence_level * 100)}%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
          ...
          <div>
            <div className="flex justify-between text-sm mb-1">
              <span className="text-gray-700">Historical Similarity</span>
