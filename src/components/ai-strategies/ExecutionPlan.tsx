    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border border-blue-200">
        <div className="flex items-start justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Execution Plan</h2>
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          {plan.started_at && (
            <div>
              ...
              <p className="text-sm font-medium text-gray-900">{formatDate(plan.started_at)}</p>
            </div>
          )}
          {plan.completed_at && (
            <div>
              <p className="text-xs text-gray-600 mb-1">Completed</p>
              <p className="text-sm font-medium text-gray-900">{formatDate(plan.completed_at)}</p>
            </div>
          )}
        </div>
      </div>
      ...
      {plan.manual_interventions && plan.manual_interventions.length > 0 && (
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900">Manual Interventions Required</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {plan.monitoring_schedule.estimated_timeline && (
              <div className="p-4 bg-gray-50 rounded-lg">
                <p className="text-xs text-gray-600 mb-1">Estimated Timeline</p>
            ...
            {plan.monitoring_schedule.parallel_execution_groups && (
              <div className="p-4 bg-gray-50 rounded-lg">
                <p className="text-xs text-gray-600 mb-1">Parallel Groups</p>
                <p className="text-lg font-bold text-gray-900">
