        ...
        {isPositive ? (
          ...
          >
            <p style={{ color: '#065f46', margin: 0, fontSize: '14px' }}>
              Congratulations! Your hard work is paying off. Keep up the
              great progress!
            </p>
          </div>
        ) : (
          ...
          >
            <p style={{ color: '#991b1b', margin: 0, fontSize: '14px' }}>
              Don't worry! Log in to your dashboard to see what factors may
              have affected your score and get personalized recommendations.
            </p>
          </div>
        )}
