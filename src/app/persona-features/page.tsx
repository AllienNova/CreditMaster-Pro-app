import { CreditScoreSimulator, PSLFTracker, MortgageReadinessScore } from '@/components/persona';

export const metadata = {
  title: 'Persona Features - CreditMaster Pro',
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-12">
          ...
          <section id="credit-simulator">
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                For <span className="font-semibold text-blue-600">Sarah Martinez</span> - The Credit Rebuilder
              </p>
          ...
          <section id="pslf-tracker">
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                For <span className="font-semibold text-blue-600">James Chen</span> - The Student Loan Strategist
              </p>
              <p className="text-sm text-gray-500 mt-1">
          ...
          <section id="mortgage-readiness">
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                For <span className="font-semibold text-blue-600">Emily Parker</span> - The Mortgage Applicant
              </p>
              <p className="text-sm text-gray-500 mt-1">
        ...
        {/* Call to Action */}
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl shadow-xl p-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Ready to Transform Your Financial Future?
          </h2>
          <p className="text-xl text-blue-100 mb-6 max-w-2xl mx-auto">
            Get personalized recommendations and AI-powered tools to achieve your financial goals
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="/ai-tools"
              className="inline-flex items-center justify-center px-8 py-3 border-2 border-white text-base font-medium rounded-lg text-white hover:bg-white hover:text-blue-600 transition-colors"
            >
              Explore AI Tools
            </a>
          </div>
