...
export const metadata: Metadata = {
  ...
  description: 'AI-powered portfolio analysis, stock research, and investment insights.',
};
    ...
    <div className="min-h-screen bg-[#fbfbfd]">
        ...
        <div className="max-w-[980px] mx-auto px-6">
          <div className="flex justify-between items-center h-12">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/invest" className="text-xs text-purple-600 font-medium">Invest</Link>
      ...
      <section className="pt-32 pb-20">
        <div className="max-w-[980px] mx-auto px-6 text-center">
          <p className="text-purple-600 font-medium text-sm tracking-wide uppercase mb-4">
            Investments
          </p>
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8 leading-relaxed">
            Research stocks, analyze portfolios, and get AI-powered insights
            to make better investment decisions.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/auth/signup"
              className="text-lg bg-purple-600 text-white px-8 py-4 rounded-full hover:bg-purple-700 transition-colors font-medium"
            >
              Start Free Trial
            </Link>
            <Link
              href="#features"
              className="text-lg text-purple-600 px-8 py-4 rounded-full hover:bg-purple-50 transition-colors font-medium"
            >
              Learn more
            </Link>
          </div>
              ...
              <div className="bg-white/5 backdrop-blur rounded-2xl p-6 mb-6">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="text-right">
                    <p className="text-green-400 text-lg font-medium">+$12,456.78</p>
                    <p className="text-green-400 text-sm">+5.27% today</p>
                  </div>
                </div>
                {/* Simulated Chart */}
                <div className="h-32 flex items-end space-x-1">
                  {[40, 55, 45, 60, 70, 65, 80, 75, 85, 90, 88, 95].map((height, i) => (
                    <div key={i} className="flex-1 bg-gradient-to-t from-purple-500 to-pink-400 rounded-t" style={{ height: `${height}%` }}></div>
                  ))}
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Deep analysis of your portfolio&apos;s risk, diversification, and performance metrics.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                AI-powered stock screener with fundamental and technical analysis tools.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Track sector performance and identify emerging trends before they mainstream.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Set custom alerts for price movements, volume changes, and technical signals.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                AI analyzes news sentiment to help you understand market movements.
              </p>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">Fundamental analysis automation</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-purple-100 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-700">Real-time sentiment tracking</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-purple-100 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-700">Risk-adjusted recommendations</span>
                </li>
              </ul>
            </div>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">AAPL - Apple Inc.</p>
                    </div>
                  </div>
                  <span className="text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full">Buy</span>
                </div>
                <p className="text-sm text-gray-600 leading-relaxed">
                  Strong fundamentals with 15% YoY revenue growth. Technical indicators
                  show bullish momentum. Sentiment analysis positive across 89% of recent news.
                </p>
              </div>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Based on volatility</p>
                    </div>
                  </div>
        ...
        <div className="max-w-[980px] mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/investments/holdings" className="text-xs text-gray-600 hover:text-gray-900">Holdings</Link></li>
                <li><Link href="/investments" className="text-xs text-gray-600 hover:text-gray-900">Research</Link></li>
                <li><Link href="/investments" className="text-xs text-gray-600 hover:text-gray-900">Analysis</Link></li>
              </ul>
            </div>
            <div>
          ...
          <div className="pt-8 border-t border-gray-300">
            <p className="text-xs text-gray-600 text-center">
              Copyright &copy; {new Date().getFullYear()} CPFI. All rights reserved. Investment advice is for informational purposes only.
            </p>
          </div>
        </div>
      </footer>
