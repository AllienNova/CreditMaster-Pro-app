...
export const metadata: Metadata = {
  title: 'Student Loans | CPFI',
  description: 'Navigate student loan repayment with AI-powered strategies and federal program guidance.',
};
        ...
        <div className="max-w-[980px] mx-auto px-6">
          <div className="flex justify-between items-center h-12">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/loans" className="text-xs text-orange-600 font-medium">Student Loans</Link>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="text-gray-400 mb-6">
                    Import all your student loans and get a complete view of your debt,
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-gray-300">Federal & private loans</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-8 h-8 bg-orange-500/20 rounded-lg flex items-center justify-center">
                        <svg className="w-5 h-5 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <span className="text-gray-300">Automatic sync with servicers</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-8 h-8 bg-orange-500/20 rounded-lg flex items-center justify-center">
                        <svg className="w-5 h-5 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <span className="text-gray-300">Real-time interest tracking</span>
                    </div>
                  </div>
                </div>
                <div className="bg-white/10 backdrop-blur rounded-2xl p-6">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-orange-400 text-sm mt-2">4.5% weighted avg rate</p>
                  </div>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-300 text-sm">Federal Direct</span>
                      <span className="text-white font-medium">$52,340</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-300 text-sm">Federal Grad PLUS</span>
                      <span className="text-white font-medium">$12,500</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-300 text-sm">Private Loan</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Find the best federal repayment plan for your situation with AI recommendations.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Track your progress toward Public Service Loan Forgiveness with qualifying payment monitoring.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Compare different repayment strategies and see exactly how much you&apos;ll pay.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Optimize Income-Driven Repayment plans to minimize total payments over time.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Never miss a payment with automated reminders and payment scheduling.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Get reminded when it&apos;s time to recertify your income for IDR plans.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-8">
              ...
              <ul className="space-y-3">
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">SAVE Plan</p>
                    <p className="text-sm text-gray-600">Lowest payments for most borrowers</p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-5 h-5 bg-orange-500 rounded-full flex items-center justify-center mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Pay as you earn program</p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-5 h-5 bg-orange-500 rounded-full flex items-center justify-center mt-0.5">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">IBR</p>
                    <p className="text-sm text-gray-600">Income-based repayment</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-2xl p-8">
              ...
              <ul className="space-y-3">
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">PSLF</p>
                    <p className="text-sm text-gray-600">Public Service Loan Forgiveness</p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-5 h-5 bg-amber-500 rounded-full flex items-center justify-center mt-0.5">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Teacher Loan Forgiveness</p>
                    <p className="text-sm text-gray-600">Up to $17,500 forgiven</p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-5 h-5 bg-amber-500 rounded-full flex items-center justify-center mt-0.5">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">IDR Forgiveness</p>
                    <p className="text-sm text-gray-600">After 20-25 years of payments</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="py-16 bg-[#fbfbfd]">
        <div className="max-w-[980px] mx-auto px-6">
          <div className="grid grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-5xl font-semibold text-gray-900 mb-2">$1.7T</div>
              <p className="text-gray-600">Total US Student Debt</p>
            </div>
            <div>
              <div className="text-5xl font-semibold text-gray-900 mb-2">43M+</div>
              <p className="text-gray-600">Borrowers Nationwide</p>
            </div>
            <div>
              <div className="text-5xl font-semibold text-gray-900 mb-2">$28K</div>
              <p className="text-gray-600">Average Debt Per Borrower</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-[980px] mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
            Join thousands of borrowers who are on the path to becoming debt-free.
          </p>
          <Link
            href="/auth/signup"
        ...
        <div className="max-w-[980px] mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/student-loan-agent" className="text-xs text-gray-600 hover:text-gray-900">AI Agent</Link></li>
                <li><Link href="/student-loans" className="text-xs text-gray-600 hover:text-gray-900">Calculator</Link></li>
                <li><Link href="/student-loans" className="text-xs text-gray-600 hover:text-gray-900">Programs</Link></li>
              </ul>
            </div>
            <div>
