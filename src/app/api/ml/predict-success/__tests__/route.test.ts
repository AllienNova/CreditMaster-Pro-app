/**
 * Negative-auth tests for /api/ml/predict-success (TASK-AUTH-03f)
 */
...
function createMockRequest(method = "GET"): NextRequest {
  const url = "http://localhost:3000/api/ml/predict-success";
  return {
    url,
    method,
...
describe("negative-auth – /api/ml/predict-success", () => {
  beforeEach(() => {
    jest.clearAllMocks();
