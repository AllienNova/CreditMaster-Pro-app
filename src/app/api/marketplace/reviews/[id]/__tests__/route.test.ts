/**
 * Negative-auth tests for /api/marketplace/reviews/review-1 (TASK-AUTH-03f)
 */
...
function createMockRequest(method = "POST"): NextRequest {
  const url = "http://localhost:3000/api/marketplace/reviews/review-1";
  return {
    url,
    method,
...
describe("negative-auth – /api/marketplace/reviews/review-1", () => {
  beforeEach(() => {
    jest.clearAllMocks();
