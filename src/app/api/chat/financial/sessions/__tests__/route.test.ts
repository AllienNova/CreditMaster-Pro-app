/**
 * Negative-auth tests for /api/chat/financial/sessions (TASK-AUTH-03f)
 */
...
function createMockRequest(method = "GET"): NextRequest {
  const url = "http://localhost:3000/api/chat/financial/sessions";
  return {
    url,
    method,
...
describe("negative-auth – /api/chat/financial/sessions", () => {
  beforeEach(() => {
    jest.clearAllMocks();
