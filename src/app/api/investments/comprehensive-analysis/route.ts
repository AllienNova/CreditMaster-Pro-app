...
type ComprehensiveAnalysisRequest = z.infer<typeof ComprehensiveAnalysisRequestSchema>;
...
export async function GET() {
  return NextResponse.json({
    ...
    method: 'POST',
    description: 'Get comprehensive investment analysis combining all 6 analysis services',
    services: [
      'Technical Analysis',
