...
describe('/api/credit-repair/goodwill/[id]', () => {
  ...
  describe('GET /api/credit-repair/goodwill/[id]', () => {
    ...
    it('should return goodwill letter by ID', async () => {
      (db.goodwill.getGoodwillLetter as jest.Mock).mockResolvedValue(mockLetter);

      const request = createMockRequest('http://localhost:3000/api/credit-repair/goodwill/letter-123');
      ...
      expect(db.goodwill.getGoodwillLetter).toHaveBeenCalledWith('letter-123', mockUser.id);
    });
  ...
  describe('PUT /api/credit-repair/goodwill/[id]', () => {
    ...
    it('should update goodwill letter successfully', async () => {
      ...
      (db.goodwill.updateGoodwillLetter as jest.Mock).mockResolvedValue(updatedLetter);
  ...
  describe('DELETE /api/credit-repair/goodwill/[id]', () => {
    ...
    it('should delete goodwill letter successfully', async () => {
      ...
      expect(db.goodwill.deleteGoodwillLetter).toHaveBeenCalledWith('letter-123', mockUser.id);
    });
