...
describe('/api/credit-repair/negotiate/[id]', () => {
  ...
  describe('GET /api/credit-repair/negotiate/[id]', () => {
    ...
    it('should return negotiation by ID', async () => {
      (db.negotiations.getNegotiation as jest.Mock).mockResolvedValue(mockNegotiation);

      const request = createMockRequest('http://localhost:3000/api/credit-repair/negotiate/negotiation-123');
      ...
      expect(db.negotiations.getNegotiation).toHaveBeenCalledWith('negotiation-123', mockUser.id);
    });
  ...
  describe('DELETE /api/credit-repair/negotiate/[id]', () => {
    ...
    it('should delete negotiation successfully', async () => {
      ...
      expect(db.negotiations.deleteNegotiation).toHaveBeenCalledWith('negotiation-123', mockUser.id);
    });
