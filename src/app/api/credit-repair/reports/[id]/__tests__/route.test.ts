...
describe('/api/credit-repair/reports/[id]', () => {
  ...
  describe('GET /api/credit-repair/reports/[id]', () => {
    ...
    it('should return credit report by ID', async () => {
      (db.creditReports.getCreditReport as jest.Mock).mockResolvedValue(mockReport);

      const request = createMockRequest('http://localhost:3000/api/credit-repair/reports/report-123');
      ...
      expect(db.creditReports.getCreditReport).toHaveBeenCalledWith('report-123', mockUser.id);
    });
  ...
  describe('DELETE /api/credit-repair/reports/[id]', () => {
    ...
    it('should delete credit report successfully', async () => {
      (db.creditReports.deleteCreditReport as jest.Mock).mockResolvedValue(true);
      ...
      expect(db.creditReports.deleteCreditReport).toHaveBeenCalledWith('report-123', mockUser.id);
    });

    it('should return 404 if report not found', async () => {
      (db.creditReports.deleteCreditReport as jest.Mock).mockResolvedValue(false);
