/**
 * Negative-auth tests for /api/gamification/quests (TASK-AUTH-03f)
 */
...
function createMockRequest(method = "GET"): NextRequest {
  const url = "http://localhost:3000/api/gamification/quests";
  return {
    url,
    method,
...
describe("negative-auth – /api/gamification/quests", () => {
  beforeEach(() => {
    jest.clearAllMocks();
