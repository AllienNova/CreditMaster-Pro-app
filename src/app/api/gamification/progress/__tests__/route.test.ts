/**
 * Negative-auth tests for /api/gamification/progress (TASK-AUTH-03f)
 */
...
function createMockRequest(method = "GET"): NextRequest {
  const url = "http://localhost:3000/api/gamification/progress";
  return {
    url,
    method,
...
describe("negative-auth – /api/gamification/progress", () => {
  beforeEach(() => {
    jest.clearAllMocks();
