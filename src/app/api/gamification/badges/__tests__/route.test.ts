/**
 * Negative-auth tests for /api/gamification/badges (TASK-AUTH-03f)
 */
...
function createMockRequest(method = "GET"): NextRequest {
  const url = "http://localhost:3000/api/gamification/badges";
  return {
    url,
    method,
...
describe("negative-auth – /api/gamification/badges", () => {
  beforeEach(() => {
    jest.clearAllMocks();
