...
import { AnalyticsEngine, ReportGenerator, type ReportFormat } from '@/lib/analytics';
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (report_type === 'system' && !rbac.hasPermission(validation.user, 'admin:analytics')) {
    ...
    if (format === 'json') {
      ...
      const content = typeof generatedReport.content === 'string'
