      ...
      prioritizedActions: [
        {
          ...
          description: 'Remove incorrect late payment from March 2024 that was actually paid on time',
        ...
        },
        {
          ...
          description: 'Reduce total utilization from 68% to under 10% for maximum score impact',
        ...
        },
        {
          ...
          description: 'Settle $1,200 medical collection for deletion from credit reports',
        ...
        },
        {
          ...
          description: 'Ask Discover to remove one-time late payment from excellent payment history',
          category: 'negotiation' as const,
          impact: 35,
        ...
        },
        {
          ...
          description: 'Become authorized user on parent\'s 20-year-old card with perfect history',
        ...
        },
        {
          ...
          description: 'Remove 2 duplicate entries for same Chase account showing on Equifax',
          category: 'dispute' as const,
          impact: 25,
      ...
      strategyOptimizations: [
        {
          ...
          description: 'Challenge all negative items simultaneously using FCRA violations and method of verification',
          pros: [
        ...
        },
        {
          ...
          description: 'Focus on reducing credit card utilization to under 10% for maximum score impact',
          pros: [
        ...
        },
        {
          ...
          description: 'Combine disputes, negotiations, and utilization reduction for maximum impact',
          pros: [
