  ...
  try {
      ...
      opportunities: [
        {
          ...
          itemDescription: 'Capital One - 30-day late payment from 18 months ago',
          bureau: 'all' as const,
          successProbability: 78,
          estimatedImpact: 25,
          recommendedStrategy: 'Goodwill Letter + Dispute',
          strategyDescription: 'Combine goodwill request with factual dispute for maximum effectiveness',
        ...
        },
        {
          ...
          strategyDescription: 'Challenge inquiry as unauthorized with identity theft protection',
          difficulty: 'easy' as const,
          timeline: '15-30 days',
        ...
        },
        {
          ...
          strategyDescription: 'Challenge bureau\'s verification process and request original documentation',
      ...
      templates: [
        {
          ...
          description: 'Request removal of negative item based on positive payment history and extenuating circumstances',
          successRate: 65,
          bestFor: ['Late payments', 'One-time mistakes', 'Long-standing customers'],
          steps: [
        ...
        },
        {
          ...
          description: 'Challenge the bureau\'s investigation process and demand proof of verification',
          successRate: 72,
          bestFor: ['Verified items', 'Fast bureau responses', 'Lack of documentation'],
          steps: [
        ...
        },
        {
          ...
          description: 'Negotiate removal of collection account in exchange for payment',
          successRate: 58,
        ...
        },
        {
          ...
          description: 'Dispute fraudulent accounts or inquiries using identity theft protections',
          successRate: 88,
          bestFor: ['Unauthorized accounts', 'Fraudulent inquiries', 'Identity theft victims'],
          steps: [
    ...
    return NextResponse.json({
      ...
      _meta: {
        ...
        dataSourcesUsed: ['dispute-service', 'ai-strategy-engine', 'success-predictions'],
      },
    });
  } catch (error) {
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        recommendedNextSteps: ['Unable to load strategy recommendations at this time'],
      },
      _meta: {
        generatedAt: new Date().toISOString(),
        fallback: true,
