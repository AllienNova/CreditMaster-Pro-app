    ...
    const mockData = {
      ...
      categoryInsights: [
        ...
        },
        {
          ...
          trend: 'increasing' as const,
          percentChange: 45,
          recommendation: 'Review recent purchases and set a monthly shopping budget',
      ...
      reductionRecommendations: [
        {
          ...
          description: 'Cook at home 2 more times per week instead of dining out',
          category: 'Food & Dining',
          currentAmount: 650,
          targetAmount: 450,
          monthlySavings: 200,
        ...
        },
        {
          ...
          description: 'Use price comparison tools and wait 24 hours before non-essential purchases',
          category: 'Shopping',
          currentAmount: 580,
          targetAmount: 400,
          monthlySavings: 180,
