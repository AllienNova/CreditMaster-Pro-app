  ...
  try {
    ...
    const mockData = {
      predictions: [
        {
          ...
          predictedScore: 728,
          confidence: 87,
          factors: ['Payment history improvement', 'Credit utilization decrease'],
        },
        {
      ...
      factorAnalysis: [
        {
          ...
          recommendation: 'Continue making all payments on time to maintain this positive impact',
        ...
        },
        {
          ...
          recommendation: 'Reduce utilization below 30% by paying down $2,500 in balances',
        ...
        },
        {
          ...
          recommendation: 'Keep older accounts open to increase average age over time',
      ...
      improvementOpportunities: [
        ...
        },
        {
          ...
          description: 'Challenge the late payment from 18 months ago on Capital One account',
        ...
        },
        {
          ...
          description: 'Get added as authorized user on a family member\'s seasoned account',
          difficulty: 'easy' as const,
          timeframe: '1-2 months',
      ...
      alerts: [
        ...
        },
        {
          ...
          description: 'Chase Bank performed a hard inquiry on your Experian report',
        ...
        },
        {
          ...
          description: 'Your oldest account just reached 5 years - great for your score!',
    ...
    return NextResponse.json({
      ...
      _meta: {
        ...
        dataSourcesUsed: ['credit-monitoring', 'ai-predictions', 'factor-analysis'],
      },
    });
  } catch (error) {
