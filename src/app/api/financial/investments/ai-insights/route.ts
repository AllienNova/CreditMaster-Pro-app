      ...
      recommendations: [
        {
          ...
          type: "buy" as const,
          reasoning:
            "Strong fundamentals, upcoming product launches, and AI integration expected to drive growth",
          confidence: 82,
          targetPrice: 195.5,
          currentPrice: 178.25,
          potentialReturn: 9.7,
        ...
        },
        {
          ...
          type: "hold" as const,
          reasoning:
            "Already at high valuation, wait for pullback before adding more exposure",
          confidence: 75,
          targetPrice: 520.0,
          currentPrice: 495.3,
          potentialReturn: 5.0,
        ...
        },
        {
          ...
          type: "buy" as const,
          reasoning:
            "Broad market exposure with low fees, ideal for long-term diversification",
          confidence: 88,
          targetPrice: 265.0,
          currentPrice: 248.75,
          potentialReturn: 6.5,
        ...
        },
        {
          ...
          type: "sell" as const,
          reasoning:
            "Overvalued relative to fundamentals, consider taking profits and rebalancing",
          confidence: 68,
          targetPrice: 180.0,
          currentPrice: 245.5,
        ...
        factors: [
          {
            ...
            level: "high" as const,
            description:
              "45% of portfolio in technology sector increases volatility risk",
          },
          {
            factor: "Market Volatility",
            level: "medium" as const,
            description:
              "Current VIX levels indicate moderate market uncertainty",
          },
          {
            factor: "Diversification",
            level: "medium" as const,
            description:
              "Portfolio spread across 12 holdings provides moderate diversification",
          },
          {
            factor: "Liquidity Risk",
            level: "low" as const,
            description:
              "All holdings are highly liquid with strong trading volumes",
          },
        ],
        recommendations: [
      ...
      diversificationSuggestions: [
        {
          ...
          reasoning:
            "Increase global diversification to reduce US market dependency",
