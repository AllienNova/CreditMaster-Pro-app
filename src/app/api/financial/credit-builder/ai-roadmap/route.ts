    ...
    const mockData = {
      milestones: [
        ...
        },
        {
          ...
          description:
            "Achieve excellent credit score through consistent habits",
          targetScore: 720,
          estimatedDays: 180,
          actions: [
      ...
      prioritizedActions: [
        {
          ...
          description:
            "Reduce balance from $2,400 to $600 (78% → 20% utilization)",
          impact: 25,
        ...
        },
        {
          ...
          description:
            "Prevent future missed payments by automating minimum payments",
          impact: 15,
        ...
        },
        {
          ...
          title: "Dispute Inaccurate Late Payment",
          description:
            "File dispute with Experian for incorrect late payment from 2024",
          impact: 30,
          difficulty: "medium" as const,
        ...
        },
        {
          ...
          description:
            "Ask parent to add you as authorized user on their oldest card",
          impact: 35,
          difficulty: "easy" as const,
        ...
        },
        {
          ...
          description:
            "Reduce balance from $1,800 to $400 (65% → 15% utilization)",
          impact: 18,
          difficulty: "medium" as const,
          timeToComplete: "1-2 weeks",
          priority: "medium" as const,
      ...
      strategyRecommendations: [
        {
          ...
          description:
            "Focus on reducing credit card utilization to below 10% for maximum score impact",
          expectedImpact: 45,
        ...
        },
        {
          ...
          description:
            "Leverage authorized user status and avoid closing old accounts to boost average age",
          expectedImpact: 35,
        ...
        },
        {
          ...
          description:
            "Ensure 100% on-time payments and dispute any inaccuracies",
          expectedImpact: 40,
