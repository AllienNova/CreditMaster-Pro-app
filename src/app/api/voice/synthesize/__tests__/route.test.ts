/**
 * Negative-auth tests for /api/voice/synthesize (TASK-AUTH-03f)
 */
...
jest.mock("@/lib/aiml-service", () => ({ getAIMLService: jest.fn() }));
...
describe("negative-auth – /api/voice/synthesize", () => {
  beforeEach(() => {
    jest.clearAllMocks();
