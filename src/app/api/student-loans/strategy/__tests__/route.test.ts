/**
 * Negative-auth tests for /api/student-loans/strategy (TASK-AUTH-03f)
 */
...
jest.mock("@/lib/ai-orchestrator", () => ({ getAIOrchestrator: jest.fn() }));

import { GET, POST } from "../route";

function createMockRequest(method = "GET"): NextRequest {
  const url = "http://localhost:3000/api/student-loans/strategy";
  return {
    url,
    method,
...
describe("negative-auth – /api/student-loans/strategy", () => {
  beforeEach(() => {
    jest.clearAllMocks();
