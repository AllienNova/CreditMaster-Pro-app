/**
 * Negative-auth tests for /api/student-loans (TASK-AUTH-03f)
 */
...
jest.mock("@/lib/federal-integration-service", () => ({ FederalIntegrationService: jest.fn().mockImplementation(() => ({ retrieveNSLDSData: jest.fn() })) }));
...
describe("negative-auth – /api/student-loans", () => {
  beforeEach(() => {
    jest.clearAllMocks();
