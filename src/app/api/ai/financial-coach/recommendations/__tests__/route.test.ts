/**
 * Negative-auth tests for /api/ai/financial-coach/recommendations (TASK-AUTH-03f)
 */
...
function createMockRequest(method = "GET"): NextRequest {
  const url = "http://localhost:3000/api/ai/financial-coach/recommendations";
  return {
    url,
    method,
...
describe("negative-auth – /api/ai/financial-coach/recommendations", () => {
  beforeEach(() => {
    jest.clearAllMocks();
