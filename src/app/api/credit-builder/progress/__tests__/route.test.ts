 ...
 *
 * Negative-auth coverage for /api/credit-builder/progress (TASK-AUTH-03c).
...
function makeRequest(): NextRequest {
  return new NextRequest("http://localhost:3000/api/credit-builder/progress");
}
...
describe("Credit Builder Progress API – /api/credit-builder/progress", () => {
