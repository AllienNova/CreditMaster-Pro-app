 ...
 *
 * Negative-auth coverage for /api/credit-builder/score (TASK-AUTH-03c).
...
jest.mock("@/lib/credit-builder/credit-builder-service", () => ({
  creditBuilderService: {
    calculateCreditBuilderScore: jest.fn().mockResolvedValue({}),
  },
}));
...
function makeRequest(): NextRequest {
  return new NextRequest("http://localhost:3000/api/credit-builder/score");
}
...
describe("Credit Builder Score API – /api/credit-builder/score", () => {
