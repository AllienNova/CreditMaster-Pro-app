...
const DISPUTE_STRATEGIES = [
  {
    id: 'fcra_violation',
    name: 'FCRA Violation',
    description: 'Challenge items that violate the Fair Credit Reporting Act requirements for accuracy and verification.',
  ...
  },
  {
    ...
    description: 'Request debt collectors to validate the debt under FDCPA regulations.',
    difficulty: 'beginner',
    successRate: 65,
    estimatedDays: 45,
    steps: [
  ...
  },
  {
    ...
    description: 'Request creditors to remove negative items as a gesture of goodwill for loyal customers.',
    difficulty: 'beginner',
    successRate: 45,
    estimatedDays: 14,
    steps: [
  ...
  },
  {
    id: 'pay_for_delete',
    name: 'Pay for Delete',
    description: 'Negotiate with creditors to remove negative items in exchange for payment.',
    difficulty: 'intermediate',
    successRate: 55,
    estimatedDays: 21,
    steps: [
  ...
  },
  {
    ...
    description: 'Dispute items that resulted from identity theft with supporting documentation.',
    difficulty: 'advanced',
    successRate: 85,
    estimatedDays: 45,
    steps: [
  ...
  },
  {
    ...
    description: 'Challenge debts that are past the statute of limitations for collection.',
    difficulty: 'intermediate',
    successRate: 70,
    estimatedDays: 30,
    steps: [
  ...
  },
  {
    ...
    description: 'Challenge items where creditors failed to follow proper procedures.',
    difficulty: 'advanced',
    successRate: 72,
    estimatedDays: 45,
    steps: [
