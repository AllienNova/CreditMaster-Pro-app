          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-6 space-y-4">
            ...
            {[
              ...
              },
              {
                ...
                desc: "Get notified when dispute status changes",
              },
              {
                key: "weeklyReport",
                label: "Weekly Report",
                desc: "Receive weekly credit progress summary",
              },
              {
                key: "marketingEmails",
                label: "Marketing Emails",
                desc: "Receive promotional offers and tips",
              },
            ].map((item) => (
              <div
                key={item.key}
