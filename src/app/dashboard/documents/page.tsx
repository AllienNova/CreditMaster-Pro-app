    ...
    const fetchDocuments = async () => {
      try {
        ...
        if (response.ok) {
          ...
          // Mock data
          setDocuments([
            { id: '1', name: 'Experian_Credit_Report_Nov2024.pdf', type: 'credit_report', size: 2456789, uploaded_at: '2024-11-15T10:00:00Z', status: 'analyzed' },
            { id: '2', name: 'Equifax_Report_Oct2024.pdf', type: 'credit_report', size: 1987654, uploaded_at: '2024-10-20T14:30:00Z', status: 'analyzed' },
            { id: '3', name: 'Dispute_Response_Experian.pdf', type: 'dispute_response', size: 456789, uploaded_at: '2024-11-01T09:15:00Z', status: 'processed' },
            { id: '4', name: 'Identity_Verification.jpg', type: 'identity', size: 234567, uploaded_at: '2024-09-10T16:45:00Z', status: 'verified' },
          ]);
        }
      } catch {
        setDocuments([
