          ...
          setNotifications([
            {
              ...
              body: "Your dispute with Experian has been marked as under review.",
            ...
            },
            {
              id: "2",
              type: "score_change",
              title: "Credit Score Changed",
              body: "Your credit score increased by 12 points! New score: 678",
            ...
            },
            {
              ...
              body: "Your Experian credit report has been analyzed. 3 disputable items found.",
            ...
            },
            {
              ...
              body: "Based on your profile, consider applying for a secured credit card.",
              createdAt: "2024-11-17T16:45:00Z",
              read: true,
              actionUrl: "/marketplace/secured-cards",
            },
            {
              id: "5",
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    <h3
                      className={`font-medium ${!notification.read ? "text-gray-900" : "text-gray-700 dark:text-slate-200"}`}
                    >
                      {notification.title}
                    </h3>
