...
export default function CryptoDetailPage() {
  ...
  const [priceTimeframe, setPriceTimeframe] = useState<'24h' | '7d' | '30d' | '1y'>('7d');
  ...
  const fetchAnalysis = useCallback(async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to load crypto analysis');
    } finally {
      setLoading(false);
    }
  }, [coinId]);
        ...
        {!loading && !error && analysis && sentiment && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* On-Chain Metrics */}
              {analysis.onChainMetrics && <OnChainMetricsCard metrics={analysis.onChainMetrics} />}
      ...
      <div className="flex items-start justify-between">
        <div className="flex-1">
          ...
          <div className="space-y-2">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-slate-300">AI Recommendations:</h3>
            {analysis.recommendations.slice(0, 3).map((rec, idx) => (
              <p key={idx} className="text-sm text-gray-600 dark:text-slate-400">
                • {rec}
              </p>
            ))}
          </div>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-500 dark:text-slate-400 mb-2">Overall Grade</p>
          <div className={`px-6 py-3 rounded-lg ${getScoreColor(analysis.overallScore)}`}>
            <p className="text-4xl font-bold">{getGrade(analysis.overallScore)}</p>
          </div>
...
function AnalysisScoreCard({ analysis }: AnalysisScoreCardProps) {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
      <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Analysis Summary</h2>

      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="text-center p-4 bg-gray-50 dark:bg-slate-700 rounded-lg">
          <p className="text-sm text-gray-500 dark:text-slate-400 mb-1">Overall Score</p>
        ...
        <div className="text-center p-4 bg-gray-50 dark:bg-slate-700 rounded-lg">
          <p className="text-sm text-gray-500 dark:text-slate-400 mb-1">Data Quality</p>
        ...
        <div className="text-center p-4 bg-gray-50 dark:bg-slate-700 rounded-lg">
          <p className="text-sm text-gray-500 dark:text-slate-400 mb-1">Last Updated</p>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Active Addresses (24h)</p>
              <p className="text-lg font-semibold text-gray-900 dark:text-white">
                {metrics.networkActivity.activeAddresses24h.toLocaleString()}
              </p>
            </div>
            <div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">New Addresses (24h)</p>
              <p className="text-lg font-semibold text-gray-900 dark:text-white">
                {metrics.networkActivity.newAddresses24h.toLocaleString()}
              </p>
            </div>
            <div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Address Growth Rate</p>
              <p className={`text-lg font-semibold ${
                metrics.networkActivity.addressGrowthRate >= 0 ? 'text-green-600' : 'text-red-600'
              }`}>
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-slate-700">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Transactions (24h)</p>
              <p className="text-lg font-semibold text-gray-900 dark:text-white">
                {metrics.transactionMetrics.transactionCount24h.toLocaleString()}
              </p>
            </div>
            <div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Volume (24h)</p>
              <p className="text-lg font-semibold text-gray-900 dark:text-white">
                ${(metrics.transactionMetrics.transactionVolume24h / 1e6).toFixed(2)}M
              </p>
            </div>
            <div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Avg Transaction Value</p>
              <p className="text-lg font-semibold text-gray-900 dark:text-white">
                ${metrics.transactionMetrics.averageTransactionValue.toFixed(2)}
              </p>
            </div>
            <div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Avg Fee</p>
              <p className="text-lg font-semibold text-gray-900 dark:text-white">
    ...
    <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Total Supply</p>
              <p className="text-lg font-semibold text-gray-900 dark:text-white">
                {(tokenomics.supplyMechanics.totalSupply / 1e6).toFixed(2)}M
              </p>
            </div>
            <div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Circulating Supply</p>
              <p className="text-lg font-semibold text-gray-900 dark:text-white">
                {(tokenomics.supplyMechanics.circulatingSupply / 1e6).toFixed(2)}M
              </p>
            </div>
            <div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Inflation Rate</p>
              <p className={`text-lg font-semibold ${
                tokenomics.supplyMechanics.inflationRate < 5 ? 'text-green-600' : 'text-red-600'
              }`}>
                {tokenomics.supplyMechanics.inflationRate.toFixed(2)}%
              </p>
            </div>
            <div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Burn Rate</p>
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-slate-700">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Top 10 Holders</p>
              <p className="text-lg font-semibold text-gray-900 dark:text-white">
                {tokenomics.distribution.top10HoldersPercentage.toFixed(2)}%
              </p>
            </div>
            <div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Top 100 Holders</p>
              <p className="text-lg font-semibold text-gray-900 dark:text-white">
                {tokenomics.distribution.top100HoldersPercentage.toFixed(2)}%
              </p>
            </div>
            <div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Whale Concentration</p>
              <p className={`text-lg font-semibold ${
                tokenomics.distribution.whaleConcentration > 50 ? 'text-red-600' : 'text-green-600'
              }`}>
                {tokenomics.distribution.whaleConcentration.toFixed(2)}%
              </p>
            </div>
            <div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Gini Coefficient</p>
              <p className="text-lg font-semibold text-gray-900 dark:text-white">
        ...
        {tokenomics.vestingSchedule && (
          <div className="pt-4 border-t border-gray-200 dark:border-slate-700">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Total Vested</p>
                <p className="text-lg font-semibold text-gray-900 dark:text-white">
                  {tokenomics.vestingSchedule.totalVested.toFixed(2)}%
                </p>
              </div>
              <div>
                <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Total Unlocked</p>
                <p className="text-lg font-semibold text-gray-900 dark:text-white">
              ...
              {tokenomics.vestingSchedule.nextUnlockDate && (
                <>
                  <div>
                    <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Next Unlock Date</p>
                    <p className="text-sm font-semibold text-gray-900 dark:text-white">
                      {new Date(tokenomics.vestingSchedule.nextUnlockDate).toLocaleDateString()}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Next Unlock Amount</p>
                    <p className="text-lg font-semibold text-gray-900 dark:text-white">
                      {((tokenomics.vestingSchedule.nextUnlockAmount ?? 0) / 1e6).toFixed(2)}M
                    </p>
                  </div>
                </>
              )}
...
function DeFiMetricsCard({ metrics }: DeFiMetricsCardProps) {
  return (
    <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div>
          <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Total Value Locked</p>
          <p className="text-2xl font-bold text-gray-900 dark:text-white">
            ${(metrics.tvl.current / 1e9).toFixed(2)}B
          </p>
        </div>
        <div>
          <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">TVL Change (24h)</p>
          <p className={`text-2xl font-bold ${
            metrics.tvl.change24h >= 0 ? 'text-green-600' : 'text-red-600'
          }`}>
            {metrics.tvl.change24h >= 0 ? '+' : ''}{metrics.tvl.change24h.toFixed(2)}%
          </p>
        </div>
        <div>
          <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Protocol Revenue (24h)</p>
          <p className="text-2xl font-bold text-gray-900 dark:text-white">
            ${((metrics.protocolRevenue?.revenue24h ?? 0) / 1e6).toFixed(2)}M
          </p>
        </div>
        <div>
          <p className="text-xs text-gray-500 dark:text-slate-400 mb-1">Avg APY</p>
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Fear & Greed Index */}
        <div className="text-center">
          <p className="text-sm text-gray-500 dark:text-slate-400 mb-2">Fear & Greed Index</p>
          <p className={`text-5xl font-bold ${getSentimentColor(sentiment.fearGreedIndex.value)}`}>
        ...
        <div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-slate-400">Twitter Mentions</span>
              <span className="text-sm font-semibold text-gray-900 dark:text-white">
                {sentiment.socialMetrics.twitterMentions24h.toLocaleString()}
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-slate-400">Reddit Subscribers</span>
              <span className="text-sm font-semibold text-gray-900 dark:text-white">
                {sentiment.socialMetrics.redditSubscribers?.toLocaleString() ?? 'N/A'}
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-slate-400">Reddit Active Users</span>
              <span className="text-sm font-semibold text-gray-900 dark:text-white">
                {sentiment.socialMetrics.redditActiveUsers?.toLocaleString() ?? 'N/A'}
              </span>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-slate-400">Positive</span>
              <span className="text-sm font-semibold text-green-600">
                {sentiment.newsSentiment.positiveNews}
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-slate-400">Neutral</span>
              <span className="text-sm font-semibold text-gray-600 dark:text-slate-300">
                {sentiment.newsSentiment.neutralNews}
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-slate-400">Negative</span>
...
function AIInsightsCard({ analysis }: AIInsightsCardProps) {
  const getRecommendationColor = (rec: string): string => {
    if (rec === 'strong_buy' || rec === 'buy') return 'bg-green-100 text-green-800';
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-4">
          <span className={`px-4 py-2 rounded-lg font-semibold ${
            analysis.overallScore >= 70 ? 'bg-green-100 text-green-700' :
            analysis.overallScore >= 50 ? 'bg-blue-100 text-blue-700' :
            analysis.overallScore >= 30 ? 'bg-yellow-100 text-yellow-700' :
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-12">
      <div className="flex flex-col items-center justify-center">
        ...
        <p className="text-gray-500 dark:text-slate-400">Loading crypto analysis...</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-12">
      <div className="flex flex-col items-center justify-center">
        ...
        <p className="text-gray-900 dark:text-white font-semibold mb-2">Error Loading Analysis</p>
