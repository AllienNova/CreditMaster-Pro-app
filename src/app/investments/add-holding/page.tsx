...
type AssetType = 'stock' | 'etf' | 'mutual_fund' | 'bond' | 'crypto' | 'option' | 'other';
...
export default function AddHoldingPage() {
  ...
  const totalInvestment = shares && costBasis
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 dark:text-slate-400">$</span>
                  <input
                    type="number"
                    step="0.01"
                    value={costBasis}
            ...
            {totalInvestment && (
              <div className="mt-4 p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg text-center">
                <p className="text-sm text-gray-600 dark:text-slate-400 mb-1">Total Investment</p>
