      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-xl p-8 md:p-12 text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 mb-8">
            Thank you for subscribing to Fynvita. Your account has been
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/ai-tools"
              className="px-8 py-3 bg-white hover:bg-gray-50 dark:hover:bg-slate-700 dark:bg-slate-900 text-blue-600 font-semibold rounded-lg border-2 border-blue-600 transition-all duration-200"
            >
              Explore AI Tools
            </Link>
          </div>
