...
const mockLoans: BuilderLoan[] = [
  {
    ...
    rating: 4.6,
    requirements: ["Valid SSN", "US bank account"],
  },
  {
    id: "2",
    lender: "MoneyLion",
    ...
    termMonths: [12],
    apr: "5.99%",
    monthlyPayment: "$42-$84",
    features: ["Low APR", "Mobile app", "Financial tracking"],
    rating: 4.4,
    requirements: ["Bank account", "Income verification"],
  },
  {
    id: "3",
    lender: "Chime Credit Builder",
    minAmount: 1,
    maxAmount: 10000,
    termMonths: [0],
    apr: "0%",
    monthlyPayment: "Varies",
    features: ["No interest", "No fees", "Secured by your money"],
    rating: 4.7,
    requirements: ["Chime account", "Direct deposit"],
  },
  {
    id: "4",
    lender: "Kikoff",
    ...
    apr: "0%",
    monthlyPayment: "$5",
    features: ["$5/month", "No credit check", "Reports to bureaus"],
    rating: 4.3,
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 dark:text-slate-300">
          Small installment loans designed to build your credit
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center gap-4">
            <select
              value={sortBy}
              onChange={(e) => setSortBy(e.target.value as "rating" | "apr")}
