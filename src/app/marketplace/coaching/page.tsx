      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <span className="text-gray-400 dark:text-slate-500">({coach.reviews} reviews)</span>
          </div>
        </div>
      </div>

      <div className="mt-4">
        <p className="text-sm text-gray-500 dark:text-slate-400 mb-2">Certifications</p>
      ...
      <div className="mt-4">
        ...
        <div className="flex flex-wrap gap-1">
          {coach.specialties.map((s) => (
            <span key={s} className="px-2 py-1 text-xs bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-slate-300 rounded">{s}</span>
          ))}
        </div>
      </div>
...
export default function CoachingPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Financial Coaching</h1>
        <p className="text-gray-600 dark:text-slate-300">Work with certified coaches to improve your financial health</p>
      </div>
