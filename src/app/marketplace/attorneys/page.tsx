...
const mockAttorneys: Attorney[] = [
  {
    id: "1",
    name: "Sarah Mitchell",
    firm: "Mitchell Consumer Law",
    location: "Los Angeles, CA",
    specialties: ["FCRA Violations", "Identity Theft", "Debt Collection"],
    rating: 4.9,
    reviews: 127,
    yearsExperience: 15,
    consultationFee: "Free",
    caseTypes: ["Credit Report Errors", "Harassment", "FDCPA"],
    image: "‍",
  },
  {
    id: "2",
    ...
    location: "Miami, FL",
    specialties: ["Credit Repair", "Bankruptcy", "Debt Settlement"],
    rating: 4.8,
    reviews: 89,
    yearsExperience: 12,
    consultationFee: "$50",
    caseTypes: ["Wrongful Collections", "Credit Disputes", "Lawsuits"],
    image: "‍",
  },
  {
    id: "3",
    ...
    specialties: ["FCRA", "TCPA", "Consumer Protection"],
    rating: 4.7,
    reviews: 156,
    yearsExperience: 18,
    consultationFee: "Free",
    caseTypes: ["Robocalls", "Data Breaches", "Credit Errors"],
    image: "‍",
  },
  {
    id: "4",
    ...
    location: "Chicago, IL",
    specialties: ["Debt Defense", "Credit Repair", "Foreclosure"],
    rating: 4.6,
    reviews: 72,
    yearsExperience: 10,
    consultationFee: "$75",
    caseTypes: ["Debt Lawsuits", "Mortgage Issues", "Collections"],
    image: "‍",
  },
];
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 dark:text-slate-300">
          Find experienced attorneys for credit-related legal issues
        </p>
      </div>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
        <p className="text-amber-800 text-sm">
          ...
          violations, identity theft, harassment from collectors, or need to sue
          a creditor.
        </p>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-4 bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-slate-700">
        ...
        <label className="flex items-center gap-2 text-sm">
          <input
            type="checkbox"
            checked={freeConsultOnly}
            onChange={(e) => setFreeConsultOnly(e.target.checked)}
            className="rounded"
          />
