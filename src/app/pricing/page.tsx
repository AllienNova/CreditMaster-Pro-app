...
import { pricingTiers, addOns, comparisonFeatures, competitorComparison } from '@/lib/pricing';
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="flex justify-between items-center h-14">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-semibold text-gray-900 dark:text-white tracking-tight">Fynvita</span>
            </Link>
            <div className="hidden md:flex items-center gap-8">
              <Link href="/credit" className="text-sm text-gray-600 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">Credit Health</Link>
              <Link href="/financial-hub" className="text-sm text-gray-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Financial Wellness</Link>
              <Link href="/invest" className="text-sm text-gray-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Investment Intelligence</Link>
              <Link href="/pricing" className="text-sm text-gray-900 dark:text-white font-semibold">Pricing</Link>
            </div>
            <div className="flex items-center gap-4">
              <Link href="/auth/login" className="text-sm text-gray-600 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white transition-colors">Sign In</Link>
              <Link
                href="/auth/signup"
      ...
      <section className="pt-32 pb-12">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white tracking-tight leading-[1.05] mb-6">
            Invest in your
            <br />
            <span className="bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent">financial vitality.</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed mb-4">
            The only platform combining credit health, financial wellness, and investment intelligence.
          </p>
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            >
              Annual
              <span className="ml-2 text-xs bg-white dark:bg-slate-800/20 px-2 py-0.5 rounded-full">Save 20%</span>
            </button>
          </div>
          <p className="text-sm text-gray-500 dark:text-slate-400">
            <strong className="text-emerald-600 dark:text-emerald-400">30-day money-back guarantee</strong> — Not satisfied? Get a full refund.
          </p>
        </div>
      </section>
            ...
            {pricingTiers.map((tier) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-6">
                    <h3 className={`text-2xl font-bold mb-1 ${isPopular ? 'text-white' : 'text-gray-900 dark:text-white'}`}>
                      {tier.name}
                    </h3>
                    <p className={`text-sm ${isPopular ? 'text-gray-300' : 'text-gray-600 dark:text-slate-400'}`}>
                      {tier.description}
                    </p>
                  </div>
                  ...
                  <div className="mb-6">
                    <div className="flex items-baseline mb-1">
                      {isFree ? (
                        <span className={`text-5xl font-bold tracking-tight ${isPopular ? 'text-white' : 'text-gray-900 dark:text-white'}`}>
                          Free
                        </span>
                      ) : (
                        <>
                          <span className={`text-5xl font-bold tracking-tight ${isPopular ? 'text-white' : 'text-gray-900 dark:text-white'}`}>
                            ${billingCycle === 'monthly' ? tier.price : displayPrice.toFixed(0)}
                          </span>
                          <span className={`text-lg ml-1 ${isPopular ? 'text-gray-400' : 'text-gray-500 dark:text-slate-400'}`}>
                            /mo
                          </span>
                        </>
                      )}
                    ...
                    {!isFree && billingCycle === 'annual' && (
                      <p className={`text-sm ${isPopular ? 'text-emerald-300' : 'text-emerald-600'}`}>
                        ${tier.annualPrice.toFixed(0)} billed annually (save ${(tier.priceNumber * 12 - tier.annualPrice).toFixed(0)})
                      </p>
                    )}
                  </div>
                  ...
                  <ul className="space-y-3 mb-8 flex-grow">
                    {tier.features.slice(0, 8).map((feature, idx) => (
                      <li key={idx} className="flex items-start">
                        ...
                        <span className={`text-sm ${isPopular ? 'text-gray-200' : 'text-gray-700 dark:text-slate-300'} ${feature.startsWith('Everything') ? 'font-semibold' : ''}`}>
                          {feature}
                        </span>
                      </li>
                    ))}
                    {tier.features.length > 8 && (
                      <li className={`text-sm ${isPopular ? 'text-gray-400' : 'text-gray-500 dark:text-slate-400'} pl-7`}>
                  ...
                  {tier.excludedFeatures && tier.excludedFeatures.length > 0 && (
                    <div className="mb-6 pt-4 border-t border-gray-200 dark:border-slate-600">
                      <p className="text-xs text-gray-500 dark:text-slate-400 mb-2">Not included:</p>
                      <ul className="space-y-1">
                        {tier.excludedFeatures.slice(0, 3).map((feature, idx) => (
                          <li key={idx} className="flex items-center text-xs text-gray-400 dark:text-slate-500">
                  ...
                  <Link
                    href={isFree ? '/auth/signup' : '/auth/signup?plan=' + tier.id}
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400 dark:text-slate-500 max-w-2xl mx-auto">
              The only platform that combines credit repair, financial wellness, AND investment intelligence.
            </p>
          </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-700">
                  <th className="text-left py-4 pr-4 font-medium text-gray-400 dark:text-slate-500 text-sm">Feature</th>
                  <th className="text-center py-4 px-6">
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-emerald-400 text-sm font-semibold">$99.99/mo</span>
                    </div>
                  </th>
                  <th className="text-center py-4 px-6">
                    <div className="flex flex-col items-center">
                      <div className="w-8 h-8 rounded-md bg-green-600 flex items-center justify-center mb-1"><span className="text-white font-bold text-sm">CK</span></div>
                      <span className="font-medium text-gray-300">Credit Karma</span>
                      <span className="text-gray-500 dark:text-slate-400 text-sm">Free</span>
                    </div>
                  </th>
                  <th className="text-center py-4 px-6">
                    <div className="flex flex-col items-center">
                      <div className="w-8 h-8 rounded-md bg-orange-500 flex items-center justify-center mb-1"><span className="text-white font-bold text-sm">RM</span></div>
                      <span className="font-medium text-gray-300">Rocket Money</span>
                      <span className="text-gray-500 dark:text-slate-400 text-sm">$6-14/mo</span>
                    </div>
                  </th>
                </tr>
              </thead>
              <tbody className="text-sm">
                <tr className="border-b border-gray-700/50">
                  <td className="py-4 pr-4 text-gray-300">Credit Bureaus Monitored</td>
                  <td className="py-4 px-6 text-center">
                    <span className="text-emerald-400 font-bold">All 3</span>
                  </td>
                  <td className="py-4 px-6 text-center text-gray-500 dark:text-slate-400">2 of 3</td>
                  <td className="py-4 px-6 text-center text-red-400">None</td>
                </tr>
                <tr className="border-b border-gray-700/50">
                  <td className="py-4 pr-4 text-gray-300">AI Dispute Letters</td>
                  <td className="py-4 px-6 text-center">
                ...
                <tr className="border-b border-gray-700/50">
                  ...
                  <td className="py-4 px-6 text-center">
                    <span className="text-emerald-400 font-bold">Included (no fees)</span>
                  </td>
                  <td className="py-4 px-6 text-center text-red-400">None</td>
                  <td className="py-4 px-6 text-center text-amber-400">35-60% of savings</td>
                </tr>
                <tr className="border-b border-gray-700/50">
                  <td className="py-4 pr-4 text-gray-300">Investment Tools</td>
                  <td className="py-4 px-6 text-center">
                    <span className="text-emerald-400 font-bold">Full Suite</span>
                  </td>
                  <td className="py-4 px-6 text-center text-red-400">None</td>
                  <td className="py-4 px-6 text-center text-red-400">None</td>
                </tr>
                <tr className="border-b border-gray-700/50">
                  <td className="py-4 pr-4 text-gray-300">Student Loan Optimization</td>
                  <td className="py-4 px-6 text-center">
                    <span className="text-emerald-400 font-bold">Complete</span>
                  </td>
                  <td className="py-4 px-6 text-center text-gray-500 dark:text-slate-400">Basic</td>
                  <td className="py-4 px-6 text-center text-red-400">None</td>
                </tr>
                <tr className="border-b border-gray-700/50">
                  <td className="py-4 pr-4 text-gray-300">24/7 AI Financial Coach</td>
                  <td className="py-4 px-6 text-center">
                ...
                <tr className="border-b border-gray-700/50">
                  ...
                  <td className="py-4 px-6 text-center text-amber-400">Product ads</td>
                  <td className="py-4 px-6 text-center text-amber-400">Success fees</td>
                </tr>
                <tr>
                  ...
                  <td className="py-4 px-6 text-center text-amber-400">Monetized</td>
                  <td className="py-4 px-6 text-center text-gray-500 dark:text-slate-400">Protected</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="mt-10 text-center">
            <p className="text-gray-400 dark:text-slate-500 mb-6 text-lg">
              Credit Karma shows you credit. Rocket Money helps you budget.<br />
              <strong className="text-white">Only Fynvita transforms your complete financial life.</strong>
            </p>
            <Link
      ...
      <section className="py-20 bg-white dark:bg-slate-900">
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {addOns.map((addon) => (
              <div key={addon.id} className="bg-gray-50 dark:bg-slate-800 rounded-xl p-6 border border-gray-200 dark:border-slate-700 hover:border-emerald-300 dark:hover:border-emerald-700 transition-all hover:shadow-md">
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">{addon.name}</h3>
                <p className="text-gray-600 dark:text-slate-400 text-sm mb-4">{addon.description}</p>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-gray-900 dark:text-white">${addon.price}<span className="text-sm font-normal text-gray-500 dark:text-slate-400">/mo</span></span>
                  <span className="text-xs text-gray-500 dark:text-slate-400">
                    For: {addon.availableFor.map(t => t.charAt(0).toUpperCase() + t.slice(1)).join(', ')}
                  </span>
                </div>
              </div>
            ))}
              ...
              <table className="w-full bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-lg">
                <thead>
                  <tr className="bg-gray-100 dark:bg-slate-800">
                    <th className="text-left py-4 px-6 font-medium text-gray-600 dark:text-slate-300 text-sm">Feature</th>
                    <th className="text-center py-4 px-4 font-bold text-gray-900 dark:text-white">Free</th>
                    <th className="text-center py-4 px-4 font-bold text-gray-900 dark:text-white">Standard</th>
                    <th className="text-center py-4 px-4 font-bold text-emerald-600">Pro</th>
                    <th className="text-center py-4 px-4 font-bold text-gray-900 dark:text-white">Family</th>
                  </tr>
                </thead>
                <tbody>
                  {comparisonFeatures.map((category, catIdx) => (
                    <>
                      <tr key={`cat-${catIdx}`} className="bg-gray-50 dark:bg-slate-900">
                        <td colSpan={5} className="py-3 px-6 font-bold text-gray-900 dark:text-white">{category.category}</td>
                      </tr>
                      {category.features.map((feature, featIdx) => (
                        <tr key={`feat-${catIdx}-${featIdx}`} className="border-b border-gray-100 dark:border-slate-700">
                          <td className="py-3 px-6 text-sm text-gray-700 dark:text-slate-200">{feature.name}</td>
      ...
      <section className="py-24 bg-gradient-to-r from-emerald-600 to-blue-600">
        <div className="max-w-[800px] mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/80 mb-8">
            Join 50,000+ users who&apos;ve transformed their financial lives with Fynvita.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/credit" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">Credit Health</Link></li>
                <li><Link href="/financial-hub" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">Financial Wellness</Link></li>
                <li><Link href="/invest" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">Investment Intelligence</Link></li>
                <li><Link href="/loans" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">Student Loans</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-sm font-bold text-white mb-4">Plans</h4>
              <ul className="space-y-3">
                <li><Link href="/pricing" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">Free</Link></li>
                <li><Link href="/pricing" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">Standard - $29.99</Link></li>
                <li><Link href="/pricing" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">Pro - $99.99</Link></li>
                <li><Link href="/pricing" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">Family - $199.99</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-sm font-bold text-white mb-4">Company</h4>
              <ul className="space-y-3">
                <li><Link href="/about" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">About</Link></li>
                <li><Link href="/contact" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">Contact</Link></li>
                <li><Link href="/careers" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">Careers</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-sm font-bold text-white mb-4">Legal</h4>
              <ul className="space-y-3">
                <li><Link href="/privacy" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">Privacy Policy</Link></li>
                <li><Link href="/terms" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">Terms of Service</Link></li>
                <li><Link href="/security" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">Security</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-sm font-bold text-white mb-4">Support</h4>
              <ul className="space-y-3">
                <li><Link href="/help" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">Help Center</Link></li>
                <li><Link href="/help/faq" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">FAQ</Link></li>
                <li><Link href="/contact" className="text-sm text-gray-400 dark:text-slate-500 hover:text-white">Contact Support</Link></li>
              </ul>
            </div>
          </div>
          <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-white font-semibold">Fynvita</span>
            </div>
            <p className="text-sm text-gray-500 dark:text-slate-400">
