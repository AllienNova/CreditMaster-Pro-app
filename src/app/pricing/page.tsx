          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">AI-Powered Credit Intelligence</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 bg-clip-text text-transparent mb-4">
            Choose Your Credit Intelligence Plan
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Access AI-powered credit tools and strategies with transparent pricing and no hidden fees
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Access 300+ AI models to generate dispute letters, analyze credit reports, and create personalized strategies
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Learn proven strategies for credit improvement, student loan optimization, and financial planning
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Self-service platform puts you in charge. Generate, review, and send your own correspondence
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-blue-50 border-l-4 border-blue-500 p-6 rounded-lg">
          <p className="text-sm text-blue-800 leading-relaxed">
            <strong>Important:</strong> CreditMaster Pro provides AI-powered tools, templates, and educational resources.
            We do not provide credit repair services. You maintain full control over all actions taken with your credit profile.
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 rounded-2xl p-8 text-white">
            <h2 className="text-2xl font-bold mb-4">Ready to Take Control of Your Credit?</h2>
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              Join 100,000+ users who are using AI-powered tools to understand and improve their credit
            </p>
            <a
              href="/dashboard"
