...
const initialFlags: FeatureFlag[] = [
  { id: "1", name: "ai_dispute_v2", description: "New AI-powered dispute generation engine", enabled: true, rollout: 100, environment: "all", createdAt: "2024-11-01" },
  { id: "2", name: "credit_score_simulator", description: "Interactive credit score simulator", enabled: true, rollout: 75, environment: "production", createdAt: "2024-10-15" },
  { id: "3", name: "plaid_integration", description: "Bank account linking via Plaid", enabled: true, rollout: 100, environment: "all", createdAt: "2024-09-20" },
  { id: "4", name: "goodwill_letter_ai", description: "AI-generated goodwill letters", enabled: false, rollout: 0, environment: "staging", createdAt: "2024-11-20" },
  { id: "5", name: "dark_mode", description: "Dark mode theme option", enabled: false, rollout: 25, environment: "staging", createdAt: "2024-11-25" },
  { id: "6", name: "multi_bureau_sync", description: "Sync disputes across all bureaus", enabled: true, rollout: 50, environment: "production", createdAt: "2024-10-01" },
];
...
export default function AdminFeaturesPage() {
  ...
  const getEnvBadge = (env: string) => {
    ...
    return <span className={`px-2 py-1 text-xs rounded-full ${styles[env]}`}>{env}</span>;
  };
