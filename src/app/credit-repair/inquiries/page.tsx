...
import InquiryRemovalTool from '@/components/credit-repair/InquiryRemovalTool';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-blue-50 to-blue-50">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-slate-300">Loading inquiry removal tool...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-slate-400">Hard Inquiry Disputes</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2 text-sm">
              ...
              <li>
                <span className="text-gray-900 dark:text-white font-medium">Inquiry Removal</span>
              </li>
            </ol>
          </nav>
        </div>
        ...
        <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h3 className="text-sm font-bold text-blue-900 mb-1">Hard Inquiry Removal</h3>
              <p className="text-xs text-blue-800">
                Remove unauthorized hard inquiries that can lower your score by 5-10 points each. 40-60% success rate for unauthorized inquiries.
              </p>
            </div>
          </div>
        </div>
