    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-blue-50 to-blue-50">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-slate-300">Loading utilization optimizer...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-50 to-blue-50">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-slate-400">Credit Card Management</p>
              </div>
            </div>
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <Link href="/credit-repair/disputes" className="text-sm font-medium text-gray-700 dark:text-slate-200 hover:text-blue-600 transition-colors">
                Disputes
              </Link>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2 text-sm">
              ...
              <li>
                <span className="text-gray-900 dark:text-white font-medium">Cards</span>
              </li>
            </ol>
          </nav>
        </div>
        ...
        <div className="mt-8 bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Utilization Impact Guide</h2>
        ...
        <div className="mt-8 bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
          <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Expected Score Impact</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-gray-900 dark:text-white mb-3">Utilization Reduction</h4>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-center space-x-3">
                <div className="text-2xl"></div>
                <div>
                  <h4 className="font-bold text-gray-900 dark:text-white">Dispute Accelerator</h4>
                  <p className="text-xs text-gray-600 dark:text-slate-300">Remove inaccurate items</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center space-x-3">
                <div className="text-2xl"></div>
                <div>
                  <h4 className="font-bold text-gray-900 dark:text-white">Payment Timing</h4>
                  <p className="text-xs text-gray-600 dark:text-slate-300">Optimize payment dates</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center space-x-3">
                <div className="text-2xl"></div>
                <div>
                  <h4 className="font-bold text-gray-900 dark:text-white">Credit Building</h4>
                  <p className="text-xs text-gray-600 dark:text-slate-300">Build credit history</p>
                </div>
              </div>
            </Link>
          </div>
