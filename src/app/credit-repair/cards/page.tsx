          ...
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <Link
                ...
                className="text-sm font-medium text-green-600 border-b-2 border-green-600 pb-1"
              >
                Cards
              </Link>
            </nav>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-green-800">
                Utilization is 30% of your credit score. Keep it under 10% per
                card and overall for maximum impact. Our AI calculates the
                optimal payment distribution to boost your score by 10-50
                points.
              </p>
            </div>
          </div>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ul className="space-y-2 text-sm text-blue-800">
            <li className="flex items-start space-x-2">
              ...
              <span>
                <strong>Pay BEFORE statement date</strong> - Utilization is
                reported on statement closing date, not due date
              </span>
            </li>
            <li className="flex items-start space-x-2">
              <span className="text-blue-600 font-bold">2.</span>
              <span>
                <strong>Keep cards open</strong> - Closing cards reduces total
                available credit and increases utilization
              </span>
            </li>
            <li className="flex items-start space-x-2">
              <span className="text-blue-600 font-bold">3.</span>
              <span>
                <strong>Request credit limit increases</strong> - Higher limits
                = lower utilization (if you don't spend more)
              </span>
            </li>
            <li className="flex items-start space-x-2">
              <span className="text-blue-600 font-bold">4.</span>
              <span>
                <strong>Use multiple cards</strong> - Spread purchases across
                cards to keep per-card utilization low
              </span>
            </li>
            <li className="flex items-start space-x-2">
              <span className="text-blue-600 font-bold">5.</span>
              <span>
                <strong>Make multiple payments</strong> - Pay down balances
                multiple times per month to keep utilization low
              </span>
            </li>
          </ul>
        </div>
