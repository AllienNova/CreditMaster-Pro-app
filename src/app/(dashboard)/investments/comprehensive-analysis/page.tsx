      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 dark:text-slate-500 text-lg">
            Powered by the unified InvestmentAnalysisEngine integrating all 6
            analysis services
          </p>
        </div>
        ...
        <div className="mt-8 bg-blue-900/20 border border-blue-800/50 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-300">
            <div>
              ...
              <p className="text-sm">
                Combines scores from all 6 services using weighted averages:
                Technical (30%), Fundamental (35%), Sentiment (20%), Pattern
                (15%). Confidence is calculated based on variance between
                services.
              </p>
            </div>
            <div>
              ...
              <p className="text-sm">
                Measures alignment between different analysis types on a -1 to 1
                scale. Strong alignment (≥0.7) indicates high confidence, while
                conflicting signals (&lt;0.3) suggest caution.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-white mb-2">Risk Assessment</h4>
              <p className="text-sm">
                Evaluates multiple risk factors including volatility, technical
                indicators, fundamental health, and sentiment trends to provide
            ...
            <div>
              ...
              <p className="text-sm">
                Generates key insights, identifies risks, and highlights
                opportunities based on comprehensive analysis across all
                services.
              </p>
            </div>
          </div>
