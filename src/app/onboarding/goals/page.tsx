...
const goals = [
  // Credit Goals
  {
    ...
    icon: "home",
    title: "Buy a Home",
    description: "Get mortgage-ready with a 740+ score",
    popular: true,
    category: "credit",
  },
  {
    ...
    icon: "truck",
    title: "Buy a Car",
    description: "Qualify for the best auto loan rates",
    popular: true,
    category: "credit",
  },
  {
  ...
  },
  {
    ...
    description: "Clean up errors and outdated info",
    popular: false,
    category: "credit",
  },
  {
    ...
    description: "Establish or rebuild your credit",
    popular: false,
    category: "credit",
  },
  // Financial Goals (NEW)
  ...
  },
  {
    ...
    description: "Cut unused subscriptions and save money",
    popular: true,
    category: "spending",
  },
  {
    ...
    description: "Accelerate debt payoff with smart strategies",
    popular: true,
    category: "debt",
  },
  {
    ...
    icon: "bolt",
    title: "Budget Better",
    description: "Track spending and stick to your budget",
    popular: false,
    category: "spending",
  },
  {
...
const timeframes = [
  {
    id: "3_months",
    label: "3 months",
    description: "Aggressive improvement",
    recommended: false,
  },
  {
    id: "6_months",
    ...
    <div>
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 dark:text-slate-300">
          Tell us what you want to achieve so we can create your personalized
          plan
        </p>
      </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedGoals.map((goalId) => {
                      ...
                      return goal ? (
                        <span
                          key={goalId}
                          className="inline-flex items-center gap-1 px-2 py-1 bg-white dark:bg-slate-800 rounded text-xs text-gray-700 dark:text-slate-200"
                        >
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-6">
              <div className="flex items-center gap-2 mb-4">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
                  What score do you want to reach?
                </h2>
                <EducationalTooltip
              ...
              {showCalculator ? (
                ...
                <div className="bg-gray-50 dark:bg-slate-900 rounded-xl p-6 border-2 border-dashed border-gray-300 dark:border-slate-600 text-center">
                  ...
                  <p className="text-sm text-gray-600 dark:text-slate-300">
                    Fill out the form to see your personalized improvement
                    forecast and potential savings
                  </p>
                </div>
              )}
            </div>
