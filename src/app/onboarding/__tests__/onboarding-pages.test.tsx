...
describe("Onboarding Welcome Page", () => {
  it("renders welcome page", () => {
    ...
    const welcomeText =
      ...
      screen.queryByText(/Onboarding/i);
  ...
  it("shows get started button", () => {
    ...
    const startButton =
      screen.queryByRole("link", { name: /start|begin|continue/i }) ||
...
describe("Onboarding Profile Page", () => {
  ...
  it("has continue button", () => {
    ...
    const continueButton =
      screen.queryByRole("link", { name: /continue|next/i }) ||
...
describe("Onboarding Connect Page", () => {
  ...
  it("renders connect accounts page", () => {
    ...
    expect(
      connectElements.length + accountElements.length + linkElements.length,
    ).toBeGreaterThan(0);
  });
  ...
  it("shows credit bureau options", () => {
    ...
    expect(
      experianElements.length + creditElements.length + bureauElements.length,
    ).toBeGreaterThan(0);
  });
  ...
  it("shows bank connection option", () => {
    ...
    expect(
      bankElements.length + plaidElements.length + financialElements.length,
    ).toBeGreaterThan(0);
  });
