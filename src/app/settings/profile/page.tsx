...
export default function ProfileSettingsPage() {
  ...
  return (
    <div>
      ...
      <p className="text-gray-600 dark:text-slate-300 mb-8">Update your personal information</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center gap-6 pb-6 border-b border-gray-200 dark:border-slate-700">
          ...
          <div>
            <button type="button" className="px-4 py-2 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition">
              Upload Photo
            </button>
            <p className="text-xs text-gray-500 dark:text-slate-400 mt-2">JPG, PNG or GIF. Max 2MB.</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">First Name</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">Last Name</label>
            <input
              type="text"
        ...
        {/* Date of Birth */}
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">Date of Birth</label>
          <input
            type="date"
        ...
        {/* Address Fields */}
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">Street Address</label>
          <input
            type="text"
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">ZIP Code</label>
            <input
              type="text"
