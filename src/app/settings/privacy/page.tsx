...
export default function PrivacySettingsPage() {
  ...
  return (
    <div>
      ...
      <p className="text-gray-600 mb-8">Control how your data is used and shared</p>
      ...
      <div className="space-y-6">
        <div className="pb-6 border-b border-gray-200">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              >
                <span className={`block w-5 h-5 bg-white rounded-full shadow transform transition ${settings.shareDataWithPartners ? "translate-x-6" : "translate-x-0.5"}`} />
              </button>
            </div>

            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium text-gray-900">Analytics & improvements</p>
              ...
              >
                <span className={`block w-5 h-5 bg-white rounded-full shadow transform transition ${settings.allowAnalytics ? "translate-x-6" : "translate-x-0.5"}`} />
              </button>
            </div>

            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium text-gray-900">Personalized advertising</p>
              ...
              >
                <span className={`block w-5 h-5 bg-white rounded-full shadow transform transition ${settings.allowPersonalizedAds ? "translate-x-6" : "translate-x-0.5"}`} />
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="pb-6 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-500 mb-4">Choose how long we keep your historical data</p>
          <select
