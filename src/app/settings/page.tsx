...
export default function SettingsPage() {
  ...
  return (
    <div>
      ...
      {/* Appearance Section */}
      <div className="mb-8 p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
      ...
      <div className="grid gap-4">
        {settingsSections.map((section) => (
          <Link
            key={section.href}
            href={section.href}
            className="flex items-center gap-4 p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-emerald-300 dark:hover:border-emerald-600 hover:bg-emerald-50/50 dark:hover:bg-emerald-900/20 transition group"
          >
            <div className="w-12 h-12 rounded-full bg-gray-100 dark:bg-gray-700 group-hover:bg-emerald-100 dark:group-hover:bg-emerald-900/50 flex items-center justify-center text-2xl transition">
              {section.icon}
            </div>
            ...
            <div className="text-right">
              ...
              <span className="ml-2 text-gray-400 dark:text-gray-500 group-hover:text-emerald-500 transition">
                →
              </span>
            </div>
          </Link>
