            ...
            <button
              ...
              className={`p-6 rounded-lg text-left transition-all ${
                activeTool === tool.id
                  ...
                  : 'bg-white text-gray-800 hover:shadow-md hover:scale-102'
              }`}
            >
              <div className="text-4xl mb-3">{tool.icon}</div>
              <h3 className="text-lg font-semibold mb-2">{tool.name}</h3>
              <p className={`text-sm mb-3 ${
                activeTool === tool.id ? 'text-blue-100' : 'text-gray-600'
              }`}>
                {tool.description}
              </p>
              <div className={`text-xs ${
                activeTool === tool.id ? 'text-blue-200' : 'text-gray-500'
              }`}>
                Model: {tool.model}
              </div>
            </button>
        ...
        <div className="mt-8 bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border-l-4 border-purple-500 pl-4">
              ...
              <p className="text-sm text-gray-600 mb-2">Best for legal writing and dispute letters</p>
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              ...
              <p className="text-sm text-gray-600 mb-2">Best for reasoning and analysis</p>
              <ul className="text-xs text-gray-500 space-y-1">
            ...
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <p className="text-sm text-gray-600 mb-2">Best for mathematical calculations</p>
              <ul className="text-xs text-gray-500 space-y-1">
            ...
            <div className="border-l-4 border-yellow-500 pl-4">
              ...
              <p className="text-sm text-gray-600 mb-2">Best for general conversations</p>
              <ul className="text-xs text-gray-500 space-y-1">
