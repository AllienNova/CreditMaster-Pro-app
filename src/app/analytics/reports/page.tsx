...
const scheduledReports = [
  ...
  {
    name: "Dispute Status Alert",
    frequency: "On Change",
    nextRun: "When updated",
    status: "active",
  },
];
...
const recentDownloads = [
  ...
  {
    name: "Dispute Progress Report - Nov 2024",
    date: "Nov 28, 2024",
    format: "PDF",
    size: "312 KB",
  },
  {
    name: "Monthly Progress - Nov 2024",
    date: "Nov 30, 2024",
    format: "PDF",
    size: "189 KB",
  },
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 mb-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 p-6">
          {availableReports.map((report) => (
            <div
              key={report.id}
              className="border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:border-emerald-300 hover:shadow-sm transition cursor-pointer"
            >
              ...
              <div key={i} className="p-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-slate-400">
                      {download.date} • {download.format} • {download.size}
                    </p>
                  </div>
                </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-emerald-100 mt-1">
              Create personalized reports with the data that matters most to you
            </p>
          </div>
