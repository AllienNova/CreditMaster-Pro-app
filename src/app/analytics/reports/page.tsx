...
const availableReports = [
  { id: "1", name: "Credit Score Summary", description: "Overview of your credit scores across all bureaus", type: "summary", lastGenerated: "Dec 1, 2024", icon: "📊" },
  { id: "2", name: "Dispute Progress Report", description: "Detailed status of all your disputes", type: "disputes", lastGenerated: "Nov 28, 2024", icon: "📝" },
  { id: "3", name: "Monthly Progress Report", description: "Month-over-month credit improvement analysis", type: "progress", lastGenerated: "Nov 30, 2024", icon: "📈" },
  { id: "4", name: "Negative Items Report", description: "List of all negative items on your credit reports", type: "negative", lastGenerated: "Nov 25, 2024", icon: "⚠️" },
  { id: "5", name: "Credit Utilization Report", description: "Analysis of your credit card usage", type: "utilization", lastGenerated: "Dec 1, 2024", icon: "💳" },
  { id: "6", name: "Account History Report", description: "Complete history of all your credit accounts", type: "accounts", lastGenerated: "Nov 20, 2024", icon: "📋" },
];
    ...
    <div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 mb-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 p-6">
          {availableReports.map((report) => (
            <div key={report.id} className="border border-gray-200 rounded-lg p-4 hover:border-emerald-300 hover:shadow-sm transition cursor-pointer">
              ...
              <div key={i} className="p-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{download.date} • {download.format} • {download.size}</p>
                  </div>
                </div>
      ...
      <div className="mt-8 bg-gradient-to-r from-emerald-500 to-blue-500 rounded-xl p-6 text-white">
        <div className="flex items-center justify-between">
          ...
          <button className="px-6 py-2 bg-white text-emerald-600 rounded-lg font-medium hover:bg-emerald-50 transition">
            Build Custom Report
          </button>
        </div>
      </div>
