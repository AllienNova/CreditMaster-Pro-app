...
const trendMetrics = [
  {
    ...
    unit: "pts/month",
    trend: "up",
    description: "Average monthly score increase",
  },
  {
    label: "Dispute Success Trend",
    value: "78%",
    unit: "",
    trend: "up",
    description: "Improving from 65% last quarter",
  },
  {
    ...
    unit: "",
    trend: "down",
    description: "Decreasing (good)",
  },
  {
    label: "Account Age Trend",
    value: "+0.5",
    unit: "yrs",
    trend: "up",
...
const projections = [
  {
    ...
    projectedScore: 745,
    confidence: "High",
    factors: "Continued dispute success, lower utilization",
  },
  {
    timeframe: "6 months",
    projectedScore: 770,
    confidence: "Medium",
    factors: "Account aging, payment history",
  },
  {
    timeframe: "12 months",
    projectedScore: 800,
    confidence: "Low",
    factors: "All factors improving",
  },
];
...
const insights = [
  {
    ...
    description:
      "Your score has increased every month for 6 consecutive months",
  },
  {
    type: "positive",
    title: "Dispute Strategy Working",
    description: "Your dispute success rate is 13% above average",
  },
  {
    type: "warning",
    title: "Utilization Still High",
    description: "Consider paying down balances to below 30% for optimal score",
  },
  {
    type: "info",
    title: "Account Age Improving",
    description: "Your average account age will cross 6 years next quarter",
  },
];
          ...
          <div className="space-y-4">
            {monthlyTrends.map((month, i) => (
              <div key={month.month} className="flex items-center gap-4">
                <span className="w-8 text-sm text-gray-500 dark:text-slate-400">
                  {month.month}
                </span>
                <div className="flex-1 flex items-center gap-2">
                  <div className="flex-1 bg-gray-100 dark:bg-slate-800 rounded-full h-6 relative overflow-hidden">
                    <div
                      ...
                      style={{ width: `${((month.score - 500) / 350) * 100}%` }}
                    />
                ...
                <div className="w-20 text-right">
                  <span
                    className={`text-xs ${i > 0 && month.score > monthlyTrends[i - 1].score ? "text-emerald-500" : "text-gray-400 dark:text-slate-500"}`}
                  >
                    {i > 0
                      ? `+${month.score - monthlyTrends[i - 1].score}`
                      : "-"}
                  </span>
                </div>
              </div>
