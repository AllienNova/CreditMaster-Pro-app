...
function StudentLoanDisputesContent() {
  ...
  const [selectedStrategy, setSelectedStrategy] =
    useState<DisputeStrategy | null>(null);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
            Student Loan Dispute Strategies
          </h1>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-blue-900 mb-2">
                How Dispute Strategies Work
              </h3>
              <p className="text-sm text-blue-800 mb-3">
                Our AI analyzes your loan servicer's records for common errors
                including:
              </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          {strategies.length === 0 ? (
            <div className="col-span-2 bg-white dark:bg-slate-800 rounded-lg shadow-sm p-12 text-center">
              ...
              <p className="text-gray-600 dark:text-slate-300 mb-6">
                Our AI hasn't detected any servicer errors for this loan yet.
                Check back later or contact support if you believe there's an
                error.
              </p>
              <button
            ...
            strategies.map((strategy, index) => (
              <DisputeStrategyCard
                ...
                rank={index + 1}
                isSelected={
                  selectedStrategy?.dispute_id === strategy.dispute_id
                }
        ...
        {selectedStrategy && (
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-6 mb-8">
            ...
            <div className="mb-6">
              ...
              <div className="bg-gray-50 dark:bg-slate-900 rounded-lg p-6 border border-gray-200 dark:border-slate-700">
                <pre className="text-sm text-gray-700 dark:text-slate-200 whitespace-pre-wrap font-sans">
                  {selectedStrategy.letter_content ||
                    'Letter content will be generated when you click "Generate Dispute Letter"'}
                </pre>
              </div>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2">
                {selectedStrategy.required_documentation.map((doc, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-slate-900 rounded-lg"
                  >
                    <input
                      type="checkbox"
            ...
            {/* Legal Precedents */}
            {selectedStrategy.legal_precedents &&
              selectedStrategy.legal_precedents.length > 0 && (
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">
                    Supporting Legal Precedents
                  </h3>
                  <div className="space-y-3">
                    {selectedStrategy.legal_precedents.map(
                      (precedent, index) => (
                        <div
                          key={index}
