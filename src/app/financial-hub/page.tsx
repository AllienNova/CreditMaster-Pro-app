...
export const metadata: Metadata = {
  title: 'Financial Hub | CPFI',
  description: 'Complete financial management with budgeting, expense tracking, and goal planning.',
};
        ...
        <div className="max-w-[980px] mx-auto px-6">
          <div className="flex justify-between items-center h-12">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/financial-hub" className="text-xs text-green-600 font-medium">Financial</Link>
      ...
      <section className="pt-32 pb-20">
        <div className="max-w-[980px] mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8 leading-relaxed">
            Track spending, create budgets, set goals, and build the financial future
            you deserve with intelligent automation.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                AI-powered budgets that adapt to your spending patterns and help you save more.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Automatic categorization of transactions with insights into spending habits.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Set savings goals and track progress with smart projections and milestones.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Visualize your money flow and identify opportunities to optimize.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                AI strategies to pay off debt faster using avalanche or snowball methods.
              </p>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">Bank-level security (256-bit encryption)</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-700">12,000+ financial institutions</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                <div className="bg-white rounded-xl p-4 shadow-sm flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">$8,234.56</p>
                  </div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-sm flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-gray-900">Amex Platinum</p>
                    <p className="text-sm text-gray-600">-$2,150.00</p>
                  </div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-sm flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-gray-900">Fidelity 401(k)</p>
                    <p className="text-sm text-gray-600">$45,678.90</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-[980px] mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
            Join thousands of users who have transformed their financial lives with CPFI.
          </p>
          <Link
            href="/auth/signup"
        ...
        <div className="max-w-[980px] mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/financial/accounts" className="text-xs text-gray-600 hover:text-gray-900">Accounts</Link></li>
                <li><Link href="/financial/goals" className="text-xs text-gray-600 hover:text-gray-900">Goals</Link></li>
                <li><Link href="/financial/cash-flow" className="text-xs text-gray-600 hover:text-gray-900">Cash Flow</Link></li>
              </ul>
            </div>
            <div>
