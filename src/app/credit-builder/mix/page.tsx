          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              <div className="text-4xl font-bold mb-2">
                {totalCurrent} / {totalIdeal}
              </div>
              <div className="text-sm text-blue-100">
                Current vs Ideal Accounts
              </div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold mb-2">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-slate-200 mb-4">
                Credit mix accounts for 10% of your FICO score. Having a diverse
                mix of credit types (revolving credit like credit cards AND
                installment loans) shows lenders you can responsibly manage
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-slate-300">
                        {type.current} account{type.current !== 1 ? "s" : ""}{" "}
                        (Ideal: {type.ideal})
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="w-full bg-gray-200 dark:bg-slate-700 rounded-full h-3">
                      <div
                        ...
                        style={{
                          width: `${(type.current / Math.max(type.current, type.ideal, 1)) * 100}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="w-full bg-gray-200 dark:bg-slate-700 rounded-full h-3">
                      <div
                        ...
                        style={{
                          width: `${(type.ideal / Math.max(type.current, type.ideal, 1)) * 100}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="w-32 bg-gray-200 dark:bg-slate-700 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${(type.current / totalCurrent || 0) * 100}%`,
                        }}
                      ></div>
                    </div>
              ...
              >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                  ...
                  <div className="bg-white dark:bg-slate-800 rounded p-3">
                    ...
                    <div
                      className={`text-sm font-bold ${getDifficultyColor(rec.difficulty)} px-2 py-1 rounded capitalize inline-block`}
                    >
                      {rec.difficulty}
                    </div>
                  </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-800">
                  Don't open accounts just for credit mix. Only get credit you
                  actually need and can manage responsibly. Quality matters more
                  than quantity.
                </p>
              </div>
            </div>
