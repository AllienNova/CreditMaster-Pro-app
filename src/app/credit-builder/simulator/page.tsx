    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-6 text-lg text-gray-700 font-medium">Loading Credit Score Simulator...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-8 mb-8 text-white shadow-xl">
          <div className="text-center">
              ...
              {['payment', 'utilization', 'accounts', 'inquiries', 'negative'].map((category) => (
                <div key={category} className="mb-6">
                  <h3 className="text-lg font-semibold text-gray-800 mb-3 capitalize">
                    ...
                    {category === 'negative' && '⚠️ Negative Items'}
                  </h3>
                  ...
                  <div className="mt-6 p-4 bg-purple-50 rounded-lg border border-purple-200">
                    ...
                    <ol className="space-y-2">
                      {selectedGoalData.steps.map((step, idx) => (
                        <li
                          key={idx}
                          className="flex gap-3 text-sm text-purple-800"
                        >
