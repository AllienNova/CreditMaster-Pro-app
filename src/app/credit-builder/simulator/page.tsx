...
export default function CreditScoreSimulator() {
  ...
  const calculateScoreImpact = (
    ...
    const projectedScore = Math.max(
      300,
      Math.min(850, baseScore + scoreChange),
    );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 max-w-3xl mx-auto">
            See how different actions impact your credit score before you take
            them. Plan your credit improvement strategy with confidence.
          </p>
        </div>
          ...
          <div>
            ...
            {selectedScenarioData && (
              <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6">
                ...
                {["pay_card_full", "pay_card_partial", "pay_loan"].includes(
                  selectedScenario,
                ) && (
                  <div className="mb-4">
                ...
                {["pay_card_partial", "redistribute_balance"].includes(
                  selectedScenario,
                ) && (
                  <div className="mb-4">
                    <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-2">
                ...
                {["wait_inquiries", "wait_negative"].includes(
                  selectedScenario,
                ) && (
                  <div className="mb-4">
                    <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-2">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-blue-50 rounded-xl p-6 mb-6">
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-slate-300">
                    <span>
                      Timeline: {impact.timeline} month
                      {impact.timeline !== 1 ? "s" : ""}
                    </span>
                    <span>•</span>
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <div className="mt-4 pt-4 border-t border-blue-200">
                      ...
                      <p className="text-sm text-blue-800">
                        ...
                        {selectedGoalData.timeline} months with consistent
                        effort
                      </p>
                    </div>
                  </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm text-blue-800">
            <div>
              ...
              <p>
                ...
                <br />
                75-89%: Generally accurate
                <br />
                60-74%: Moderate uncertainty
                <br />
            ...
            <div>
              ...
              <p>
                • Predictions based on FICO scoring model
                <br />
                • Actual impact may vary by credit bureau
                <br />
                • Individual results depend on complete credit profile
                <br />• Combine multiple positive actions for best results
              </p>
            </div>
          </div>
        </div>
