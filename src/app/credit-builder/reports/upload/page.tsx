  ...
  const analyzeReport = async () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setResult({
          bureau: file.name.toLowerCase().includes("experian")
            ? "Experian"
          ...
          >
            ...
            <div className="mt-8 grid grid-cols-3 gap-4 text-sm text-gray-500 dark:text-slate-400">
              <div className="p-3 bg-gray-50 dark:bg-slate-900 rounded-lg">
                <span className="text-blue-600 font-medium">Experian</span>
                <br />
                Supported
              </div>
              <div className="p-3 bg-gray-50 dark:bg-slate-900 rounded-lg">
                <span className="text-red-600 font-medium">Equifax</span>
                <br />
                Supported
              </div>
              <div className="p-3 bg-gray-50 dark:bg-slate-900 rounded-lg">
                <span className="text-green-600 font-medium">TransUnion</span>
                <br />
                Supported
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8">
              ...
              <div className="flex gap-4 mt-8">
                ...
                <button
                  ...
                  className="px-6 py-3 border border-gray-300 dark:border-slate-600 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 dark:bg-slate-900"
                >
                  Upload Another
                </button>
              </div>
