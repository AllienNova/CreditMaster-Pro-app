    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="bg-gray-200 dark:bg-slate-700 rounded-lg h-48"
          />
        ))}
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-slate-400">
            Create a strategic plan to become debt-free using proven payoff
            strategies
          </p>
        </div>
          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-400">
                <strong>Avalanche:</strong> Pay highest interest first (saves
                most money) •<strong className="ml-2">Snowball:</strong> Pay
