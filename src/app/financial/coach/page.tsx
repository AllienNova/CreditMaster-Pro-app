...
export const metadata: Metadata = {
  title: 'AI Financial Coach | CPFI',
  description: 'Get personalized financial coaching powered by AI using Dave Ramsey\'s proven strategies',
  openGraph: {
    title: 'AI Financial Coach | CPFI',
    description: 'Get personalized financial coaching powered by AI using Dave Ramsey\'s proven strategies',
    type: 'website',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Your personal AI-powered financial coach using Dave Ramsey's proven Baby Steps methodology
          </p>
        </div>
