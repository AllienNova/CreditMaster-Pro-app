...
export const metadata: Metadata = {
  title: "Recommendations | AI Financial Coach | Fynvita",
  description:
    "Personalized AI-powered financial recommendations based on your spending, goals, and financial profile",
  openGraph: {
    title: "Recommendations | AI Financial Coach | Fynvita",
    description:
      "Personalized AI-powered financial recommendations based on your spending, goals, and financial profile",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-slate-400">
            Personalized AI-powered recommendations based on your financial
          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-400">
                Your AI coach combines spending analysis, budget optimization,
                and goal tracking to deliver actionable recommendations tailored
                to your unique financial situation. Recommendations update as
                your data changes.
              </p>
            </div>
          </div>
