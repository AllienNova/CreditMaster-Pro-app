...
export const metadata: Metadata = {
  title: "Goal Tracker | AI Financial Coach | Fynvita",
  description:
    "Track and optimize your financial goals with AI-powered progress monitoring and recommendations",
  openGraph: {
    title: "Goal Tracker | AI Financial Coach | Fynvita",
    description:
      "Track and optimize your financial goals with AI-powered progress monitoring and recommendations",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-slate-400">
            Track, manage, and optimize your financial goals with AI-powered
          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-400">
                Your AI coach monitors progress across all your financial goals,
                identifies opportunities to accelerate timelines, and
                recommends contribution adjustments based on your spending
                patterns and income.
              </p>
            </div>
          </div>
