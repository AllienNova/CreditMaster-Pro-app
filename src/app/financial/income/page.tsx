...
export const metadata: Metadata = {
  title: 'Income Tracking | Fynvita',
  description: 'Track and analyze your income sources',
};

function IncomeLoadingSkeleton() {
  return (
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Income Tracking</h1>
          <p className="mt-2 text-gray-600 dark:text-slate-300">
            Track and analyze your income sources
          </p>
        </div>

        <Suspense fallback={<IncomeLoadingSkeleton />}>
          <IncomeTracking />
        </Suspense>
      </div>
    </div>
