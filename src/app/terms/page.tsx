      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8 md:p-12">
        ...
        <div className="mb-8 p-6 bg-gray-50 rounded-lg">
          ...
          <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700">
            ...
            <li><a href="#user-responsibility" className="hover:text-blue-600">User Responsibility and Control</a></li>
            <li><a href="#not-credit-repair" className="hover:text-blue-600">Not a Credit Repair Service</a></li>
            <li><a href="#educational" className="hover:text-blue-600">Educational Purpose</a></li>
            <li><a href="#no-guarantees" className="hover:text-blue-600">No Guarantees or Warranties</a></li>
            <li><a href="#user-obligations" className="hover:text-blue-600">User Obligations</a></li>
            <li><a href="#payment" className="hover:text-blue-600">Payment and Subscriptions</a></li>
            <li><a href="#intellectual-property" className="hover:text-blue-600">Intellectual Property</a></li>
            <li><a href="#limitation" className="hover:text-blue-600">Limitation of Liability</a></li>
        ...
        <section id="description" className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            The Platform is a <strong>self-service tool</strong> that empowers you to take action on your own behalf. 
            We provide the technology; you maintain complete control over how you use it.
          </p>
        </section>

        {/* Section 3 */}
        <section id="user-responsibility" className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">3. User Responsibility and Control</h2>
          <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 mb-4">
            <p className="text-yellow-800 font-semibold">
              YOU ARE SOLELY RESPONSIBLE FOR ALL ACTIONS TAKEN USING THE PLATFORM.
            </p>
          </div>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
            <li>You maintain full control over all documents generated and actions taken</li>
            <li>You are responsible for reviewing, editing, and approving all generated content</li>
            <li>You decide whether, when, and how to send any correspondence</li>
            <li>You are responsible for ensuring accuracy of all information you provide</li>
            <li>You must comply with all applicable laws and regulations</li>
            <li>We do not act on your behalf or represent you in any capacity</li>
            <li>We do not communicate with credit bureaus, creditors, or collectors on your behalf</li>
          </ul>
        </section>
        ...
        <section id="not-credit-repair" className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            We are a <strong>technology platform</strong> that provides tools for your personal use, similar to 
            how TurboTax provides tax software (but is not a tax preparation service) or LegalZoom provides 
            legal document templates (but is not a law firm).
          </p>
        </section>

        {/* Section 5 */}
        <section id="educational" className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Educational Purpose</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            All content, tools, and resources provided by the Platform are for <strong>educational and 
            informational purposes only</strong>. They do not constitute:
          </p>
          <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4 mb-4">
            ...
            <li>Personalized recommendations (AI-generated content is general in nature)</li>
          </ul>
          <p className="text-gray-700 leading-relaxed">
            You should consult with qualified professionals (attorneys, financial advisors, credit counselors) 
        ...
        <section id="no-guarantees" className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">6. No Guarantees or Warranties</h2>
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            <strong>Results vary significantly</strong> based on individual circumstances, credit history, creditor 
            policies, and many other factors beyond our control.
          </p>
          <p className="text-gray-700 leading-relaxed">
            THE PLATFORM IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT 
        ...
        <section id="user-obligations" className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">7. User Obligations</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            You agree to:
          </p>
          <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4 mb-4">
          ...
          <p className="text-gray-700 leading-relaxed">
            Violation of these obligations may result in immediate termination of your account.
          </p>
        </section>

        {/* Section 8 */}
        <section id="payment" className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">8. Payment and Subscriptions</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <section id="intellectual-property" className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            <strong>Your Content:</strong> You retain ownership of any information you input into the Platform.
            You grant us a limited license to process your data solely to provide the Platform services.
          </p>
          <p className="text-gray-700 leading-relaxed">
            <strong>Generated Content:</strong> Documents and content generated by the Platform using your input
            are yours to use. However, you may not resell, redistribute, or commercialize the Platform's tools
            or templates.
          </p>
        </section>
        ...
        <section id="limitation" className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4 mb-4">
            ...
            <li>We are not liable for any credit score changes (positive or negative)</li>
            <li>We are not responsible for actions taken by credit bureaus, creditors, or collectors</li>
            <li>Our total liability is limited to the amount you paid for the Platform in the past 12 months</li>
          </ul>
          <p className="text-gray-700 leading-relaxed">
            You use the Platform at your own risk. We provide tools; you are responsible for how you use them.
          </p>
        </section>
        ...
        <section id="termination" className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Upon termination, your access to the Platform will cease immediately. You remain responsible for
        ...
        <section className="mb-8 bg-blue-50 p-6 rounded-lg">
          <h2 className="text-2xl font-bold text-blue-900 mb-4">Additional Disclosures</h2>

          <h3 className="text-lg font-bold text-blue-800 mb-2">Consumer Rights</h3>
          <p className="text-blue-700 mb-4 text-sm leading-relaxed">
            You have the right to dispute inaccurate information on your credit report under the Fair Credit
            Reporting Act (FCRA). You can file disputes directly with credit bureaus at no cost. The Platform
            provides tools to help you exercise these rights, but you are not required to use our Platform
            to dispute credit report errors.
          </p>

          <h3 className="text-lg font-bold text-blue-800 mb-2">AI-Generated Content</h3>
          <p className="text-blue-700 mb-4 text-sm leading-relaxed">
            Content generated by our AI tools is based on patterns and templates. It may contain errors or
            inaccuracies. You must review, verify, and edit all AI-generated content before use. We are not
            responsible for any consequences arising from the use of AI-generated content.
          </p>

          <h3 className="text-lg font-bold text-blue-800 mb-2">Data Privacy</h3>
          <p className="text-blue-700 text-sm leading-relaxed">
            Your use of the Platform is also governed by our Privacy Policy. We take data security seriously
            and employ industry-standard measures to protect your information. However, no system is 100% secure.
          </p>
        </section>
