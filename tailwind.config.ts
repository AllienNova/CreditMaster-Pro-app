  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'xs':   ['0.64rem',  { lineHeight: '1.5' }],    /* 10.24px — badges, fine print */
        ...
        '3xl':  ['3.052rem', { lineHeight: '1.15' }],    /* 48.8px  — hero display */
      ...
      boxShadow: {
        ...
        'card-hover': '0 8px 16px -4px rgb(0 0 0 / 0.12), 0 4px 6px -2px rgb(0 0 0 / 0.08)',
        'float':   '0 16px 32px -8px rgb(0 0 0 / 0.16), 0 6px 12px -4px rgb(0 0 0 / 0.08)',
      },
