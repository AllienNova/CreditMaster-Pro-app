...
describe("API Health Check — All Endpoints", () => {
  ...
  describe("Credit Repair API", () => {
    ...
    const dynamicRoutes = [
      {
        method: "GET",
        path: "/api/credit-repair/disputes/fake-id",
        expect: 401,
      },
      { method: "GET", path: "/api/credit-repair/cards/fake-id", expect: 401 },
      {
        method: "GET",
        path: "/api/credit-repair/negotiate/fake-id",
        expect: 401,
      },
      {
        method: "GET",
        path: "/api/credit-repair/goodwill/fake-id",
        expect: 401,
      },
      {
        method: "GET",
        path: "/api/credit-repair/reports/fake-id",
        expect: 401,
      },
    ];
