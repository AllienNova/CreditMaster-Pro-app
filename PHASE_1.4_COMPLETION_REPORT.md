...
console.log(`Target: $${newGoal.targetAmount} by ${newGoal.targetDate.toLocaleDateString()}`);
```
...
console.log(`Projected Completion: ${progress.predictions.projectedCompletionDate.toLocaleDateString()}`);
console.log(`Probability of Success: ${progress.predictions.probabilityOfSuccess}%`);
```
...
console.log(`On Track: ${metrics.onTrackCount} | Behind: ${metrics.behindCount} | Ahead: ${metrics.aheadCount}`);
```
