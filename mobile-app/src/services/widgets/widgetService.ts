...
class WidgetService {
   ...
   */
  async updateCreditScore(data: Partial<WidgetData['creditScore']>): Promise<void> {
   ...
   */
  async updateFinancialSummary(data: Partial<WidgetData['financialSummary']>): Promise<void> {
   ...
   */
  async updateInvestments(data: Partial<WidgetData['investments']>): Promise<void> {
   ...
   */
  async updateQuickActions(data: Partial<WidgetData['quickActions']>): Promise<void> {
  ...
  async getFormattedWidgetData(widgetType: keyof WidgetData): Promise<unknown> {
    ...
    switch (widgetType) {
      ...
      case 'financialSummary':
        return {
          ...this.widgetData.financialSummary,
          formattedNetWorth: this.formatCurrency(this.widgetData.financialSummary.netWorth),
          formattedSpending: this.formatCurrency(this.widgetData.financialSummary.monthlySpending),
      ...
      case 'investments':
        return {
          ...this.widgetData.investments,
          formattedValue: this.formatCurrency(this.widgetData.investments.portfolioValue),
          formattedChange: this.formatCurrency(this.widgetData.investments.dayChange),
          formattedPercent: this.formatPercent(this.widgetData.investments.dayChangePercent),
