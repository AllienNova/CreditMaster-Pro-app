...
const API_BASE_URL =
  process.env.EXPO_PUBLIC_API_URL || "https://api.Fynvita.pro";
...
export const creditAPI = {
  ...
  getReport: (id: string) =>
    apiRequest<{ report: any }>(`/api/credit/reports/${id}`),
...
export const disputesAPI = {
  ...
  generateFromTemplate: (
    ...
    apiRequest<{ letter: string; template: DisputeTemplate }>(
  ...
  getStrategyRecommendations: (scenario: {
    ...
    apiRequest<{ recommendations: StrategyRecommendation[] }>(
      "/api/disputes/generate",
      {
        method: "POST",
  ...
  getTemplates: () =>
    apiRequest<{ templates: DisputeTemplate[] }>("/api/disputes/templates"),

  // Get templates by category
  getTemplatesByCategory: (category: string) =>
    apiRequest<{ templates: DisputeTemplate[] }>(
      `/api/disputes/templates?category=${category}`,
    ),

  // Get single template by ID
  getTemplate: (templateId: string) =>
    apiRequest<{ template: DisputeTemplate }>(
      `/api/disputes/templates/${templateId}`,
    ),

  // Get all available strategies
  getStrategies: () =>
    apiRequest<{ strategies: DisputeStrategy[] }>("/api/disputes/strategies"),

  // Get strategies by difficulty
  getStrategiesByDifficulty: (difficulty: string) =>
    apiRequest<{ strategies: DisputeStrategy[] }>(
      `/api/disputes/strategies?difficulty=${difficulty}`,
    ),

  // Get single strategy by ID
  getStrategy: (strategyId: string) =>
    apiRequest<{ strategy: DisputeStrategy }>(
      `/api/disputes/strategies/${strategyId}`,
    ),
};
...
export const subscriptionAPI = {
  ...
  cancel: () =>
    apiRequest<{ success: boolean }>("/api/subscription/cancel", {
      method: "POST",
    }),
};
