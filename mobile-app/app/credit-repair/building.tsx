...
const STRATEGIES: Strategy[] = [
  {
    ...
    description:
      "Payment history is 35% of your score. Set up autopay for all accounts.",
    impact: "high",
  ...
  },
  {
    ...
    description:
      "Keep balances below 30% of limits. Aim for under 10% for best results.",
    impact: "high",
  ...
  },
  {
    ...
    description:
      "Get added to a family member's old account with good history.",
    impact: "medium",
    timeframe: "1-2 months",
    icon: "people",
  },
  {
    ...
    description:
      "Build credit with a secured card that reports to all bureaus.",
    impact: "medium",
  ...
  },
  {
    ...
    description: "Small loan that builds credit while you save money.",
    impact: "medium",
  ...
  },
  {
    ...
    description: "Having different types of credit can boost your score.",
    impact: "low",
    timeframe: "6-12 months",
    icon: "layers",
  },
            ...
            <Card key={strategy.id} style={styles.strategyCard}>
              <View style={styles.strategyHeader}>
                <View
                  style={[
                    styles.strategyIcon,
                    { backgroundColor: `${getImpactColor(strategy.impact)}15` },
                  ]}
                >
                  <Ionicons
