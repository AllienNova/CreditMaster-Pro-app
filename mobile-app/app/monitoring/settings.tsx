...
const ALERT_TYPES = [
  ...
  },
  {
    id: "new_account",
    name: "New Accounts",
    description: "When a new account appears",
    icon: "add-circle",
  },
  {
    id: "inquiry",
    name: "Hard Inquiries",
    description: "When someone checks your credit",
    icon: "search",
  },
  {
    id: "payment",
  ...
  },
  {
    ...
    description: "Significant balance changes",
    icon: "wallet",
  },
  {
    id: "derogatory",
    name: "Negative Items",
    description: "Collections, late payments",
    icon: "alert-circle",
  },
];
    ...
    Alert.alert(
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          text: "Pause",
          style: "destructive",
          onPress: () => toggleMonitoring(false),
        },
      ],
    );
  };
      ...
      >
        ...
        <Card style={styles.card}>
          ...
          <Text style={styles.sectionDescription}>
            Choose which credit bureaus to monitor
          </Text>
          {BUREAUS.map((bureau) => (
            <View key={bureau.id} style={styles.settingRow}>
              ...
              <Switch
                ...
                thumbColor={
                  bureauSettings[bureau.id as keyof typeof bureauSettings]
          ...
          {ALERT_TYPES.map((alert) => (
            <View key={alert.id} style={styles.settingRow}>
              ...
              <Switch
                ...
                thumbColor={
                  alertSettings[alert.id as keyof typeof alertSettings]
                    ? theme.colors.primary
                    : "#f4f3f4"
                }
              />
        ...
        <Card style={styles.card}>
          ...
          <View style={styles.settingRow}>
            ...
            <Switch
              ...
              thumbColor={
                notificationSettings.push ? theme.colors.primary : "#f4f3f4"
              }
            />
          </View>
          <View style={styles.settingRow}>
            ...
            <Switch
              ...
              thumbColor={
                notificationSettings.email ? theme.colors.primary : "#f4f3f4"
              }
            />
          </View>
          <View style={styles.settingRow}>
            ...
            <Switch
              ...
              thumbColor={
                notificationSettings.sms ? theme.colors.primary : "#f4f3f4"
              }
            />
          </View>
        </Card>
