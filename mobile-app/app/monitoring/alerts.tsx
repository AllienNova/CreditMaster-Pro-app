          ...
          {TYPE_FILTERS.map((t) => (
            <TouchableOpacity
              ...
              style={[
                ...
                typeFilter === t.key && styles.typeFilterChipActive,
              ]}
              onPress={() => {
                setTypeFilter(t.key);
            ...
            >
              <Ionicons
                ...
                size={16}
                color={
                  typeFilter === t.key ? "#fff" : theme.colors.textSecondary
                }
              />
              <Text
                style={[
                  styles.typeFilterChipText,
                  typeFilter === t.key && styles.typeFilterChipTextActive,
                ]}
              >
                {t.label}
              </Text>
