...
const REPORT_TEMPLATES: Report[] = [
  ...
  },
  {
    id: "2",
    name: "Income Summary",
    description: "All income sources and tax withholdings",
    type: "income",
    lastGenerated: "2024-12-01",
    icon: "cash",
  },
  {
    ...
    description: "Assets, liabilities, and net worth trend",
    type: "net_worth",
  ...
  },
  {
    ...
    description: "Income, deductions, and estimated taxes",
    type: "tax",
  ...
  },
  {
    id: "6",
    name: "Custom Report",
    description: "Build your own custom financial report",
    type: "custom",
    lastGenerated: "Never",
    icon: "create",
  },
...
export default function ReportsScreen() {
  const [activeTab, setActiveTab] = useState<"templates" | "saved">(
    "templates",
  );
