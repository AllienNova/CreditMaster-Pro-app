...
const RECOMMENDATIONS = [
  {
    ...
    description:
      "You're $50 over budget. Consider cutting back on non-essentials.",
    impact: "Save $50/mo",
    type: "warning",
  },
  {
    id: "2",
    title: "Great job on Food!",
    description: "You're on track to stay under budget this month.",
    impact: "Save $180",
    type: "success",
  },
  {
    ...
    description: "Transfer leftover budget to savings automatically.",
    impact: "Save $200/mo",
    type: "tip",
  },
];
...
export default function BudgetsScreen() {
  ...
  const getRecommendationIcon = (type: string) => {
    switch (type) {
      ...
      case "tip":
        return { icon: "bulb", color: "#3B82F6", bg: "#DBEAFE" };
      default:
        return {
          ...
          {RECOMMENDATIONS.map((rec) => {
            ...
            return (
              <Card key={rec.id} style={styles.recommendationCard}>
                <View
                  style={[styles.recIcon, { backgroundColor: iconStyle.bg }]}
                >
                  <Ionicons
