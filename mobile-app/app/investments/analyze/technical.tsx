...
const PRICE_DATA = [
  { value: 172.5, label: "Mon" },
  { value: 174.2, label: "Tue" },
  { value: 173.8, label: "Wed" },
  { value: 176.4, label: "Thu" },
  { value: 178.9, label: "Fri" },
  { value: 177.6, label: "Sat" },
...
const MOVING_AVERAGES: TechnicalIndicator[] = [
  ...
  },
  {
    ...
    value: 172.8,
    signal: "bullish",
    description: "Price above 50-day average",
  },
  {
    name: "SMA 200",
    value: 165.2,
  ...
  },
  {
    ...
    value: 177.5,
    signal: "bullish",
    description: "Short-term momentum positive",
  },
  {
    name: "EMA 26",
    value: 174.2,
    signal: "bullish",
    description: "Medium-term trend bullish",
  },
];
...
const OSCILLATORS: TechnicalIndicator[] = [
  {
    ...
    value: 62.5,
    signal: "neutral",
    description: "Momentum neutral, not overbought",
  },
  {
    name: "MACD",
    value: 2.34,
  ...
  },
  {
    ...
    value: -22.4,
    signal: "neutral",
    description: "Near overbought zone",
  },
  {
    name: "ADX",
    value: 28.5,
    signal: "bullish",
    description: "Strong trend in progress",
  },
];

const SUPPORT_RESISTANCE = [
  { type: "resistance", level: 185.0, strength: "strong" },
  { type: "resistance", level: 182.5, strength: "moderate" },
  { type: "current", level: 180.25, strength: "current" },
  { type: "support", level: 175.0, strength: "moderate" },
  { type: "support", level: 170.0, strength: "strong" },
];

const CHART_PATTERNS = [
  { name: "Bullish Flag", confidence: 78, timeframe: "4H", target: 188.5 },
  {
...
export default function TechnicalAnalysisScreen() {
  ...
  const bullishCount = [...MOVING_AVERAGES, ...OSCILLATORS].filter(
    (i) => i.signal === "bullish",
  ).length;
  const bearishCount = [...MOVING_AVERAGES, ...OSCILLATORS].filter(
    (i) => i.signal === "bearish",
  ).length;
  const neutralCount = [...MOVING_AVERAGES, ...OSCILLATORS].filter(
    (i) => i.signal === "neutral",
  ).length;
      ...
      >
        ...
        <Card style={styles.summaryCard}>
          ...
          <View style={styles.overallSignal}>
            ...
            <Text
              style={[styles.overallValue, { color: theme.colors.success }]}
            >
              BUY
            </Text>
          </View>
          ...
          {CHART_PATTERNS.map((pattern, idx) => (
            <View key={idx} style={styles.patternRow}>
              <View style={styles.patternInfo}>
                ...
                <Text style={styles.patternTimeframe}>
                  {pattern.timeframe} Chart
                </Text>
              </View>
              <View style={styles.patternRight}>
                ...
                <Text style={styles.patternTarget}>
