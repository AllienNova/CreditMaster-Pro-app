...
const RISK_FACTORS: RiskFactor[] = [
  {
    factor: "Market Risk",
    impact: "medium",
    description: "Tech sector volatility and market corrections",
  },
  {
    factor: "Competition",
    impact: "medium",
    description: "Increasing competition in smartphone market",
  },
  {
    factor: "Regulatory",
    impact: "high",
    description: "Antitrust investigations in multiple jurisdictions",
  },
  {
    factor: "Supply Chain",
    impact: "low",
    description: "Diversified manufacturing reducing concentration risk",
  },
  {
    factor: "Currency",
    impact: "low",
    description: "Strong dollar may impact international revenue",
  },
];
      ...
      >
        ...
        <Card
          style={[
            ...
            { borderLeftColor: getActionColor(RECOMMENDATION.action) },
          ]}
        >
          ...
          <View style={styles.optionRow}>
            {timeframes.map((tf) => (
              <TouchableOpacity
                ...
                style={[
                  styles.optionButton,
                  selectedTimeframe === tf.id && styles.optionActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.optionLabel,
                    selectedTimeframe === tf.id && styles.optionLabelActive,
                  ]}
                >
                  {tf.label}
                </Text>
                <Text
                  style={[
                    styles.optionDesc,
                    selectedTimeframe === tf.id && styles.optionDescActive,
                  ]}
                >
                  {tf.desc}
                </Text>
          ...
          <View style={styles.optionRow}>
            {riskTolerances.map((risk) => (
              <TouchableOpacity
                ...
                style={[
                  styles.riskButton,
                  selectedRisk === risk.id && styles.riskActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.riskLabel,
                    selectedRisk === risk.id && styles.riskLabelActive,
                  ]}
                >
                  {risk.label}
                </Text>
        ...
        <Card style={styles.riskCard}>
          <View style={styles.riskHeader}>
            ...
            >
              <Text
                style={[styles.riskLevelText, { color: theme.colors.warning }]}
              >
          ...
          <View style={styles.riskMetrics}>
            ...
            <View style={styles.riskMetricItem}>
              <Text
                style={[styles.riskMetricValue, { color: theme.colors.error }]}
              >
          ...
          <View style={styles.caseSection}>
            <View style={styles.caseHeader}>
              <Ionicons
                ...
                color={theme.colors.success}
              />
              <Text style={[styles.caseTitle, { color: theme.colors.success }]}>
                Bull Case
              </Text>
            </View>
          ...
          <View style={[styles.caseSection, styles.bearSection]}>
            <View style={styles.caseHeader}>
              <Ionicons
                ...
                color={theme.colors.error}
              />
              <Text style={[styles.caseTitle, { color: theme.colors.error }]}>
                Bear Case
              </Text>
            </View>
        ...
        <Card style={styles.positionCard}>
          ...
          <View style={styles.returnRow}>
            <View style={styles.returnItem}>
              <Text
                style={[styles.returnValue, { color: theme.colors.success }]}
              >
        ...
        <View style={styles.disclaimer}>
          ...
          <Text style={styles.disclaimerText}>
            AI recommendations are for informational purposes only. Not
