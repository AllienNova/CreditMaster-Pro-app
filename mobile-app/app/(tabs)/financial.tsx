...
export default function FinancialScreen() {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    netWorthCard: { marginHorizontal: spacing.lg, marginBottom: spacing.lg, alignItems: 'center', paddingVertical: spacing.xl },
    netWorthLabel: { fontSize: 14, color: colors.textSecondary, marginBottom: 4 },
    netWorthValue: { fontSize: 36, fontWeight: '700', color: colors.text, marginBottom: spacing.lg },
    netWorthBreakdown: { flexDirection: 'row', alignItems: 'center' },
    breakdownItem: { alignItems: 'center', paddingHorizontal: spacing.lg },
    breakdownLabel: { fontSize: 12, color: colors.textSecondary, marginBottom: 4 },
    breakdownValue: { fontSize: 16, fontWeight: '600' },
    breakdownDivider: { width: 1, height: 30, backgroundColor: colors.border },
    statsRow: { flexDirection: 'row', paddingHorizontal: spacing.lg, marginBottom: spacing.lg },
    statCard: { flex: 1, marginHorizontal: 4, alignItems: 'center', paddingVertical: spacing.md },
    statLabel: { fontSize: 12, color: colors.textSecondary, marginTop: 4 },
    statValue: { fontSize: 18, fontWeight: '600', color: colors.text, marginTop: 2 },
    menuSection: { paddingHorizontal: spacing.lg },
    menuItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface, borderRadius: borderRadius.lg, padding: spacing.md, marginBottom: spacing.sm },
    menuIcon: { width: 44, height: 44, borderRadius: 22, backgroundColor: withOpacity(colors.primary, 0.08), justifyContent: 'center', alignItems: 'center', marginRight: spacing.md },
    menuContent: { flex: 1 },
