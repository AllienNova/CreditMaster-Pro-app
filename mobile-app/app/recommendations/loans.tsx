...
const LOAN_OFFERS: LoanOffer[] = [
  ...
  },
  {
    ...
    maxAmount: 100000,
    aprRange: "7.49% - 25.49%",
    termRange: "24-144 months",
    monthlyPayment: 298,
    approvalOdds: 75,
    features: ["Rate beat program", "Same-day funding", "No fees"],
    prequalified: true,
  },
  {
    id: "3",
    ...
    monthlyPayment: 345,
    approvalOdds: 88,
    features: ["AI-powered approval", "Fast funding", "Considers education"],
    prequalified: true,
  },
  {
    id: "4",
    ...
    maxAmount: 40000,
    aprRange: "6.99% - 24.99%",
    termRange: "36-72 months",
    monthlyPayment: 285,
    approvalOdds: 70,
    features: ["No fees", "On-time payment reward", "Flexible payments"],
    prequalified: false,
  },
  {
    id: "5",
    ...
    maxAmount: 35000,
    aprRange: "7.99% - 24.99%",
    termRange: "36-84 months",
    monthlyPayment: 275,
    approvalOdds: 78,
    features: ["Cash back reward", "No origination fee", "Flexible terms"],
    prequalified: true,
  },
];
...
export default function LoansScreen() {
  ...
  const filteredOffers =
    selectedType === "all"
      ? LOAN_OFFERS
      : LOAN_OFFERS.filter((o) => o.type === selectedType);
  const sortedOffers = [...filteredOffers].sort(
    (a, b) => b.approvalOdds - a.approvalOdds,
  );
      ...
      >
        ...
        <Card style={styles.summaryCard}>
          ...
          <Text style={styles.summaryText}>
            Based on your credit profile, you're pre-qualified for{" "}
            {LOAN_OFFERS.filter((o) => o.prequalified).length} loan offers with
            ...
            <View style={styles.calcResults}>
              <View style={styles.calcResult}>
                ...
                <Text style={styles.calcResultValue}>
                  ${Math.round(parseInt(loanAmount || "0") / 36)}
                </Text>
              </View>
              <View style={styles.calcResult}>
                <Text style={styles.calcResultLabel}>Total Interest</Text>
                <Text style={styles.calcResultValue}>
                  ${Math.round(parseInt(loanAmount || "0") * 0.15)}
                </Text>
              </View>
            </View>
          </Card>
        ...
        {sortedOffers.map((offer) => (
          <Card
            ...
            style={[
              styles.offerCard,
              offer.prequalified && styles.offerCardPrequalified,
            ]}
          >
            {offer.prequalified && (
              <View style={styles.prequalBadge}>
                <Text style={styles.prequalText}>PRE-QUALIFIED</Text>
              </View>
            )}
            <View style={styles.offerHeader}>
              ...
              <View
                style={[
                  ...
                  {
                    backgroundColor: `${getApprovalColor(offer.approvalOdds)}15`,
                  },
                ]}
              >
                <Text
                  style={[
                    styles.approvalText,
                    { color: getApprovalColor(offer.approvalOdds) },
                  ]}
                >
                  {offer.approvalOdds}%
                </Text>
            ...
            <View style={styles.offerDetails}>
              ...
              <View style={styles.detailItem}>
                ...
                <Text style={styles.detailValue}>
                  {offer.aprRange.split(" - ")[0]}
                </Text>
              </View>
              <View style={styles.detailItem}>
                <Text style={styles.detailLabel}>Terms</Text>
                <Text style={styles.detailValue}>{offer.termRange}</Text>
              </View>
            </View>
