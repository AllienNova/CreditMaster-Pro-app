      ...
      <View style={[styles.card, { backgroundColor: colors.card }]}>
        ...
        {goal.milestones.map((milestone, idx) => (
          <View key={milestone.id} style={styles.milestoneItem}>
            ...
            >
              <Ionicons
                name={milestone.isAchieved ? "checkmark" : "flag"}
                size={16}
                color={milestone.isAchieved ? "#fff" : colors.textSecondary}
              />
            </View>
            ...
            {milestone.isAchieved && milestone.achievedDate && (
              <Text style={[styles.achievedDate, { color: "#22c55e" }]}>
      ...
      <View style={[styles.card, { backgroundColor: colors.card }]}>
        ...
        >
          ...
          <Text
            style={[
              styles.cardTitle,
              { color: colors.text, marginLeft: 8, flex: 1 },
            ]}
          >
            Goal Simulator
          </Text>
        ...
        {showSimulator && (
          <View style={styles.simulatorContent}>
            ...
            {goalSimulation &&
              goalSimulation.scenarios.map((scenario) => (
                <View
                  key={scenario.id}
                  style={[
                    styles.scenarioCard,
                    scenario.id === goalSimulation.recommendedScenario && {
                ...
                >
                  ...
                  <Text
                    style={[
                      styles.scenarioDetail,
                      { color: colors.textSecondary },
                    ]}
                  >
                    ${scenario.monthlyContribution}/mo → Complete by{" "}
                    {new Date(
                      scenario.projectedCompletionDate,
                    ).toLocaleDateString()}
                  </Text>
                  <Text
                    style={[
                      ...
                      {
                        color:
                          scenario.probabilityOfSuccess >= 80
                            ? "#22c55e"
                            : "#eab308",
                      },
                    ]}
