...
export default function CoachDashboardScreen() {
  ...
  const { dashboard, dashboardLoading, dashboardError, fetchDashboard } = useCoachStore();
  ...
  if (dashboardLoading && !dashboard) {
    return (
      <View style={[styles.loadingContainer, { backgroundColor: colors.background }]}>
        ...
        <Text style={[styles.loadingText, { color: colors.textSecondary }]}>Loading your coach...</Text>
      </View>
    );
  }
  ...
  return (
    <ScrollView
      ...
      refreshControl={<RefreshControl refreshing={dashboardLoading} onRefresh={fetchDashboard} />}
    >
      {/* Coach Message */}
      <View style={[styles.coachCard, { backgroundColor: colors.primary }]}>
        ...
        <Text style={styles.coachMessage}>{dashboard?.coachMessage || 'Loading your personalized advice...'}</Text>
      </View>
      ...
      <View style={[styles.card, { backgroundColor: colors.card }]}>
        ...
        <View style={styles.healthScoreContainer}>
          <View style={[styles.healthScoreCircle, { borderColor: getHealthColor(dashboard?.healthScore || 0) }]}>
            <Text style={[styles.healthScore, { color: getHealthColor(dashboard?.healthScore || 0) }]}>
          ...
          <View style={styles.healthDetails}>
            ...
            <Text style={[styles.budgetHealth, { color: colors.textSecondary }]}>
      ...
      <View style={styles.quickActions}>
        ...
        >
          ...
          <Text style={[styles.actionText, { color: colors.text }]}>Recommendations</Text>
          {dashboard?.pendingActionsCount ? (
            <View style={styles.badge}>
              <Text style={styles.badgeText}>{dashboard.pendingActionsCount}</Text>
            </View>
          ) : null}
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={[styles.actionSubtext, { color: colors.textSecondary }]}>
            {dashboard?.goalsOnTrack || 0}/{dashboard?.activeGoals || 0} on track
          </Text>
        </TouchableOpacity>
        ...
        <View style={[styles.card, { backgroundColor: colors.card }]}>
          ...
          <View style={styles.milestoneContent}>
            ...
            <View style={styles.milestoneDetails}>
              <Text style={[styles.milestoneName, { color: colors.text }]}>{dashboard.nextMilestone.name}</Text>
              <Text style={[styles.milestoneGoal, { color: colors.textSecondary }]}>
                {dashboard.nextMilestone.goalName} - ${dashboard.nextMilestone.targetAmount.toFixed(0)}
              </Text>
            </View>
          </View>
        </View>
      ...
      {dashboard?.topRecommendations && dashboard.topRecommendations.length > 0 && (
        <View style={[styles.card, { backgroundColor: colors.card }]}>
          <View style={styles.cardHeader}>
            <Text style={[styles.cardTitle, { color: colors.text }]}>Top Recommendations</Text>
...
const styles = StyleSheet.create({
  ...
  healthScoreCircle: { width: 80, height: 80, borderRadius: 40, borderWidth: 4, justifyContent: 'center', alignItems: 'center' },
  ...
  actionButton: { width: '48%', borderRadius: 12, padding: 16, marginBottom: 12, alignItems: 'center' },
  ...
  recItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderTopWidth: 1, borderTopColor: 'rgba(0,0,0,0.1)' },
