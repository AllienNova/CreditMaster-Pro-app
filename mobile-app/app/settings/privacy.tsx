      ...
      >
        ...
        <Card style={styles.card}>
          <View style={styles.settingRow}>
            <View
              style={[styles.settingIcon, { backgroundColor: "#22C55E15" }]}
            >
          ...
          >
            <View
              style={[styles.settingIcon, { backgroundColor: "#8B5CF615" }]}
            >
            ...
            {["5", "15", "30", "60"].map((mins) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  sessionTimeout === mins && styles.timeoutOptionActive,
                ]}
                onPress={() => setSessionTimeout(mins)}
              >
                <Text
                  style={[
                    styles.timeoutText,
                    sessionTimeout === mins && styles.timeoutTextActive,
                  ]}
                >
                  {mins} min
                </Text>
        ...
        <Card style={styles.card}>
          <View style={styles.settingRow}>
            <View style={styles.settingInfo}>
              ...
              <Text style={styles.settingDescription}>
                Allow sharing anonymized data for better offers
              </Text>
            </View>
            <Switch
              value={dataSharing}
