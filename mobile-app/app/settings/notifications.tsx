...
export default function NotificationSettingsScreen() {
  const [groups, setGroups] = useState<NotificationGroup[]>([
    {
      ...
      settings: [
        ...
        },
        {
          ...
          description: "Notify when someone checks your credit",
          enabled: true,
        },
        {
          id: "derogatory",
          title: "Negative Items",
          description: "Alert for new negative items on your report",
          enabled: true,
        },
      ],
    },
    {
      ...
      settings: [
        ...
        },
        {
          ...
          description: "Notify when disputes are resolved",
          enabled: true,
        },
        {
          id: "dispute_reminder",
          title: "Follow-up Reminders",
          description: "Reminders to follow up on disputes",
          enabled: false,
        },
      ],
    },
    {
      ...
      settings: [
        ...
        },
        {
          ...
          description: "Notify for transactions over $500",
          enabled: false,
        },
        {
          id: "budget_exceeded",
          title: "Budget Alerts",
          description: "Alert when you exceed budget limits",
          enabled: true,
        },
      ],
    },
      ...
      settings: [
        {
          id: "tips",
          title: "Credit Tips",
          description: "Weekly tips to improve your credit",
          enabled: true,
        },
        {
          id: "offers",
          title: "Personalized Offers",
          description: "Credit card and loan recommendations",
          enabled: false,
        },
        {
          id: "newsletter",
          title: "Newsletter",
          description: "Monthly newsletter with insights",
          enabled: false,
        },
      ],
    },
  ...
  const toggleSetting = (groupIndex: number, settingId: string) => {
    ...
    const setting = newGroups[groupIndex].settings.find(
      (s) => s.id === settingId,
    );
    if (setting) {
                ...
                <View key={setting.id}>
                  <View style={styles.settingRow}>
                    ...
                    <Switch
                      ...
                      onValueChange={() =>
                        toggleSetting(groupIndex, setting.id)
                      }
                      trackColor={{
                        false: theme.colors.border,
                        true: theme.colors.primary,
