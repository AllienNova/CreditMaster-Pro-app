...
const FEATURES: FeatureFlag[] = [
  {
    id: "ff-001",
    name: "ai_dispute_v2",
    description: "New AI dispute generation engine",
    enabled: true,
    rollout: 100,
    type: "release",
  },
  ...
  {
    id: "ff-003",
    name: "instant_reports",
    description: "Instant credit report generation",
    enabled: false,
    rollout: 0,
    type: "release",
  },
  ...
  },
  {
    ...
    description: "Batch dispute processing",
    enabled: true,
    rollout: 100,
    type: "ops",
  },
      ...
      >
        ...
        <View style={styles.statsRow}>
          ...
          >
            <Text style={[styles.statValue, { color: theme.colors.warning }]}>
              {features.filter((f) => f.type === "experiment").length}
            </Text>
              ...
              <View style={styles.featureHeader}>
                <View style={styles.featureInfo}>
                  ...
                  <View
                    style={[
                      styles.typeBadge,
                      { backgroundColor: `${getTypeColor(feature.type)}15` },
                    ]}
                  >
                    <Text
                      style={[
                ...
                <Switch
                  ...
                  thumbColor={
                    feature.enabled ? theme.colors.primary : "#f4f3f4"
                  }
                />
              </View>
        ...
        <Card style={styles.tipsCard}>
          ...
          <Text style={styles.tipText}>
            • <Text style={{ color: theme.colors.success }}>Release</Text>:
            Gradual feature rollouts
          </Text>
          <Text style={styles.tipText}>
            • <Text style={{ color: theme.colors.warning }}>Experiment</Text>:
            A/B testing features
          </Text>
          <Text style={styles.tipText}>
            • <Text style={{ color: theme.colors.primary }}>Ops</Text>:
            Operational toggles
          </Text>
        </Card>
      </ScrollView>
