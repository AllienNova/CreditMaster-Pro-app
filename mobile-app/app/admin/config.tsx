...
const CONFIG_ITEMS: ConfigItem[] = [
  ...
  {
    key: "2fa_required",
    label: "2FA Required for Admin",
    value: true,
    type: "boolean",
    category: "Security",
  },
  {
    key: "dispute_auto_process",
    label: "Auto-process Disputes",
    value: false,
    type: "boolean",
    category: "Features",
  },
  ...
  {
    key: "max_disputes_per_day",
    label: "Max Disputes/Day",
    value: 10,
    type: "number",
    category: "Limits",
  },
...
export default function AdminConfigScreen() {
  ...
  const toggleBoolConfig = (key: string) => {
    setConfigs(
      configs.map((c) => (c.key === key ? { ...c, value: !c.value } : c)),
    );
  };
      ...
      >
              ...
              {configs
                ...
                .map((config, i, arr) => (
                  <View
                    ...
                    style={[
                      styles.configItem,
                      i < arr.length - 1 && styles.configItemBorder,
                    ]}
                  >
                    ...
                    {config.type === "boolean" && (
                      <Switch
                        ...
                        thumbColor={
                          config.value ? theme.colors.primary : "#f4f3f4"
                        }
                      />
                    )}
                    {config.type === "number" && (
        ...
        <Card style={styles.warningCard}>
          ...
          <Text style={styles.warningText}>
            Changes to system configuration may affect all users. Please test in
