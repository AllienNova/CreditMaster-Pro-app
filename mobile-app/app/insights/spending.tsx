  ...
  patterns: [
    {
      ...
      description: 'Your dining out spending increased 45% compared to your 3-month average.',
      impact: '+$140/month',
      severity: 'high',
    },
    {
      ...
      description: 'Your subscription costs have grown 8% over the past 6 months.',
      impact: '+$11/month',
      severity: 'medium',
    },
    {
      ...
      >
        ...
        <View style={styles.overviewGrid}>
          <Card style={styles.overviewCard}>
            ...
            <Text style={styles.overviewValue}>{formatCurrency(analysis.totalSpending)}</Text>
            <View style={styles.overviewTrend}>
              <Ionicons
                name={analysis.comparedToLastPeriod >= 0 ? 'trending-up' : 'trending-down'}
                size={14}
                color={analysis.comparedToLastPeriod >= 0 ? '#EF4444' : '#22C55E'}
              />
              <Text
                style={[
          ...
          <Card style={styles.overviewCard}>
            ...
            <Text style={styles.overviewValue}>{analysis.transactionCount}</Text>
          ...
          <Card style={styles.overviewCard}>
            ...
            <Text style={styles.overviewValue}>{formatCurrency(analysis.dailyAverage)}</Text>
            <Text style={styles.overviewSubtext}>
          ...
          <Card style={styles.overviewCard}>
            ...
            <Text style={[styles.overviewValue, { color: getRiskColor(analysis.overallRiskScore) }]}>
        ...
        <Card style={styles.categoryCard}>
          {analysis.categories.map((cat) => {
            ...
            const budgetPercent = cat.budget ? (cat.amount / cat.budget) * 100 : 0;
              ...
              >
                ...
                <View style={styles.categoryContent}>
                  ...
                  <View style={styles.progressContainer}>
                    ...
                    <Text style={styles.percentText}>{cat.percentOfTotal.toFixed(0)}%</Text>
                  </View>
                  {isExpanded && cat.budget && (
                    <View style={styles.expandedContent}>
                      <View style={styles.budgetRow}>
                        <Text style={styles.budgetLabel}>Budget:</Text>
                        <Text style={styles.budgetValue}>{formatCurrency(cat.budget)}</Text>
                      </View>
            ...
            <Card key={pattern.id} style={styles.patternCard}>
              <View style={styles.patternHeader}>
                ...
                <View style={styles.patternContent}>
                  ...
                  <Text style={[styles.patternImpact, { color: getPatternColor(pattern.type) }]}>
                    {pattern.impact}
                  </Text>
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  periodText: { fontSize: 14, color: theme.colors.textSecondary, fontWeight: '500' },
  ...
  overviewValue: { fontSize: 22, fontWeight: '700', color: theme.colors.text, marginTop: 4 },
  overviewTrend: { flexDirection: 'row', alignItems: 'center', marginTop: 4 },
  overviewTrendText: { fontSize: 13, fontWeight: '500', marginLeft: 2 },
  overviewSubtext: { fontSize: 11, color: theme.colors.textSecondary, marginTop: 4 },
  sectionTitle: {
    fontSize: 18,
    fontWeight: '600',
  ...
  categoryAmount: { fontSize: 14, fontWeight: '600', color: theme.colors.text, marginRight: 8 },
  trendBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 6,
  ...
  percentText: { fontSize: 12, color: theme.colors.textSecondary, marginLeft: 8, width: 32 },
  expandedContent: {
    marginTop: 12,
    paddingTop: 12,
    borderTopWidth: 1,
  ...
  patternTitle: { fontSize: 15, fontWeight: '600', color: theme.colors.text, flex: 1 },
  ...
  patternDescription: { fontSize: 13, color: theme.colors.textSecondary, lineHeight: 19 },
  patternImpact: { fontSize: 13, fontWeight: '600', marginTop: 6 },
  recommendationsCard: { marginBottom: theme.spacing.lg, padding: theme.spacing.md },
  recommendationRow: {
    flexDirection: 'row',
    alignItems: 'flex-start',
    marginBottom: 12,
  ...
  primaryButtonText: { fontSize: 16, fontWeight: '600', color: '#fff', marginLeft: 8 },
});
