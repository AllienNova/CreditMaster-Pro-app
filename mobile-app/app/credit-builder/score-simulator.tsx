...
const SIMULATION_ACTIONS: SimulationAction[] = [
  // Positive actions
  {
    ...
    description: "Reduce utilization by 50%",
    impact: { min: 20, max: 40 },
    icon: "trending-down",
    selected: false,
  },
  {
    id: "pay_ontime_6mo",
    category: "positive",
    title: "6 months on-time payments",
  ...
  },
  {
    ...
    category: "positive",
    title: "Remove collection account",
    description: "Pay-for-delete or dispute",
    impact: { min: 30, max: 70 },
    icon: "trash",
    selected: false,
  },
  {
    ...
    description: "On account with good history",
    impact: { min: 10, max: 30 },
    icon: "person-add",
    selected: false,
  },
  {
  ...
  },
  {
    ...
    description: "Maintain credit history length",
    impact: { min: 5, max: 10 },
    icon: "time",
    selected: false,
  },
  // Negative actions
  {
    id: "missed_payment",
    category: "negative",
    title: "Missed payment (30 days)",
    description: "Single late payment",
    impact: { min: -60, max: -100 },
    icon: "alert-circle",
    selected: false,
  },
  {
    id: "max_cards",
    category: "negative",
    title: "Max out credit cards",
    description: "90%+ utilization",
    impact: { min: -30, max: -50 },
    icon: "card",
    selected: false,
  },
  {
    ...
    description: "Applying for new credit",
    impact: { min: -5, max: -10 },
    icon: "search",
    selected: false,
  },
  {
    id: "close_oldest",
    category: "negative",
    title: "Close oldest account",
    description: "Reduces credit age",
    impact: { min: -10, max: -25 },
    icon: "close-circle",
    selected: false,
  },
  {
    ...
    description: "Unpaid debt sent to collections",
    impact: { min: -50, max: -110 },
    icon: "warning",
    selected: false,
  },
];
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      >
          ...
          <View style={styles.scoreComparison}>
            ...
            <View style={styles.arrowContainer}>
              <Ionicons
                ...
                size={32}
                color={
                  totalImpact >= 0 ? theme.colors.success : theme.colors.error
                }
              />
              <Text
                style={[
        ...
        <View style={styles.actionSection}>
          ...
          <Text style={styles.sectionHint}>
            See potential damage from these actions
          </Text>
          ...
          {negativeActions.map((action) => (
            ...
            >
              <Card
                style={[
                  styles.actionCard,
                  action.selected && styles.actionCardSelectedNegative,
                ]}
              >
                <View style={styles.actionRow}>
                  <View
                    style={[
                      styles.checkbox,
                      action.selected && styles.checkboxSelectedNegative,
                    ]}
                  >
                    {action.selected && (
                      <Ionicons name="checkmark" size={16} color="#fff" />
        ...
        <Card style={styles.disclaimerCard}>
          <View style={styles.disclaimerRow}>
            ...
            <Text style={styles.disclaimerText}>
              Simulations are estimates based on typical credit scoring
              patterns. Actual results may vary based on your complete credit
              profile.
            </Text>
          </View>
        </Card>
