...
const TOOL_CATEGORIES = [
  {
    ...
    tools: [
      ...
      },
      {
        ...
        subtitle: "Optimize your utilization ratio",
      ...
      },
      {
        ...
        subtitle: "Track and improve payments",
      ...
      },
      {
        ...
        icon: "time",
        title: "Credit Age",
        subtitle: "Manage account age",
        route: "/credit-builder/age",
        color: "#8B5CF6",
        priority: "medium",
      },
      {
        ...
        icon: "layers",
        title: "Credit Mix",
        subtitle: "Diversify credit types",
        route: "/credit-builder/mix",
        color: "#EC4899",
        priority: "medium",
      },
    ],
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        subtitle: "Build credit while saving",
        route: "/credit-builder/loan",
        color: "#F97316",
        priority: "medium",
      },
    ],
    ...
    tools: [
      {
        ...
        route: "/credit-builder/debt-strategy",
        color: "#EF4444",
        priority: "high",
      },
      {
      ...
      },
      {
        ...
        icon: "git-merge",
        title: "Consolidation",
        subtitle: "Combine debts into one",
        route: "/credit-builder/consolidation",
        color: "#14B8A6",
        priority: "low",
      },
    ],
    ...
    tools: [
      {
        ...
        subtitle: "Request late payment removal",
        route: "/credit-builder/goodwill",
        color: "#A855F7",
        priority: "medium",
      },
      {
        ...
        subtitle: "Negotiate collection removal",
        route: "/credit-builder/pay-for-delete",
        color: "#F43F5E",
        priority: "medium",
      },
      {
    ...
    factors.forEach((factor) => {
      if (factor.status === "poor" || factor.status === "fair") {
        const category = TOOL_CATEGORIES.find((c) =>
          c.tools.some((t) => t.id === factor.id.replace("_", "-")),
        );
        if (category) {
          const tool = category.tools.find(
            (t) => t.id === factor.id.replace("_", "-"),
          );
        ...
        {recommendedTools.length > 0 && (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>
              <Ionicons name="star" size={16} color="#F59E0B" /> Recommended for
              You
            </Text>
            ...
            <View style={styles.toolsGrid}>
              {category.tools.map((tool) => (
                ...
                >
                  ...
                  <Text style={styles.toolTitleSmall} numberOfLines={1}>
                    {tool.title}
                  </Text>
                </TouchableOpacity>
              ))}
