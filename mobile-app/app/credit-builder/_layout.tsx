  ...
  return (
    <Stack screenOptions={headerOptions}>
      ...
      <Stack.Screen
        ...
        options={{ title: "Score Simulator Pro" }}
      />
      <Stack.Screen
        name="utilization"
        options={{ title: "Credit Utilization" }}
      />
      ...
      <Stack.Screen
        name="pay-for-delete"
        options={{ title: "Pay for Delete" }}
      />
      <Stack.Screen name="freeze" options={{ title: "Credit Freeze" }} />
      <Stack.Screen
        name="identity-theft"
        options={{ title: "Identity Protection" }}
      />
