...
const CREDIT_TYPES: CreditType[] = [
  ...
  },
  {
    ...
    count: 1,
    hasType: true,
    description: "Installment loan for vehicle",
    color: "#22C55E",
  },
  {
    id: "mortgage",
  ...
  },
  {
    ...
    count: 0,
    hasType: false,
    description: "Unsecured installment loan",
    color: "#EC4899",
  },
  {
    id: "retail_card",
    ...
    count: 1,
    hasType: true,
    description: "Store credit cards",
    color: "#06B6D4",
  },
];
      ...
      >
        ...
        <Card style={styles.mixCard}>
          <View style={styles.mixCircle}>
            <Text style={[styles.mixPercent, { color: getMixColor(mixScore) }]}>
              {typesHave}/{totalTypes}
            </Text>
          ...
          <View style={styles.mixBar}>
            <View
              style={[
                ...
                {
                  width: `${mixScore}%`,
                  backgroundColor: getMixColor(mixScore),
                },
              ]}
            />
          </View>
          <Text style={styles.mixHint}>
            You have {typesHave} of {totalTypes} credit types
          </Text>
        </Card>
        ...
        <Card style={styles.impactCard}>
          ...
          <Text style={styles.impactText}>
            Credit mix accounts for 10% of your score. Having diverse credit
            types shows lenders you can manage different accounts.
          </Text>
        </Card>
        ...
        {CREDIT_TYPES.map((creditType) => (
          <Card
            key={creditType.id}
            style={[styles.typeCard, !creditType.hasType && styles.missingCard]}
          >
            <View style={styles.typeRow}>
              <View
                style={[
                  styles.typeIcon,
                  { backgroundColor: `${creditType.color}20` },
                ]}
              >
                <Ionicons
                  name={creditType.icon as keyof typeof Ionicons.glyphMap}
                  size={24}
                ...
                {creditType.hasType ? (
                  <>
                    <View style={styles.countBadge}>
                      <Text style={styles.countText}>{creditType.count}</Text>
                    </View>
                    <Ionicons
        ...
        {CREDIT_TYPES.filter((t) => !t.hasType).length > 0 && (
          <Card style={styles.recommendCard}>
            ...
            <Text style={styles.recommendText}>
              Consider adding these credit types to improve your mix:
            </Text>
        ...
        <Card style={styles.tipsCard}>
          ...
          <View style={styles.tipItem}>
            <Ionicons name="checkmark-circle" size={18} color="#22C55E" />
            <Text style={styles.tipText}>
              Credit builder loans can add installment credit
            </Text>
          </View>
          <View style={styles.tipItem}>
            <Ionicons name="checkmark-circle" size={18} color="#22C55E" />
            <Text style={styles.tipText}>
              Secured cards are good for building credit
            </Text>
          </View>
        </Card>
