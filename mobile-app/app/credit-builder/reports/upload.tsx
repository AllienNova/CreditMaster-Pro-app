...
export default function ReportUploadScreen() {
  ...
  const handleDocumentPick = async () => {
    if (!selectedBureau) {
      Alert.alert(
        "Select Bureau",
        "Please select which bureau this report is from.",
      );
      return;
    }
  ...
  const handleCameraCapture = async () => {
    ...
    if (status !== "granted") {
      Alert.alert(
        "Permission Required",
        "Camera access is needed to capture report pages.",
      );
      return;
    }
  ...
  const simulateUpload = (filename: string, size: number) => {
    ...
    setTimeout(() => {
      setUploadedReports((prev) =>
        prev.map((r) =>
          r.id === newReport.id ? { ...r, status: "processing" } : r,
        ),
      );
    }, 1500);
    ...
    setTimeout(() => {
      setUploadedReports((prev) =>
        prev.map((r) =>
          r.id === newReport.id ? { ...r, status: "analyzed" } : r,
        ),
      );
  ...
  const getStatusInfo = (status: UploadedReport["status"]) => {
    switch (status) {
      ...
      case "processing":
        return { icon: "hourglass", color: "#F59E0B", text: "Analyzing..." };
      case "analyzed":
        return {
      ...
      >
          ...
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoContent}>
              ...
              <Text style={styles.infoSubtitle}>
                We'll analyze it for errors and opportunities
              </Text>
            </View>
          </View>
        </Card>
        ...
        <View style={styles.uploadOptions}>
          <TouchableOpacity
            style={[
              styles.uploadOption,
              !selectedBureau && styles.uploadOptionDisabled,
            ]}
          ...
          >
            ...
            <Text
              style={[
                ...
                !selectedBureau && styles.textDisabled,
              ]}
            >
              Choose File
            </Text>
        ...
        <Card style={styles.tipsCard}>
          ...
          <View style={styles.tipItem}>
            ...
            <Text style={styles.tipText}>
              Use the full report, not a summary
            </Text>
          </View>
          <View style={styles.tipItem}>
            <Ionicons
          ...
          <View style={styles.tipItem}>
            ...
            />
            <Text style={styles.tipText}>
              Reports should be less than 30 days old
            </Text>
          </View>
        </Card>
