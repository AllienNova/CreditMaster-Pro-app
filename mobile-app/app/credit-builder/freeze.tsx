...
const BUREAUS: Bureau[] = [
  {
    ...
    name: "Experian",
    logo: "🔵",
    freezeUrl: "https://www.experian.com/freeze",
...
const BENEFITS = [
  {
    ...
    title: "Prevents New Accounts",
    description: "Stops identity thieves from opening credit in your name",
  },
  {
    icon: "cash",
    title: "Free by Law",
    description: "Credit freezes are free at all three bureaus",
  },
  {
    icon: "lock-closed",
    title: "You Control Access",
    description: "Temporarily lift when you need to apply for credit",
  },
  {
    icon: "time",
    title: "Stays Until You Remove",
    description: "Freeze remains in place until you lift it",
  },
];
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      >
        ...
        <Card
          style={[
            styles.statusCard,
            allFrozen ? styles.statusCardFrozen : styles.statusCardUnfrozen,
          ]}
        >
          <View style={styles.statusIcon}>
            <Ionicons
              name={allFrozen ? "snow" : "warning"}
              size={40}
              color={allFrozen ? "#3B82F6" : "#F59E0B"}
            />
          </View>
          <Text style={styles.statusTitle}>
            {allFrozen ? "Fully Protected" : "Partially Protected"}
          </Text>
          <Text style={styles.statusText}>
            {frozenCount} of 3 bureaus frozen
          </Text>
          {!allFrozen && (
            <Text style={styles.statusWarning}>
              Freeze all bureaus for maximum protection
            </Text>
          )}
        </Card>
          ...
          <Card key={bureau.id} style={styles.bureauCard}>
            <View style={styles.bureauRow}>
              ...
              <View style={styles.bureauInfo}>
                ...
                <Text style={styles.bureauStatus}>
                  {bureauStatus[bureau.id] ? "🔒 Frozen" : "🔓 Unfrozen"}
                </Text>
              </View>
              <Switch
                value={bureauStatus[bureau.id]}
                onValueChange={() => toggleFreeze(bureau.id)}
            ...
            <View style={styles.bureauActions}>
              <TouchableOpacity
                ...
                onPress={() => openBureauSite(bureau.freezeUrl)}
              >
                <Ionicons
                  name="open-outline"
                  size={16}
        ...
        <Card style={styles.faqCard}>
          ...
          <View style={styles.faqItem}>
            ...
            <Text style={styles.faqAnswer}>
              No, freezing your credit has no impact on your score.
            </Text>
          </View>
          <View style={styles.faqItem}>
            <Text style={styles.faqQuestion}>
              Can I still use my existing cards?
            </Text>
            <Text style={styles.faqAnswer}>
              Yes, a freeze only prevents new accounts from being opened.
            </Text>
          </View>
          <View style={styles.faqItem}>
            <Text style={styles.faqQuestion}>
              How do I apply for credit with a freeze?
            </Text>
            <Text style={styles.faqAnswer}>
              Temporarily lift the freeze at the relevant bureau before
              applying.
            </Text>
          </View>
        </Card>
