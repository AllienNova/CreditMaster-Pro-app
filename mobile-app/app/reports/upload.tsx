...
export default function UploadReportScreen() {
  ...
  const handleUpload = async () => {
    ...
    Alert.alert(
      "Success",
      "Your credit report has been uploaded and is being analyzed!",
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <Text style={styles.sectionDescription}>
          Which bureau is this report from?
        </Text>
        ...
        <View style={styles.bureauGrid}>
          {BUREAUS.map((bureau) => (
            ...
            >
              ...
              {selectedBureau === bureau.id && (
                <View
                  style={[styles.checkBadge, { backgroundColor: bureau.color }]}
                >
        ...
        <Text style={styles.sectionDescription}>
          Upload your credit report PDF or image
        </Text>
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          style={[
            styles.uploadButton,
            (!selectedBureau || !selectedFile || isUploading) &&
