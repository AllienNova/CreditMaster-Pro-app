        ...
        <View style={styles.summaryGridItem}>
          ...
          <Text
            style={[
              ...
              {
                color:
                  totalPL / Math.max(totalTrades, 1) >= 0
                    ? "#10B981"
                    : "#EF4444",
              },
            ]}
        ...
        <View style={styles.tradeSymbolContainer}>
          ...
          <View
            style={[
              ...
              {
                backgroundColor:
                  trade.direction === "long" ? "#10B98120" : "#EF444420",
              },
            ]}
          >
            <Text
...
export default function TradeHistoryScreen() {
  ...
  const { tradeHistory, isLoading, isRefreshing, fetchTradeHistory } =
    useTradingStore();
