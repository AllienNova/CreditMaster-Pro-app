...
export default function DisputesScreen() {
  ...
  const filteredDisputes =
    selectedFilter === "all"
      ? DISPUTES
      : DISPUTES.filter((d) => d.status === selectedFilter);
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      >
        ...
        <View style={styles.quickActions}>
          ...
          <TouchableOpacity
            style={styles.quickAction}
            onPress={() => router.push("/disputes/analytics")}
          >
            <View
              ...
              <View style={styles.timeline}>
                  ...
                  dispute.status !== "rejected" && (
                    <View style={styles.timelineItem}>
                      ...
                      <Text
                        style={[
                          styles.timelineText,
                          dispute.daysRemaining <= 7 && { color: "#F59E0B" },
                        ]}
                      >
                ...
                {dispute.result && (
                  <View
                    style={[
                      styles.resultBadge,
                      { backgroundColor: getResultBadge(dispute.result)?.bg },
                    ]}
                  >
                    <Text
                      style={[
                        styles.resultText,
                        { color: getResultBadge(dispute.result)?.text },
                      ]}
                    >
