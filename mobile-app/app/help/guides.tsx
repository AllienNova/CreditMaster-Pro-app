...
const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    description:
      "Step-by-step guide to disputing inaccurate items on your credit report",
    category: "Disputes",
    readTime: "8 min",
    icon: "document-text",
  },
  {
    ...
    description:
      "Strategies for establishing credit when you have no credit history",
  ...
  {
    id: "4",
    title: "Lowering Credit Utilization",
    description:
      "Tips to reduce your credit utilization ratio and boost your score",
    category: "Credit Building",
    readTime: "4 min",
    icon: "pie-chart",
  },
  {
    ...
    description: "Best practices for keeping your personal information safe",
    category: "Security",
    readTime: "7 min",
  ...
  },
  {
    ...
    description: "How to understand and interpret your credit report",
    category: "Credit Basics",
    readTime: "10 min",
    icon: "reader",
  },
  {
    ...
    description:
      "Options for handling collection accounts on your credit report",
    category: "Disputes",
    readTime: "6 min",
    icon: "alert-circle",
  },
  {
    ...
    description: "How to use credit cards responsibly to build credit",
    category: "Credit Building",
    readTime: "5 min",
    icon: "card",
  },
