...
export default function StrategiesScreen() {
  ...
  // Store actions
  const generateStrategies = useStudentLoanStore((state) => state.generateStrategies);
  const selectStrategyAction = useStudentLoanStore((state) => state.selectStrategy);
  const clearError = useStudentLoanStore((state) => state.clearError);

  // Local state
  const [showInputForm, setShowInputForm] = useState(!savedSituation && strategies.length === 0);
          ...
          {showInputForm ? (
            <View style={styles.formCard}>
              ...
              <View style={styles.formField}>
                ...
                >
                  <Text style={styles.selectorText}>
                    {filingStatusOptions.find((o) => o.value === financialData.filingStatus)?.label ||
                      'Select'}
                  </Text>
              ...
              <View style={styles.formField}>
                ...
                >
                  <Text style={styles.selectorText}>
                    {employmentOptions.find((o) => o.value === financialData.employmentType)
                      ?.label || 'Select'}
                  </Text>
                  <Ionicons name="chevron-down" size={20} color={theme.colors.textSecondary} />
                </TouchableOpacity>
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    ...
                    <Text style={styles.generateButtonText}>Generate AI Strategies</Text>
                  </>
                )}
              </TouchableOpacity>
            </View>
            ...
            <>
              ...
              >
                ...
                <Text style={styles.updateButtonText}>Update Financial Info</Text>
              </TouchableOpacity>
                ...
                >
                  ...
                  <View style={styles.strategyHeader}>
                    ...
                    <View style={styles.strategyInfo}>
                      ...
                      <Text style={styles.strategyType}>{strategy.type.toUpperCase()}</Text>
                    </View>
                  ...
                  <View style={styles.strategyStats}>
                    ...
                    <View style={styles.strategyStat}>
                      ...
                      <Text style={styles.statValue}>
                        {Math.floor(strategy.payoffMonths / 12)}y {strategy.payoffMonths % 12}m
                      </Text>
                    </View>
                  </View>
                  ...
                  {strategy.forgiveness && strategy.forgiveness > 0 && (
                    <View style={styles.forgivenessRow}>
                      ...
                      <Text style={styles.forgivenessText}>
                        Potential Forgiveness: {formatCurrency(strategy.forgiveness)}
                      </Text>
                    </View>
                  )}
