...
test.describe('Pricing Page', () => {
  ...
  test('should have CTA buttons for each plan', async ({ page }) => {
    const ctaButtons = page.getByRole('button', { name: /get started|subscribe|choose|select|buy/i });
  ...
  test('should toggle between monthly and yearly pricing', async ({ page }) => {
    ...
    const toggle = page.locator('[role="switch"], [class*="toggle"], button:has-text("yearly"), button:has-text("annual")');
  ...
  test('should highlight recommended plan', async ({ page }) => {
    ...
    const recommended = page.locator('[class*="popular"], [class*="recommended"], [class*="featured"], :has-text("Most Popular"), :has-text("Recommended")');
...
test.describe('Pricing Page Navigation', () => {
  test('should navigate to signup when clicking CTA', async ({ page }) => {
    ...
    const ctaButton = page.getByRole('button', { name: /get started|subscribe|choose/i }).first();
