...
test.describe("Comprehensive Investment Analysis", () => {
  ...
  test("should load the analysis page", async ({ page }) => {
    ...
    await expect(
      page.getByRole("heading", { name: /Comprehensive Investment Analysis/i }),
    ).toBeVisible();
  });
  ...
  test("should disable analyze button when symbol is empty", async ({
    page,
  }) => {
    const symbolInput = page.getByPlaceholder(/Enter symbol/i);
    const analyzeButton = page.getByRole("button", { name: /Analyze/i });
  ...
  test("should enable analyze button when symbol is provided", async ({
    page,
  }) => {
    const symbolInput = page.getByPlaceholder(/Enter symbol/i);
    const analyzeButton = page.getByRole("button", { name: /Analyze/i });
