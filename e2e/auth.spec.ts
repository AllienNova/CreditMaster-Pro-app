...
test.describe('Authentication Flow', () => {
  ...
  test.describe('Protected Routes', () => {
    ...
    test('should redirect to login when accessing disputes unauthenticated', async ({ page }) => {
  ...
  test.describe('Password Visibility Toggle', () => {
    test('should toggle password visibility', async ({ page }) => {
      ...
      const toggleButton = page.locator('[aria-label*="password"], [data-testid*="toggle"], button:near(input[type="password"])');
