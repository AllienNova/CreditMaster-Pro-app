...
test.describe("Credit Builder API", () => {
  ...
  test("GET /api/credit-builder/recommendations should respond", async ({
    request,
  }) => {
...
test.describe("Credit Report API", () => {
  ...
  test("POST /api/credit-report/analyze should require auth", async ({
    request,
  }) => {
...
test.describe("Payment API", () => {
  test("POST /api/payment/checkout should require data", async ({
    request,
  }) => {
  ...
  test("GET /api/payment/subscription should require auth", async ({
    request,
  }) => {
...
test.describe("Admin API", () => {
  test("GET /api/admin/users should require admin auth", async ({
    request,
  }) => {
...
test.describe("Student Loans API", () => {
  test("GET /api/student-loans/programs should respond", async ({
    request,
  }) => {
  ...
  test("POST /api/student-loans/calculate should accept data", async ({
    request,
  }) => {
...
test.describe("Marketplace API", () => {
  test("GET /api/marketplace/tradelines should respond", async ({
    request,
  }) => {
