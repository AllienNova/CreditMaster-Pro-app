...
export default function () {
  ...
  // Test 2: Get Holdings
  const holdingsResponse = http.get(`${BASE_URL}/api/investments/holdings`, {
    headers,
  });
  ...
  const randomSymbol =
    testSymbols[Math.floor(Math.random() * testSymbols.length)];
  ...
  check(createResponse, {
    "create holding status is 200 or 201": (r) =>
